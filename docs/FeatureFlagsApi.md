...
let flagCopyConfigPost = {"comment":"optional comment","source":{"currentVersion":1,"key":"example-source-env"},"target":{"currentVersion":1,"key":"example-target-env"}}; // FlagCopyConfigPost | 
...
let apiInstance = new LaunchDarklyApi.FeatureFlagsApi();
let projectKey = "projectKey_example"; // String | The project key
let featureFlagBody = {"clientSideAvailability":{"usingEnvironmentId":true,"usingMobileKey":true},"key":"my-flag","name":"My Flag"}; // FeatureFlagBody | 
let opts = {
