...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LaunchDarklyRestApi.CustomRolesApi();
  });
  ...
  describe('CustomRolesApi', function() {
    describe('deleteCustomRole', function() {
      it('should call deleteCustomRole successfully', function(done) {
        //uncomment below and update the code to test deleteCustomRole
        //instance.deleteCustomRole(function(error) {
    ...
    describe('getCustomRole', function() {
      it('should call getCustomRole successfully', function(done) {
        //uncomment below and update the code to test getCustomRole
        //instance.getCustomRole(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getCustomRoles', function() {
      it('should call getCustomRoles successfully', function(done) {
        //uncomment below and update the code to test getCustomRoles
        //instance.getCustomRoles(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('patchCustomRole', function() {
      it('should call patchCustomRole successfully', function(done) {
        //uncomment below and update the code to test patchCustomRole
        //instance.patchCustomRole(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postCustomRole', function() {
      it('should call postCustomRole successfully', function(done) {
        //uncomment below and update the code to test postCustomRole
        //instance.postCustomRole(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
