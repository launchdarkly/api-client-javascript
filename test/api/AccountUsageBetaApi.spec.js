...
(function(root, factory) {
  ...
  describe('AccountUsageBetaApi', function() {
    ...
    describe('getExperimentationUnitsUsage', function() {
      it('should call getExperimentationUnitsUsage successfully', function(done) {
        //uncomment below and update the code to test getExperimentationUnitsUsage
        //instance.getExperimentationUnitsUsage(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
