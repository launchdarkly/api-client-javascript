    ...
    describe('UserSegmentsApi', function() {
      ...
      describe('updatedUnboundedSegmentTargets', function() {
        it('should call updatedUnboundedSegmentTargets successfully', function(done) {
          // TODO: uncomment, update parameter values for updatedUnboundedSegmentTargets call
          /*
          var projectKey = "projectKey_example";
          var environmentKey = "environmentKey_example";
          var userSegmentKey = "userSegmentKey_example";
          var unboundedSegmentTargetsBody = new LaunchDarklyApi.UnboundedSegmentTargetsBody();
          unboundedSegmentTargetsBody.included = new LaunchDarklyApi.UnboundedSegmentTargetChanges();
          unboundedSegmentTargetsBody.included.add = ["user@launchdarkly.com"];
          unboundedSegmentTargetsBody.included.remove = [];
          unboundedSegmentTargetsBody.excluded = new LaunchDarklyApi.UnboundedSegmentTargetChanges();
          unboundedSegmentTargetsBody.excluded.add = ["user@launchdarkly.com"];
          unboundedSegmentTargetsBody.excluded.remove = [];

          instance.updatedUnboundedSegmentTargets(projectKey, environmentKey, userSegmentKey, unboundedSegmentTargetsBody, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
