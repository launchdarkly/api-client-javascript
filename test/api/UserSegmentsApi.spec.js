...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserSegmentsApi', function() {
      ...
      describe('updatedBigSegmentTargets', function() {
        it('should call updatedBigSegmentTargets successfully', function(done) {
          // TODO: uncomment, update parameter values for updatedBigSegmentTargets call
          /*
          var projectKey = "projectKey_example";
          var environmentKey = "environmentKey_example";
          var userSegmentKey = "userSegmentKey_example";
          ...
          instance.updatedBigSegmentTargets(projectKey, environmentKey, userSegmentKey, bigSegmentTargetsBody, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
