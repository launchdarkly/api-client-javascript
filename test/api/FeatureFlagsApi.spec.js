...
(function(root, factory) {
  ...
  describe('FeatureFlagsApi', function() {
    ...
    describe('getFeatureFlagChangeRequest', function() {
      it('should call getFeatureFlagChangeRequest successfully', function(done) {
        //uncomment below and update the code to test getFeatureFlagChangeRequest
        //instance.getFeatureFlagChangeRequest(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getFeatureFlagChangeRequests', function() {
      it('should call getFeatureFlagChangeRequests successfully', function(done) {
        //uncomment below and update the code to test getFeatureFlagChangeRequests
        //instance.getFeatureFlagChangeRequests(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postApplyFeatureFlagChangeRequest', function() {
      it('should call postApplyFeatureFlagChangeRequest successfully', function(done) {
        //uncomment below and update the code to test postApplyFeatureFlagChangeRequest
        //instance.postApplyFeatureFlagChangeRequest(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postFeatureFlagChangeRequest', function() {
      it('should call postFeatureFlagChangeRequest successfully', function(done) {
        //uncomment below and update the code to test postFeatureFlagChangeRequest
        //instance.postFeatureFlagChangeRequest(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postReviewFeatureFlagChangeRequest', function() {
      it('should call postReviewFeatureFlagChangeRequest successfully', function(done) {
        //uncomment below and update the code to test postReviewFeatureFlagChangeRequest
        //instance.postReviewFeatureFlagChangeRequest(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
