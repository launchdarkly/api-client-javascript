    ...
    describe('FeatureFlagsApi', function() {
      ...
      describe('deleteApprovalRequest', function() {
        it('should call deleteApprovalRequest successfully', function(done) {
          ...
          opts.approvalRequestConfigBody.executionDate = "0";
          opts.approvalRequestConfigBody.operatingOnId = "";
      ...
      describe('flagsProjectKeyEnvironmentKeyFeatureFlagKeyDependentFlagsGet', function() {
        it('should call flagsProjectKeyEnvironmentKeyFeatureFlagKeyDependentFlagsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for flagsProjectKeyEnvironmentKeyFeatureFlagKeyDependentFlagsGet call and complete the assertions
          /*
          var projectKey = "projectKey_example";
          var environmentKey = "environmentKey_example";
          var featureFlagKey = "featureFlagKey_example";

          instance.flagsProjectKeyEnvironmentKeyFeatureFlagKeyDependentFlagsGet(projectKey, environmentKey, featureFlagKey, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(LaunchDarklyApi.DependentFlagsByEnvironment);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(LaunchDarklyApi.DependentFlag);
                expect(data.name).to.be.a('string');
            ...
            expect(data.links).to.be.a(LaunchDarklyApi.DependentFlagsLinks);
      ...
      describe('flagsProjectKeyFeatureFlagKeyDependentFlagsGet', function() {
        it('should call flagsProjectKeyFeatureFlagKeyDependentFlagsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for flagsProjectKeyFeatureFlagKeyDependentFlagsGet call and complete the assertions
          /*
          var projectKey = "projectKey_example";
          var featureFlagKey = "featureFlagKey_example";

          instance.flagsProjectKeyFeatureFlagKeyDependentFlagsGet(projectKey, featureFlagKey, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(LaunchDarklyApi.MultiEnvironmentDependentFlags);
            {
              let dataCtr = data.items;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(LaunchDarklyApi.MultiEnvironmentDependentFlag);
                expect(data.name).to.be.a('string');
                expect(data.name).to.be("");
                expect(data.key).to.be.a('string');
                expect(data.key).to.be("");
                {
                  ...
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(LaunchDarklyApi.DependentFlagEnvironment);
                    expect(data.name).to.be.a('string');
                    expect(data.name).to.be("");
                    expect(data.key).to.be.a('string');
                    expect(data.key).to.be("");
                    expect(data.links).to.be.a(LaunchDarklyApi.DependentFlagEnvironmentLinks);
                          expect(data.links.self).to.be.a(LaunchDarklyApi.Link);
                            expect(data.links.self.href).to.be.a('string');
                        expect(data.links.self.href).to.be("/api/v2/endpoint");
                        expect(data.links.self.type).to.be.a('string');
                        expect(data.links.self.type).to.be("application/json");
                      expect(data.links.flagLink).to.be.a(LaunchDarklyApi.Link);
                            expect(data.links.flagLink.href).to.be.a('string');
                        expect(data.links.flagLink.href).to.be("/api/v2/endpoint");
                        expect(data.links.flagLink.type).to.be.a('string');
                        expect(data.links.flagLink.type).to.be("application/json");
                    expect(data.site).to.be.a(LaunchDarklyApi.Site);
                          expect(data.site.href).to.be.a('string');
                      expect(data.site.href).to.be("/features/sort.order");
                      expect(data.site.type).to.be.a('string');
          ...
          instance.getApprovalRequest(projectKey, featureFlagKey, environmentKey, approvalRequestId, function(error, data, response) {
                ...
                expect(data.links.next.type).to.be("application/json");
            {
              ...
              for (let p in dataCtr) {
                ...
                expect(data.operatingOnId).to.be.a('string');
                expect(data.operatingOnId).to.be("");
      ...
      describe('getFeatureFlagStatus', function() {
        it('should call getFeatureFlagStatus successfully', function(done) {
          ...
          instance.getFeatureFlagStatus(projectKey, environmentKey, featureFlagKey, function(error, data, response) {
            ...
            expect(data.links).to.be.a(LaunchDarklyApi.FeatureFlagStatusLinks);
                  expect(data.links.parent).to.be.a(LaunchDarklyApi.Link);
                    expect(data.links.parent.href).to.be.a('string');
                expect(data.links.parent.href).to.be("/api/v2/endpoint");
                expect(data.links.parent.type).to.be.a('string');
