...
(function(root, factory) {
  ...
  describe('FeatureFlagsApi', function() {
    ...
    describe('getExpiringContextTargets', function() {
      it('should call getExpiringContextTargets successfully', function(done) {
        //uncomment below and update the code to test getExpiringContextTargets
        //instance.getExpiringContextTargets(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('patchExpiringTargets', function() {
      it('should call patchExpiringTargets successfully', function(done) {
        //uncomment below and update the code to test patchExpiringTargets
        //instance.patchExpiringTargets(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postMigrationSafetyIssues', function() {
      it('should call postMigrationSafetyIssues successfully', function(done) {
        //uncomment below and update the code to test postMigrationSafetyIssues
        //instance.postMigrationSafetyIssues(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
