...
(function(root, factory) {
  ...
  describe('FeatureFlagScheduledChangesConflictsInstructions', function() {
    it('should create an instance of FeatureFlagScheduledChangesConflictsInstructions', function() {
      // uncomment below and update the code to test FeatureFlagScheduledChangesConflictsInstructions
      //var instance = new LaunchDarklyApi.FeatureFlagScheduledChangesConflictsInstructions();
