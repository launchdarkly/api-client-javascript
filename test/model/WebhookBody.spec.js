  ...
  describe('(package)', function() {
    describe('WebhookBody', function() {
      ...
      it('should create an instance of WebhookBody', function() {
        // TODO: update the code to test WebhookBody
      ...
      it('should have the property sign (base name: "sign")', function() {
        // TODO: update the code to test the property sign
        expect(instance).to.have.property('sign');
        // expect(instance.sign).to.be(expectedValueLiteral);
      });
