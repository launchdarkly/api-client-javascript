...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LaunchDarklyApi.MetricListingRep();
  });
  ...
  describe('MetricListingRep', function() {
    it('should create an instance of MetricListingRep', function() {
      // uncomment below and update the code to test MetricListingRep
      //var instance = new LaunchDarklyApi.MetricListingRep();
      //expect(instance).to.be.a(LaunchDarklyApi.MetricListingRep);
    });
