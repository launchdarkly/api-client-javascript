...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LaunchDarklyApi.DeploymentRep();
  });
  ...
  describe('DeploymentRep', function() {
    it('should create an instance of DeploymentRep', function() {
      // uncomment below and update the code to test DeploymentRep
      //var instance = new LaunchDarklyApi.DeploymentRep();
      //expect(instance).to.be.a(LaunchDarklyApi.DeploymentRep);
    });
    ...
    it('should have the property numberOfContributors (base name: "numberOfContributors")', function() {
      // uncomment below and update the code to test the property numberOfContributors
      //var instance = new LaunchDarklyApi.DeploymentRep();
      //expect(instance).to.be();
    });

    it('should have the property numberOfPullRequests (base name: "numberOfPullRequests")', function() {
      // uncomment below and update the code to test the property numberOfPullRequests
      //var instance = new LaunchDarklyApi.DeploymentRep();
      //expect(instance).to.be();
    });

    it('should have the property linesAdded (base name: "linesAdded")', function() {
      // uncomment below and update the code to test the property linesAdded
      //var instance = new LaunchDarklyApi.DeploymentRep();
      //expect(instance).to.be();
    });

    it('should have the property linesDeleted (base name: "linesDeleted")', function() {
      // uncomment below and update the code to test the property linesDeleted
      //var instance = new LaunchDarklyApi.DeploymentRep();
      //expect(instance).to.be();
    });
    ...
    it('should have the property leadTimeStages (base name: "leadTimeStages")', function() {
      // uncomment below and update the code to test the property leadTimeStages
      //var instance = new LaunchDarklyApi.DeploymentRep();
      //expect(instance).to.be();
    });
