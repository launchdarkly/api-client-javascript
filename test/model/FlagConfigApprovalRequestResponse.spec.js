...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LaunchDarklyApi.FlagConfigApprovalRequestResponse();
  });
  ...
  describe('FlagConfigApprovalRequestResponse', function() {
    it('should create an instance of FlagConfigApprovalRequestResponse', function() {
      // uncomment below and update the code to test FlagConfigApprovalRequestResponse
      //var instance = new LaunchDarklyApi.FlagConfigApprovalRequestResponse();
      //expect(instance).to.be.a(LaunchDarklyApi.FlagConfigApprovalRequestResponse);
    });
