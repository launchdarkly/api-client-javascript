...
(function(root, factory) {
  ...
  describe('UserSegment', function() {
    ...
    it('should have the property includedContexts (base name: "includedContexts")', function() {
      // uncomment below and update the code to test the property includedContexts
      //var instance = new LaunchDarklyApi.UserSegment();
      //expect(instance).to.be();
    });

    it('should have the property excludedContexts (base name: "excludedContexts")', function() {
      // uncomment below and update the code to test the property excludedContexts
      //var instance = new LaunchDarklyApi.UserSegment();
      //expect(instance).to.be();
    });
    ...
    it('should have the property unbounded (base name: "unbounded")', function() {
      // uncomment below and update the code to test the property unbounded
      //var instance = new LaunchDarklyApi.UserSegment();
      //expect(instance).to.be();
    });

    it('should have the property unboundedContextKind (base name: "unboundedContextKind")', function() {
      // uncomment below and update the code to test the property unboundedContextKind
      //var instance = new LaunchDarklyApi.UserSegment();
      //expect(instance).to.be();
    });
    ...
    it('should have the property unboundedMetadata (base name: "_unboundedMetadata")', function() {
      // uncomment below and update the code to test the property unboundedMetadata
      //var instance = new LaunchDarklyApi.UserSegment();
      //expect(instance).to.be();
    });

    it('should have the property external (base name: "_external")', function() {
      // uncomment below and update the code to test the property external
      //var instance = new LaunchDarklyApi.UserSegment();
      //expect(instance).to.be();
    });

    it('should have the property externalLink (base name: "_externalLink")', function() {
