...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LaunchDarklyApi.AuditLogEntryListingRep();
  });
  ...
  describe('AuditLogEntryListingRep', function() {
    it('should create an instance of AuditLogEntryListingRep', function() {
      // uncomment below and update the code to test AuditLogEntryListingRep
      //var instane = new LaunchDarklyApi.AuditLogEntryListingRep();
      //expect(instance).to.be.a(LaunchDarklyApi.AuditLogEntryListingRep);
    });

    it('should have the property links (base name: "_links")', function() {
      // uncomment below and update the code to test the property links
      //var instance = new LaunchDarklyApi.AuditLogEntryListingRep();
