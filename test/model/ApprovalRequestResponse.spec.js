...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LaunchDarklyApi.ApprovalRequestResponse();
  });
  ...
  describe('ApprovalRequestResponse', function() {
    it('should create an instance of ApprovalRequestResponse', function() {
      // uncomment below and update the code to test ApprovalRequestResponse
      //var instance = new LaunchDarklyApi.ApprovalRequestResponse();
      //expect(instance).to.be.a(LaunchDarklyApi.ApprovalRequestResponse);
    });
