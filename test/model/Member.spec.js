...
(function(root, factory) {
  ...
  describe('Member', function() {
    ...
    it('should have the property pendingEmail (base name: "_pendingEmail")', function() {
      // uncomment below and update the code to test the property pendingEmail
      //var instance = new LaunchDarklyApi.Member();
      //expect(instance).to.be();
    });
    ...
    it('should have the property excludedDashboards (base name: "excludedDashboards")', function() {
      // uncomment below and update the code to test the property excludedDashboards
      //var instance = new LaunchDarklyApi.Member();
      //expect(instance).to.be();
    });
    ...
    it('should have the property lastSeenMetadata (base name: "_lastSeenMetadata")', function() {
      // uncomment below and update the code to test the property lastSeenMetadata
      //var instance = new LaunchDarklyApi.Member();
      //expect(instance).to.be();
    });

    it('should have the property integrationMetadata (base name: "_integrationMetadata")', function() {
    ...
    it('should have the property permissionGrants (base name: "permissionGrants")', function() {
      // uncomment below and update the code to test the property permissionGrants
      //var instance = new LaunchDarklyApi.Member();
      //expect(instance).to.be();
    });
    ...
    it('should have the property roleAttributes (base name: "roleAttributes")', function() {
      // uncomment below and update the code to test the property roleAttributes
      //var instance = new LaunchDarklyApi.Member();
      //expect(instance).to.be();
    });
