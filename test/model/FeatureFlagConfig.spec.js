...
(function(root, factory) {
  ...
  describe('FeatureFlagConfig', function() {
    ...
    it('should have the property contextTargets (base name: "contextTargets")', function() {
      // uncomment below and update the code to test the property contextTargets
      //var instance = new LaunchDarklyApi.FeatureFlagConfig();
      //expect(instance).to.be();
    });
    ...
    it('should have the property trackEventsFallthrough (base name: "trackEventsFallthrough")', function() {
      // uncomment below and update the code to test the property trackEventsFallthrough
      //var instance = new LaunchDarklyApi.FeatureFlagConfig();
      //expect(instance).to.be();
    });

    it('should have the property debugEventsUntilDate (base name: "_debugEventsUntilDate")', function() {
      // uncomment below and update the code to test the property debugEventsUntilDate
      //var instance = new LaunchDarklyApi.FeatureFlagConfig();
      //expect(instance).to.be();
    });

    it('should have the property summary (base name: "_summary")', function() {
