...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LaunchDarklyApi.ExpandableApprovalRequestResponse();
  });
  ...
  describe('ExpandableApprovalRequestResponse', function() {
    it('should create an instance of ExpandableApprovalRequestResponse', function() {
      // uncomment below and update the code to test ExpandableApprovalRequestResponse
      //var instance = new LaunchDarklyApi.ExpandableApprovalRequestResponse();
      //expect(instance).to.be.a(LaunchDarklyApi.ExpandableApprovalRequestResponse);
    });
    ...
    it('should have the property appliedByServiceTokenId (base name: "appliedByServiceTokenId")', function() {
      // uncomment below and update the code to test the property appliedByServiceTokenId
      //var instance = new LaunchDarklyApi.ExpandableApprovalRequestResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property operatingOnId (base name: "operatingOnId")', function() {
      // uncomment below and update the code to test the property operatingOnId
      //var instance = new LaunchDarklyApi.ExpandableApprovalRequestResponse();
      //expect(instance).to.be();
    });

    it('should have the property integrationMetadata (base name: "integrationMetadata")', function() {
      // uncomment below and update the code to test the property integrationMetadata
      //var instance = new LaunchDarklyApi.ExpandableApprovalRequestResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property approvalSettings (base name: "approvalSettings")', function() {
      // uncomment below and update the code to test the property approvalSettings
      //var instance = new LaunchDarklyApi.ExpandableApprovalRequestResponse();
      //expect(instance).to.be();
    });
