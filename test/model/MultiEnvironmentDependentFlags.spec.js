...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MultiEnvironmentDependentFlags', function() {
      beforeEach(function() {
        instance = new LaunchDarklyApi.MultiEnvironmentDependentFlags();
      });

      it('should create an instance of MultiEnvironmentDependentFlags', function() {
        // TODO: update the code to test MultiEnvironmentDependentFlags
        expect(instance).to.be.a(LaunchDarklyApi.MultiEnvironmentDependentFlags);
      });
