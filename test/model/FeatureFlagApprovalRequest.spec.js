...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LaunchDarklyApi.FeatureFlagApprovalRequest();
  });
  ...
  describe('FeatureFlagApprovalRequest', function() {
    it('should create an instance of FeatureFlagApprovalRequest', function() {
      // uncomment below and update the code to test FeatureFlagApprovalRequest
      //var instance = new LaunchDarklyApi.FeatureFlagApprovalRequest();
      //expect(instance).to.be.a(LaunchDarklyApi.FeatureFlagApprovalRequest);
    });
