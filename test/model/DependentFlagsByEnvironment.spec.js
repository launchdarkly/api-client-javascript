...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DependentFlagsByEnvironment', function() {
      beforeEach(function() {
        instance = new LaunchDarklyApi.DependentFlagsByEnvironment();
      });

      it('should create an instance of DependentFlagsByEnvironment', function() {
        // TODO: update the code to test DependentFlagsByEnvironment
        expect(instance).to.be.a(LaunchDarklyApi.DependentFlagsByEnvironment);
      });
