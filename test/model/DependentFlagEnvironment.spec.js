...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DependentFlagEnvironment', function() {
      beforeEach(function() {
        instance = new LaunchDarklyApi.DependentFlagEnvironment();
      });

      it('should create an instance of DependentFlagEnvironment', function() {
        // TODO: update the code to test DependentFlagEnvironment
        expect(instance).to.be.a(LaunchDarklyApi.DependentFlagEnvironment);
      });
