...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DependentFlag', function() {
      beforeEach(function() {
        instance = new LaunchDarklyApi.DependentFlag();
      });

      it('should create an instance of DependentFlag', function() {
        // TODO: update the code to test DependentFlag
        expect(instance).to.be.a(LaunchDarklyApi.DependentFlag);
      });
