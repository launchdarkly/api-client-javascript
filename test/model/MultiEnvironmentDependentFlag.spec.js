...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MultiEnvironmentDependentFlag', function() {
      beforeEach(function() {
        instance = new LaunchDarklyApi.MultiEnvironmentDependentFlag();
      });

      it('should create an instance of MultiEnvironmentDependentFlag', function() {
        // TODO: update the code to test MultiEnvironmentDependentFlag
        expect(instance).to.be.a(LaunchDarklyApi.MultiEnvironmentDependentFlag);
      });
