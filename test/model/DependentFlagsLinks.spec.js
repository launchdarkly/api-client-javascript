...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DependentFlagsLinks', function() {
      beforeEach(function() {
        instance = new LaunchDarklyApi.DependentFlagsLinks();
      });

      it('should create an instance of DependentFlagsLinks', function() {
        // TODO: update the code to test DependentFlagsLinks
        expect(instance).to.be.a(LaunchDarklyApi.DependentFlagsLinks);
      });
