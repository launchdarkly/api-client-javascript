...
(function(root, factory) {
  ...
  describe('FlagGlobalAttributesRep', function() {
    it('should create an instance of FlagGlobalAttributesRep', function() {
      ...
      //var instane = new LaunchDarklyApi.FlagGlobalAttributesRep();
    ...
    it('should have the property variationJsonSchema (base name: "variationJsonSchema")', function() {
      // uncomment below and update the code to test the property variationJsonSchema
      //var instance = new LaunchDarklyApi.FlagGlobalAttributesRep();
      //expect(instance).to.be();
    });
