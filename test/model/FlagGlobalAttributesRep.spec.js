...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LaunchDarklyApi.FlagGlobalAttributesRep();
  });
  ...
  describe('FlagGlobalAttributesRep', function() {
    it('should create an instance of FlagGlobalAttributesRep', function() {
      // uncomment below and update the code to test FlagGlobalAttributesRep
      //var instance = new LaunchDarklyApi.FlagGlobalAttributesRep();
      //expect(instance).to.be.a(LaunchDarklyApi.FlagGlobalAttributesRep);
    });
    ...
    it('should have the property maintainerTeam (base name: "_maintainerTeam")', function() {
      // uncomment below and update the code to test the property maintainerTeam
      //var instance = new LaunchDarklyApi.FlagGlobalAttributesRep();
      //expect(instance).to.be();
    });
    ...
    it('should have the property purpose (base name: "_purpose")', function() {
      // uncomment below and update the code to test the property purpose
      //var instance = new LaunchDarklyApi.FlagGlobalAttributesRep();
      //expect(instance).to.be();
    });

    it('should have the property migrationSettings (base name: "migrationSettings")', function() {
      // uncomment below and update the code to test the property migrationSettings
      //var instance = new LaunchDarklyApi.FlagGlobalAttributesRep();
      //expect(instance).to.be();
    });
