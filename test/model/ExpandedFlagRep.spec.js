...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LaunchDarklyApi.ExpandedFlagRep();
  });
  ...
  describe('ExpandedFlagRep', function() {
    it('should create an instance of ExpandedFlagRep', function() {
      // uncomment below and update the code to test ExpandedFlagRep
      //var instance = new LaunchDarklyApi.ExpandedFlagRep();
      //expect(instance).to.be.a(LaunchDarklyApi.ExpandedFlagRep);
    });
