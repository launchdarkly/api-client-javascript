...
*LaunchDarklyApi.ApplicationsBetaApi* | [**createApplication**](docs/ApplicationsBetaApi.md#createApplication) | **POST** /api/v2/applications | Post application
...
*LaunchDarklyApi.ApplicationsBetaApi* | [**postApplicationVersion**](docs/ApplicationsBetaApi.md#postApplicationVersion) | **POST** /api/v2/applications/{applicationKey}/versions | Post application version
