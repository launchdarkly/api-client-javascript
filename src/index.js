...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Action', 'model/Actions', 'model/AuditLogEntries', 'model/AuditLogEntry', 'model/AuditLogEntryTarget', 'model/Clause', 'model/CustomRole', 'model/CustomRoleBody', 'model/CustomRoleKeyOrId', 'model/CustomRoles', 'model/Environment', 'model/EnvironmentBody', 'model/FeatureFlag', 'model/FeatureFlagBody', 'model/FeatureFlagConfig', 'model/FeatureFlagConfigFallthrough', 'model/FeatureFlagStatus', 'model/FeatureFlagStatuses', 'model/FeatureFlags', 'model/FlagsprojectKeyfeatureFlagKeyPatch', 'model/Id', 'model/Link', 'model/Links', 'model/Member', 'model/Members', 'model/MembersBody', 'model/NonOwnerRole', 'model/PatchComment', 'model/PatchDelta', 'model/Policy', 'model/Project', 'model/ProjectBody', 'model/Projects', 'model/Resource', 'model/Resources', 'model/Role', 'model/Rollout', 'model/Rule', 'model/Statement', 'model/Statements', 'model/Target', 'model/User', 'model/UserFlagSetting', 'model/UserFlagSettings', 'model/UserSettingsBody', 'model/Users', 'model/Variation', 'model/Webhook', 'model/WebhookBody', 'model/Webhooks', 'model/WeightedVariation', 'api/AuditLogApi', 'api/CustomRolesApi', 'api/EnvironmentsApi', 'api/FeatureFlagsApi', 'api/ProjectsApi', 'api/RootApi', 'api/TeamMembersApi', 'api/UserSettingsApi', 'api/UsersApi', 'api/WebhooksApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Action'), require('./model/Actions'), require('./model/AuditLogEntries'), require('./model/AuditLogEntry'), require('./model/AuditLogEntryTarget'), require('./model/Clause'), require('./model/CustomRole'), require('./model/CustomRoleBody'), require('./model/CustomRoleKeyOrId'), require('./model/CustomRoles'), require('./model/Environment'), require('./model/EnvironmentBody'), require('./model/FeatureFlag'), require('./model/FeatureFlagBody'), require('./model/FeatureFlagConfig'), require('./model/FeatureFlagConfigFallthrough'), require('./model/FeatureFlagStatus'), require('./model/FeatureFlagStatuses'), require('./model/FeatureFlags'), require('./model/FlagsprojectKeyfeatureFlagKeyPatch'), require('./model/Id'), require('./model/Link'), require('./model/Links'), require('./model/Member'), require('./model/Members'), require('./model/MembersBody'), require('./model/NonOwnerRole'), require('./model/PatchComment'), require('./model/PatchDelta'), require('./model/Policy'), require('./model/Project'), require('./model/ProjectBody'), require('./model/Projects'), require('./model/Resource'), require('./model/Resources'), require('./model/Role'), require('./model/Rollout'), require('./model/Rule'), require('./model/Statement'), require('./model/Statements'), require('./model/Target'), require('./model/User'), require('./model/UserFlagSetting'), require('./model/UserFlagSettings'), require('./model/UserSettingsBody'), require('./model/Users'), require('./model/Variation'), require('./model/Webhook'), require('./model/WebhookBody'), require('./model/Webhooks'), require('./model/WeightedVariation'), require('./api/AuditLogApi'), require('./api/CustomRolesApi'), require('./api/EnvironmentsApi'), require('./api/FeatureFlagsApi'), require('./api/ProjectsApi'), require('./api/RootApi'), require('./api/TeamMembersApi'), require('./api/UserSettingsApi'), require('./api/UsersApi'), require('./api/WebhooksApi'));
  }
}(function(ApiClient, Action, Actions, AuditLogEntries, AuditLogEntry, AuditLogEntryTarget, Clause, CustomRole, CustomRoleBody, CustomRoleKeyOrId, CustomRoles, Environment, EnvironmentBody, FeatureFlag, FeatureFlagBody, FeatureFlagConfig, FeatureFlagConfigFallthrough, FeatureFlagStatus, FeatureFlagStatuses, FeatureFlags, FlagsprojectKeyfeatureFlagKeyPatch, Id, Link, Links, Member, Members, MembersBody, NonOwnerRole, PatchComment, PatchDelta, Policy, Project, ProjectBody, Projects, Resource, Resources, Role, Rollout, Rule, Statement, Statements, Target, User, UserFlagSetting, UserFlagSettings, UserSettingsBody, Users, Variation, Webhook, WebhookBody, Webhooks, WeightedVariation, AuditLogApi, CustomRolesApi, EnvironmentsApi, FeatureFlagsApi, ProjectsApi, RootApi, TeamMembersApi, UserSettingsApi, UsersApi, WebhooksApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The FlagsprojectKeyfeatureFlagKeyPatch model constructor.
     * @property {module:model/FlagsprojectKeyfeatureFlagKeyPatch}
     */
    FlagsprojectKeyfeatureFlagKeyPatch: FlagsprojectKeyfeatureFlagKeyPatch,
    /**
    ...
    /**
     * The NonOwnerRole model constructor.
     * @property {module:model/NonOwnerRole}
     */
    NonOwnerRole: NonOwnerRole,
    /**
