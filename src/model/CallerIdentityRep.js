...
/**
 * The CallerIdentityRep model module.
 * @module model/CallerIdentityRep
 * @version 18.1.0
 */
class CallerIdentityRep {
    /**
     * Constructs a new <code>CallerIdentityRep</code>.
     * @alias module:model/CallerIdentityRep
     */
    constructor() { 
        
        CallerIdentityRep.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CallerIdentityRep</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CallerIdentityRep} obj Optional instance to populate.
     * @return {module:model/CallerIdentityRep} The populated <code>CallerIdentityRep</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CallerIdentityRep();
            ...
            if (data.hasOwnProperty('authKind')) {
                obj['authKind'] = ApiClient.convertToType(data['authKind'], 'String');
            }
            if (data.hasOwnProperty('tokenKind')) {
                obj['tokenKind'] = ApiClient.convertToType(data['tokenKind'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CallerIdentityRep</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CallerIdentityRep</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['authKind'] && !(typeof data['authKind'] === 'string' || data['authKind'] instanceof String)) {
            throw new Error("Expected the field `authKind` to be a primitive type in the JSON string but got " + data['authKind']);
        }
        // ensure the json data is a string
        if (data['tokenKind'] && !(typeof data['tokenKind'] === 'string' || data['tokenKind'] instanceof String)) {
            throw new Error("Expected the field `tokenKind` to be a primitive type in the JSON string but got " + data['tokenKind']);
        }
        // ensure the json data is a string
 ...
 */
CallerIdentityRep.prototype['accountId'] = undefined;

/**
 * @member {String} environmentId
 */
CallerIdentityRep.prototype['environmentId'] = undefined;

/**
 * @member {String} projectId
 */
CallerIdentityRep.prototype['projectId'] = undefined;

/**
 * @member {String} environmentName
 */
CallerIdentityRep.prototype['environmentName'] = undefined;

/**
 * @member {String} projectName
 */
CallerIdentityRep.prototype['projectName'] = undefined;

/**
 * @member {String} authKind
 */
CallerIdentityRep.prototype['authKind'] = undefined;

/**
 * @member {String} tokenKind
 */
CallerIdentityRep.prototype['tokenKind'] = undefined;

/**
 * @member {String} clientId
 */
CallerIdentityRep.prototype['clientId'] = undefined;

/**
 * @member {String} tokenName
 */
CallerIdentityRep.prototype['tokenName'] = undefined;

/**
 * @member {String} tokenId
 */
CallerIdentityRep.prototype['tokenId'] = undefined;

/**
 * @member {String} memberId
 */
CallerIdentityRep.prototype['memberId'] = undefined;

/**
 * @member {Boolean} serviceToken
 */
CallerIdentityRep.prototype['serviceToken'] = undefined;
...
export default CallerIdentityRep;
