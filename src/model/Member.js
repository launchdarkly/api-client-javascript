...
class Member {
     ...
     * @param pendingInvite {Boolean} Whether or not the member has a pending invitation
     * @param verified {Boolean} Whether or not the member's email address has been verified
