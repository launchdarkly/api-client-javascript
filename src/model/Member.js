...
class Member {
     ...
     * @param role {String} The member's base role. If the member has no additional roles, this role will be in effect.
     * @param email {String} The member's email address
     * @param pendingInvite {Boolean} Whether the member has a pending invitation
     * @param verified {Boolean} Whether the member's email address has been verified
     * @param customRoles {Array.<String>} The set of additional roles, besides the base role, assigned to the member
     * @param mfa {String} Whether multi-factor authentication is enabled for this member
     * @param lastSeen {Number} 
     * @param creationDate {Number} 
     */
    constructor(links, id, role, email, pendingInvite, verified, customRoles, mfa, lastSeen, creationDate) { 
        
        Member.initialize(this, links, id, role, email, pendingInvite, verified, customRoles, mfa, lastSeen, creationDate);
    }
     ...
     */
    static initialize(obj, links, id, role, email, pendingInvite, verified, customRoles, mfa, lastSeen, creationDate) { 
        obj['_links'] = links;
        obj['_id'] = id;
        obj['role'] = role;
        obj['email'] = email;
        obj['_pendingInvite'] = pendingInvite;
        obj['_verified'] = verified;
        obj['customRoles'] = customRoles;
        obj['mfa'] = mfa;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('_pendingEmail')) {
                obj['_pendingEmail'] = ApiClient.convertToType(data['_pendingEmail'], 'String');
            }
            ...
            if (data.hasOwnProperty('excludedDashboards')) {
                obj['excludedDashboards'] = ApiClient.convertToType(data['excludedDashboards'], ['String']);
            }
            if (data.hasOwnProperty('_lastSeen')) {
                obj['_lastSeen'] = ApiClient.convertToType(data['_lastSeen'], 'Number');
            }
            if (data.hasOwnProperty('_lastSeenMetadata')) {
                obj['_lastSeenMetadata'] = LastSeenMetadata.constructFromObject(data['_lastSeenMetadata']);
            }
            if (data.hasOwnProperty('_integrationMetadata')) {
                obj['_integrationMetadata'] = IntegrationMetadata.constructFromObject(data['_integrationMetadata']);
            }
            if (data.hasOwnProperty('teams')) {
                obj['teams'] = ApiClient.convertToType(data['teams'], [MemberTeamSummaryRep]);
            }
            ...
            if (data.hasOwnProperty('oauthProviders')) {
                obj['oauthProviders'] = ApiClient.convertToType(data['oauthProviders'], ['String']);
            }
            if (data.hasOwnProperty('version')) {
                obj['version'] = ApiClient.convertToType(data['version'], 'Number');
            }
            if (data.hasOwnProperty('roleAttributes')) {
                obj['roleAttributes'] = ApiClient.convertToType(data['roleAttributes'], {'String': Array});
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['_pendingEmail'] && !(typeof data['_pendingEmail'] === 'string' || data['_pendingEmail'] instanceof String)) {
            throw new Error("Expected the field `_pendingEmail` to be a primitive type in the JSON string but got " + data['_pendingEmail']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['customRoles'])) {
            throw new Error("Expected the field `customRoles` to be an array in the JSON data but got " + data['customRoles']);
        }
        // ensure the json data is a string
        if (data['mfa'] && !(typeof data['mfa'] === 'string' || data['mfa'] instanceof String)) {
            throw new Error("Expected the field `mfa` to be a primitive type in the JSON string but got " + data['mfa']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['excludedDashboards'])) {
            throw new Error("Expected the field `excludedDashboards` to be an array in the JSON data but got " + data['excludedDashboards']);
        }
        // validate the optional field `_lastSeenMetadata`
        if (data['_lastSeenMetadata']) { // data not null
          LastSeenMetadata.validateJSON(data['_lastSeenMetadata']);
        }
        // validate the optional field `_integrationMetadata`
        if (data['_integrationMetadata']) { // data not null
          IntegrationMetadata.validateJSON(data['_integrationMetadata']);
        }
        if (data['teams']) { // data not null
            ...
            for (const item of data['teams']) {
                MemberTeamSummaryRep.validateJSON(item);
            };
        }
        if (data['permissionGrants']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['permissionGrants'])) {
                throw new Error("Expected the field `permissionGrants` to be an array in the JSON data but got " + data['permissionGrants']);
            }
            // validate the optional field `permissionGrants` (array)
            for (const item of data['permissionGrants']) {
                MemberPermissionGrantSummaryRep.validateJSON(item);
            };
        }
        // ensure the json data is an array
        if (!Array.isArray(data['oauthProviders'])) {
            throw new Error("Expected the field `oauthProviders` to be an array in the JSON data but got " + data['oauthProviders']);
        }
...
Member.RequiredProperties = ["_links", "_id", "role", "email", "_pendingInvite", "_verified", "customRoles", "mfa", "_lastSeen", "creationDate"];

/**
 * The location and content type of related resources
 * @member {Object.<String, module:model/Link>} _links
 */
Member.prototype['_links'] = undefined;
 ...
 */
Member.prototype['_pendingInvite'] = undefined;

/**
 * Whether the member's email address has been verified
 * @member {Boolean} _verified
 */
Member.prototype['_verified'] = undefined;

/**
 * The member's email address before it has been verified, for accounts where email verification is required
 * @member {String} _pendingEmail
 */
Member.prototype['_pendingEmail'] = undefined;

/**
 * The set of additional roles, besides the base role, assigned to the member
 * @member {Array.<String>} customRoles
 */
Member.prototype['customRoles'] = undefined;

/**
 * Whether multi-factor authentication is enabled for this member
 * @member {String} mfa
 */
Member.prototype['mfa'] = undefined;

/**
 * Default dashboards that the member has chosen to ignore
 * @member {Array.<String>} excludedDashboards
 */
Member.prototype['excludedDashboards'] = undefined;

/**
 * @member {Number} _lastSeen
 */
Member.prototype['_lastSeen'] = undefined;

/**
 * @member {module:model/LastSeenMetadata} _lastSeenMetadata
 */
Member.prototype['_lastSeenMetadata'] = undefined;

/**
 * @member {module:model/IntegrationMetadata} _integrationMetadata
 */
Member.prototype['_integrationMetadata'] = undefined;

/**
 * Details on the teams this member is assigned to
 * @member {Array.<module:model/MemberTeamSummaryRep>} teams
 */
Member.prototype['teams'] = undefined;
 ...
 * @member {Array.<String>} oauthProviders
 */
Member.prototype['oauthProviders'] = undefined;

/**
 * Version of the current configuration
 * @member {Number} version
 */
Member.prototype['version'] = undefined;

/**
 * @member {Object.<String, Array.<String>>} roleAttributes
 */
Member.prototype['roleAttributes'] = undefined;
