...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_lastSeenMetadata')) {
        obj['_lastSeenMetadata'] = MemberLastSeenMetadata.constructFromObject(data['_lastSeenMetadata']);
      }
    }
    return obj;
  }
   ...
   */
  exports.prototype['_lastSeen'] = undefined;
  /**
   * @member {module:model/MemberLastSeenMetadata} _lastSeenMetadata
   */
  exports.prototype['_lastSeenMetadata'] = undefined;
