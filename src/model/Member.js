...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Id', 'model/Links', 'model/MemberLastSeenMetadata', 'model/Role'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Id'), require('./Links'), require('./MemberLastSeenMetadata'), require('./Role'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyApi) {
      root.LaunchDarklyApi = {};
    }
    root.LaunchDarklyApi.Member = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.Id, root.LaunchDarklyApi.Links, root.LaunchDarklyApi.MemberLastSeenMetadata, root.LaunchDarklyApi.Role);
  }
}(this, function(ApiClient, Id, Links, MemberLastSeenMetadata, Role) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_verified'))
        obj.verified = ApiClient.convertToType(data['_verified'], 'Boolean');
      if (data.hasOwnProperty('_pendingInvite'))
        obj.pendingInvite = ApiClient.convertToType(data['_pendingInvite'], 'Boolean');
      ...
      if (data.hasOwnProperty('_lastSeen'))
        obj.lastSeen = ApiClient.convertToType(data['_lastSeen'], 'Number');
      if (data.hasOwnProperty('_lastSeenMetadata'))
        obj.lastSeenMetadata = MemberLastSeenMetadata.constructFromObject(data['_lastSeenMetadata']);
    }
    return obj;
  }
  ...
  /**
   * @member {Boolean} pendingInvite
   */
  exports.prototype.pendingInvite = undefined;
  ...
  /**
   * @member {module:model/MemberLastSeenMetadata} lastSeenMetadata
   */
  exports.prototype.lastSeenMetadata = undefined;
