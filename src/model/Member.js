...
class Member {
     ...
     * @param role {String} The member's built-in role. If the member has no custom roles, this role will be in effect.
     ...
     * @param customRoles {Array.<String>} The set of custom roles (as keys) assigned to the member
