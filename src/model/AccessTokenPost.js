...
class AccessTokenPost {
    /**
     * Constructs a new <code>AccessTokenPost</code>.
     * @alias module:model/AccessTokenPost
     */
    constructor() { 
        
        AccessTokenPost.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccessTokenPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccessTokenPost} obj Optional instance to populate.
     * @return {module:model/AccessTokenPost} The populated <code>AccessTokenPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccessTokenPost();
            ...
            if (data.hasOwnProperty('inlineRole')) {
                obj['inlineRole'] = ApiClient.convertToType(data['inlineRole'], [StatementPost]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AccessTokenPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccessTokenPost</code>.
     */
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['customRoleIds'])) {
            throw new Error("Expected the field `customRoleIds` to be an array in the JSON data but got " + data['customRoleIds']);
        }
        if (data['inlineRole']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['inlineRole'])) {
                throw new Error("Expected the field `inlineRole` to be an array in the JSON data but got " + data['inlineRole']);
            }
            // validate the optional field `inlineRole` (array)
            for (const item of data['inlineRole']) {
                StatementPost.validateJSON(item);
            };
        }
 ...
 * @member {String} name
 */
AccessTokenPost.prototype['name'] = undefined;

/**
 * A description for the access token
 * @member {String} description
 */
AccessTokenPost.prototype['description'] = undefined;

/**
 * Base role for the token
 * @member {module:model/AccessTokenPost.RoleEnum} role
 */
AccessTokenPost.prototype['role'] = undefined;

/**
 * A list of custom role IDs to use as access limits for the access token
 * @member {Array.<String>} customRoleIds
 */
AccessTokenPost.prototype['customRoleIds'] = undefined;
 ...
 * @member {Array.<module:model/StatementPost>} inlineRole
 */
AccessTokenPost.prototype['inlineRole'] = undefined;

/**
 * Whether the token is a service token
 * @member {Boolean} serviceToken
 */
AccessTokenPost.prototype['serviceToken'] = undefined;

/**
 * The default API version for this token
 * @member {Number} defaultApiVersion
 */
AccessTokenPost.prototype['defaultApiVersion'] = undefined;
...
export default AccessTokenPost;
