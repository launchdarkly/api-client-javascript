    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('statements')) {
                obj['statements'] = ApiClient.convertToType(data['statements'], [StatementRep]);
            }
            ...
            if (data.hasOwnProperty('_status')) {
                obj['_status'] = IntegrationSubscriptionStatusRep.constructFromObject(data['_status']);
            }
 ...
 */
Integration.prototype['_links'] = undefined;

/**
 * @member {String} _id
 */
Integration.prototype['_id'] = undefined;

/**
 * @member {String} kind
 */
Integration.prototype['kind'] = undefined;
 ...
 */
Integration.prototype['config'] = undefined;

/**
 * @member {Array.<module:model/StatementRep>} statements
 */
Integration.prototype['statements'] = undefined;

/**
 * @member {Boolean} on
 */
Integration.prototype['on'] = undefined;

/**
 * @member {Array.<String>} tags
 */
Integration.prototype['tags'] = undefined;

/**
 * @member {module:model/AccessRep} _access
 */
Integration.prototype['_access'] = undefined;

/**
 * @member {module:model/IntegrationSubscriptionStatusRep} _status
 */
Integration.prototype['_status'] = undefined;

/**
 * @member {String} url
 */
Integration.prototype['url'] = undefined;

/**
 * @member {String} apiKey
 */
Integration.prototype['apiKey'] = undefined;
