...
class MetricV2Rep {
    /**
     * Constructs a new <code>MetricV2Rep</code>.
     * @alias module:model/MetricV2Rep
     * @param key {String} The metric key
     * @param name {String} The metric name
     * @param kind {module:model/MetricV2Rep.KindEnum} The kind of event the metric tracks
    ...
    constructor(key, name, kind, links) { 
        ...
        MetricV2Rep.initialize(this, key, name, kind, links);
    }
    ...
    /**
     * Constructs a <code>MetricV2Rep</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MetricV2Rep} obj Optional instance to populate.
     * @return {module:model/MetricV2Rep} The populated <code>MetricV2Rep</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MetricV2Rep();
    ...
    /**
     * Validates the JSON data with respect to <code>MetricV2Rep</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MetricV2Rep</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MetricV2Rep.RequiredProperties) {
...
MetricV2Rep.RequiredProperties = ["key", "name", "kind", "_links"];

/**
 * The metric key
 * @member {String} key
 */
MetricV2Rep.prototype['key'] = undefined;

/**
 * The version ID of the metric
 * @member {String} _versionId
 */
MetricV2Rep.prototype['_versionId'] = undefined;

/**
 * The metric name
 * @member {String} name
 */
MetricV2Rep.prototype['name'] = undefined;

/**
 * The kind of event the metric tracks
 * @member {module:model/MetricV2Rep.KindEnum} kind
 */
MetricV2Rep.prototype['kind'] = undefined;
 ...
 */
MetricV2Rep.prototype['isNumeric'] = undefined;

/**
 * The type of unit aggregation to use for the metric
 * @member {module:model/MetricV2Rep.UnitAggregationTypeEnum} unitAggregationType
 */
MetricV2Rep.prototype['unitAggregationType'] = undefined;

/**
 * The event key sent with the metric. Only relevant for custom metrics.
 * @member {String} eventKey
 */
MetricV2Rep.prototype['eventKey'] = undefined;

/**
 * The location and content type of related resources
 * @member {Object.<String, module:model/Link>} _links
 */
MetricV2Rep.prototype['_links'] = undefined;
 ...
 * @readonly
 */
MetricV2Rep['UnitAggregationTypeEnum'] = {
