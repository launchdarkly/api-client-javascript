    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('_member')) {
                obj['_member'] = MemberSummaryRep.constructFromObject(data['_member']);
            }
            ...
            if (data.hasOwnProperty('inlineRole')) {
                obj['inlineRole'] = ApiClient.convertToType(data['inlineRole'], [StatementRep]);
            }
...
/**
 * @member {module:model/MemberSummaryRep} _member
 */
...
/**
 * @member {Array.<module:model/StatementRep>} inlineRole
 */
