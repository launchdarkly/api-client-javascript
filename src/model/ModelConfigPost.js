...
/**
 * The ModelConfigPost model module.
 * @module model/ModelConfigPost
 * @version 18.0.1
 */
class ModelConfigPost {
    /**
     * Constructs a new <code>ModelConfigPost</code>.
     * @alias module:model/ModelConfigPost
     ...
     */
    constructor(name, key, id) { 
        
        ModelConfigPost.initialize(this, name, key, id);
    }
     ...
     */
    static initialize(obj, name, key, id) { 
        obj['name'] = name;
        obj['key'] = key;
        obj['id'] = id;
    }
    ...
    /**
     * Constructs a <code>ModelConfigPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelConfigPost} obj Optional instance to populate.
     * @return {module:model/ModelConfigPost} The populated <code>ModelConfigPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ModelConfigPost();
    ...
    /**
     * Validates the JSON data with respect to <code>ModelConfigPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModelConfigPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ModelConfigPost.RequiredProperties) {
...
ModelConfigPost.RequiredProperties = ["name", "key", "id"];

/**
 * Human readable name of the model
 * @member {String} name
 */
ModelConfigPost.prototype['name'] = undefined;

/**
 * Unique key for the model
 * @member {String} key
 */
ModelConfigPost.prototype['key'] = undefined;

/**
 * Identifier for the model, for use with third party providers
 * @member {String} id
 */
ModelConfigPost.prototype['id'] = undefined;

/**
 * Icon for the model
 * @member {String} icon
 */
ModelConfigPost.prototype['icon'] = undefined;

/**
 * Provider for the model
 * @member {String} provider
 */
ModelConfigPost.prototype['provider'] = undefined;

/**
 * @member {Object} params
 */
ModelConfigPost.prototype['params'] = undefined;

/**
 * @member {Object} customParams
 */
ModelConfigPost.prototype['customParams'] = undefined;

/**
 * @member {Array.<String>} tags
 */
ModelConfigPost.prototype['tags'] = undefined;

/**
 * Cost per input token in USD
 * @member {Number} costPerInputToken
 */
ModelConfigPost.prototype['costPerInputToken'] = undefined;

/**
 * Cost per output token in USD
 * @member {Number} costPerOutputToken
 */
ModelConfigPost.prototype['costPerOutputToken'] = undefined;
...
export default ModelConfigPost;
