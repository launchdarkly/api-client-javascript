...
class UserSegment {
     ...
     * @param name {String} A human-friendly name for the segment.
     * @param tags {Array.<String>} Tags for the segment. Defaults to an empty array.
     * @param creationDate {Number} 
     * @param lastModifiedDate {Number} 
     * @param key {String} A unique key used to reference the segment
     * @param links {Object.<String, module:model/Link>} The location and content type of related resources
     * @param rules {Array.<module:model/UserSegmentRule>} An array of the targeting rules for this segment.
     * @param version {Number} Version of the segment
     * @param deleted {Boolean} Whether the segment has been deleted
     * @param generation {Number} For big segments, how many times this segment has been created.
     */
    constructor(name, tags, creationDate, lastModifiedDate, key, links, rules, version, deleted, generation) { 
        
        UserSegment.initialize(this, name, tags, creationDate, lastModifiedDate, key, links, rules, version, deleted, generation);
    }
     ...
     */
    static initialize(obj, name, tags, creationDate, lastModifiedDate, key, links, rules, version, deleted, generation) { 
        obj['name'] = name;
        obj['tags'] = tags;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('includedContexts')) {
                obj['includedContexts'] = ApiClient.convertToType(data['includedContexts'], [SegmentTarget]);
            }
            if (data.hasOwnProperty('excludedContexts')) {
                obj['excludedContexts'] = ApiClient.convertToType(data['excludedContexts'], [SegmentTarget]);
            }
            ...
            if (data.hasOwnProperty('_flags')) {
                obj['_flags'] = ApiClient.convertToType(data['_flags'], [FlagListingRep]);
            }
            if (data.hasOwnProperty('unbounded')) {
                obj['unbounded'] = ApiClient.convertToType(data['unbounded'], 'Boolean');
            }
            if (data.hasOwnProperty('unboundedContextKind')) {
                obj['unboundedContextKind'] = ApiClient.convertToType(data['unboundedContextKind'], 'String');
            }
            if (data.hasOwnProperty('generation')) {
                obj['generation'] = ApiClient.convertToType(data['generation'], 'Number');
            }
            if (data.hasOwnProperty('_unboundedMetadata')) {
                obj['_unboundedMetadata'] = SegmentMetadata.constructFromObject(data['_unboundedMetadata']);
            }
            if (data.hasOwnProperty('_external')) {
                obj['_external'] = ApiClient.convertToType(data['_external'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UserSegment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserSegment</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserSegment.RequiredProperties) {
        ...
        if (data['includedContexts']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['includedContexts'])) {
                throw new Error("Expected the field `includedContexts` to be an array in the JSON data but got " + data['includedContexts']);
            }
            // validate the optional field `includedContexts` (array)
            for (const item of data['includedContexts']) {
                SegmentTarget.validateJSON(item);
            };
        }
        if (data['excludedContexts']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['excludedContexts'])) {
                throw new Error("Expected the field `excludedContexts` to be an array in the JSON data but got " + data['excludedContexts']);
            }
            // validate the optional field `excludedContexts` (array)
            for (const item of data['excludedContexts']) {
                SegmentTarget.validateJSON(item);
            };
        }
        if (data['rules']) { // data not null
            ...
            for (const item of data['rules']) {
                UserSegmentRule.validateJSON(item);
            };
        }
        ...
        if (data['_flags']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['_flags'])) {
                throw new Error("Expected the field `_flags` to be an array in the JSON data but got " + data['_flags']);
            }
            // validate the optional field `_flags` (array)
            for (const item of data['_flags']) {
                FlagListingRep.validateJSON(item);
            };
        }
        // ensure the json data is a string
        if (data['unboundedContextKind'] && !(typeof data['unboundedContextKind'] === 'string' || data['unboundedContextKind'] instanceof String)) {
            throw new Error("Expected the field `unboundedContextKind` to be a primitive type in the JSON string but got " + data['unboundedContextKind']);
        }
        // validate the optional field `_unboundedMetadata`
        if (data['_unboundedMetadata']) { // data not null
          SegmentMetadata.validateJSON(data['_unboundedMetadata']);
        }
        // ensure the json data is a string
        if (data['_external'] && !(typeof data['_external'] === 'string' || data['_external'] instanceof String)) {
            throw new Error("Expected the field `_external` to be a primitive type in the JSON string but got " + data['_external']);
        }
        // ensure the json data is a string
        if (data['_externalLink'] && !(typeof data['_externalLink'] === 'string' || data['_externalLink'] instanceof String)) {
            throw new Error("Expected the field `_externalLink` to be a primitive type in the JSON string but got " + data['_externalLink']);
        }
...
UserSegment.RequiredProperties = ["name", "tags", "creationDate", "lastModifiedDate", "key", "_links", "rules", "version", "deleted", "generation"];

/**
 * A human-friendly name for the segment.
 * @member {String} name
 */
UserSegment.prototype['name'] = undefined;

/**
 * A description of the segment's purpose. Defaults to <code>null</code> and is omitted in the response if not provided.
 * @member {String} description
 */
UserSegment.prototype['description'] = undefined;

/**
 * Tags for the segment. Defaults to an empty array.
 * @member {Array.<String>} tags
 */
UserSegment.prototype['tags'] = undefined;

/**
 * @member {Number} creationDate
 */
UserSegment.prototype['creationDate'] = undefined;

/**
 * @member {Number} lastModifiedDate
 */
UserSegment.prototype['lastModifiedDate'] = undefined;

/**
 * A unique key used to reference the segment
 * @member {String} key
 */
UserSegment.prototype['key'] = undefined;
 ...
 */
UserSegment.prototype['included'] = undefined;
 ...
 */
UserSegment.prototype['excluded'] = undefined;

/**
 * @member {Array.<module:model/SegmentTarget>} includedContexts
 */
UserSegment.prototype['includedContexts'] = undefined;

/**
 * @member {Array.<module:model/SegmentTarget>} excludedContexts
 */
UserSegment.prototype['excludedContexts'] = undefined;

/**
 * The location and content type of related resources
 * @member {Object.<String, module:model/Link>} _links
 */
UserSegment.prototype['_links'] = undefined;

/**
 * An array of the targeting rules for this segment.
 * @member {Array.<module:model/UserSegmentRule>} rules
 */
UserSegment.prototype['rules'] = undefined;

/**
 * Version of the segment
 * @member {Number} version
 */
UserSegment.prototype['version'] = undefined;

/**
 * Whether the segment has been deleted
 * @member {Boolean} deleted
 */
UserSegment.prototype['deleted'] = undefined;

/**
 * @member {module:model/Access} _access
 */
UserSegment.prototype['_access'] = undefined;
 ...
 * @member {Array.<module:model/FlagListingRep>} _flags
 */
UserSegment.prototype['_flags'] = undefined;
 ...
 */
UserSegment.prototype['unbounded'] = undefined;

/**
 * For big segments, the targeted context kind.
 * @member {String} unboundedContextKind
 */
UserSegment.prototype['unboundedContextKind'] = undefined;

/**
 * For big segments, how many times this segment has been created.
 * @member {Number} generation
 */
UserSegment.prototype['generation'] = undefined;

/**
 * @member {module:model/SegmentMetadata} _unboundedMetadata
 */
UserSegment.prototype['_unboundedMetadata'] = undefined;

/**
 * The external data store backing this segment. Only applies to synced segments.
 * @member {String} _external
 */
UserSegment.prototype['_external'] = undefined;
