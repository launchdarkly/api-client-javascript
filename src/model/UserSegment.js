...
class UserSegment {
     ...
     */
    constructor(name, tags, creationDate, key, links, rules, version, deleted, generation) { 
        
        UserSegment.initialize(this, name, tags, creationDate, key, links, rules, version, deleted, generation);
    }
     ...
     */
    static initialize(obj, name, tags, creationDate, key, links, rules, version, deleted, generation) { 
        obj['name'] = name;
        obj['tags'] = tags;
