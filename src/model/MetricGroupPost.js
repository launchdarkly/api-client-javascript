...
class MetricGroupPost {
    /**
     * Constructs a new <code>MetricGroupPost</code>.
     * @alias module:model/MetricGroupPost
     * @param name {String} A human-friendly name for the metric group
     * @param kind {module:model/MetricGroupPost.KindEnum} The type of the metric group
     * @param maintainerId {String} The ID of the member who maintains this metric group
     * @param tags {Array.<String>} Tags for the metric group
     * @param metrics {Array.<module:model/MetricInMetricGroupInput>} An ordered list of the metrics in this metric group
     */
    constructor(name, kind, maintainerId, tags, metrics) { 
        
        MetricGroupPost.initialize(this, name, kind, maintainerId, tags, metrics);
    }
     ...
     */
    static initialize(obj, name, kind, maintainerId, tags, metrics) { 
        obj['name'] = name;
        obj['kind'] = kind;
        obj['maintainerId'] = maintainerId;
        obj['tags'] = tags;
        obj['metrics'] = metrics;
    }

    /**
     * Constructs a <code>MetricGroupPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MetricGroupPost} obj Optional instance to populate.
     * @return {module:model/MetricGroupPost} The populated <code>MetricGroupPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MetricGroupPost();
            ...
            if (data.hasOwnProperty('metrics')) {
                obj['metrics'] = ApiClient.convertToType(data['metrics'], [MetricInMetricGroupInput]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MetricGroupPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MetricGroupPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MetricGroupPost.RequiredProperties) {
        ...
        if (data['metrics']) { // data not null
            ...
            for (const item of data['metrics']) {
                MetricInMetricGroupInput.validateJSON(item);
            };
        }
...
MetricGroupPost.RequiredProperties = ["name", "kind", "maintainerId", "tags", "metrics"];

/**
 * A unique key to reference the metric group
 * @member {String} key
 */
MetricGroupPost.prototype['key'] = undefined;

/**
 * A human-friendly name for the metric group
 * @member {String} name
 */
MetricGroupPost.prototype['name'] = undefined;

/**
 * The type of the metric group
 * @member {module:model/MetricGroupPost.KindEnum} kind
 */
MetricGroupPost.prototype['kind'] = undefined;

/**
 * Description of the metric group
 * @member {String} description
 */
MetricGroupPost.prototype['description'] = undefined;

/**
 * The ID of the member who maintains this metric group
 * @member {String} maintainerId
 */
MetricGroupPost.prototype['maintainerId'] = undefined;

/**
 * Tags for the metric group
 * @member {Array.<String>} tags
 */
MetricGroupPost.prototype['tags'] = undefined;

/**
 * An ordered list of the metrics in this metric group
 * @member {Array.<module:model/MetricInMetricGroupInput>} metrics
 */
MetricGroupPost.prototype['metrics'] = undefined;
...
export default MetricGroupPost;
