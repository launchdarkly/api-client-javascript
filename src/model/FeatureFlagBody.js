...
class FeatureFlagBody {
     ...
     * @param key {String} A unique key to reference the flag in your code
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('variations')) {
                obj['variations'] = ApiClient.convertToType(data['variations'], [Variate]);
            }
 ...
 * @member {Array.<module:model/Variate>} variations
 */
 ...
 */
FeatureFlagBody.prototype['variationJsonSchema'] = undefined;
