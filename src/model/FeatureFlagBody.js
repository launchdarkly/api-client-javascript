...
class FeatureFlagBody {
    ...
    constructor(name, key) { 
        ...
        FeatureFlagBody.initialize(this, name, key);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('clientSideAvailability')) {
                obj['clientSideAvailability'] = ClientSideAvailabilityPost.constructFromObject(data['clientSideAvailability']);
            }
            ...
            if (data.hasOwnProperty('initialPrerequisites')) {
                obj['initialPrerequisites'] = ApiClient.convertToType(data['initialPrerequisites'], [FlagPrerequisitePost]);
            }
            if (data.hasOwnProperty('isFlagOn')) {
                obj['isFlagOn'] = ApiClient.convertToType(data['isFlagOn'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FeatureFlagBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FeatureFlagBody</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FeatureFlagBody.RequiredProperties) {
        ...
        if (data['clientSideAvailability']) { // data not null
          ClientSideAvailabilityPost.validateJSON(data['clientSideAvailability']);
        }
        ...
        if (data['migrationSettings']) { // data not null
          MigrationSettingsPost.validateJSON(data['migrationSettings']);
        }
        // ensure the json data is a string
        ...
        if (data['initialPrerequisites']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['initialPrerequisites'])) {
                throw new Error("Expected the field `initialPrerequisites` to be an array in the JSON data but got " + data['initialPrerequisites']);
            }
            // validate the optional field `initialPrerequisites` (array)
            for (const item of data['initialPrerequisites']) {
                FlagPrerequisitePost.validateJSON(item);
            };
        }
...
FeatureFlagBody.RequiredProperties = ["name", "key"];

/**
 * A human-friendly name for the feature flag
 * @member {String} name
 */
FeatureFlagBody.prototype['name'] = undefined;

/**
 * A unique key used to reference the flag in your code
 * @member {String} key
 */
FeatureFlagBody.prototype['key'] = undefined;

/**
 * Description of the feature flag. Defaults to an empty string.
 * @member {String} description
 */
FeatureFlagBody.prototype['description'] = undefined;
 ...
 */
FeatureFlagBody.prototype['includeInSnippet'] = undefined;

/**
 * @member {module:model/ClientSideAvailabilityPost} clientSideAvailability
 */
FeatureFlagBody.prototype['clientSideAvailability'] = undefined;
 ...
 */
FeatureFlagBody.prototype['variations'] = undefined;

/**
 * Whether the flag is a temporary flag. Defaults to <code>true</code>.
 * @member {Boolean} temporary
 */
FeatureFlagBody.prototype['temporary'] = undefined;

/**
 * Tags for the feature flag. Defaults to an empty array.
 * @member {Array.<String>} tags
 */
FeatureFlagBody.prototype['tags'] = undefined;

/**
 * @member {Object.<String, module:model/CustomProperty>} customProperties
 */
FeatureFlagBody.prototype['customProperties'] = undefined;

/**
 * @member {module:model/Defaults} defaults
 */
FeatureFlagBody.prototype['defaults'] = undefined;

/**
 * Purpose of the flag
 * @member {module:model/FeatureFlagBody.PurposeEnum} purpose
 */
FeatureFlagBody.prototype['purpose'] = undefined;
 ...
 * @member {Array.<module:model/FlagPrerequisitePost>} initialPrerequisites
 */
FeatureFlagBody.prototype['initialPrerequisites'] = undefined;

/**
 * Whether to automatically turn the flag on across all environments at creation. Defaults to <code>false</code>.
 * @member {Boolean} isFlagOn
 */
FeatureFlagBody.prototype['isFlagOn'] = undefined;
