...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Defaults', 'model/Variation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Defaults'), require('./Variation'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyApi) {
      root.LaunchDarklyApi = {};
    }
    root.LaunchDarklyApi.FeatureFlagBody = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.Defaults, root.LaunchDarklyApi.Variation);
  }
}(this, function(ApiClient, Defaults, Variation) {
  'use strict';
