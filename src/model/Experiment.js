...
class Experiment {
     ...
     * @param key {String} The experiment key
     * @param name {String} The experiment name
     * @param maintainerId {String} The ID of the member who maintains this experiment.
     ...
     */
    constructor(key, name, maintainerId, creationDate, environmentKey, links) { 
        
        Experiment.initialize(this, key, name, maintainerId, creationDate, environmentKey, links);
    }
     ...
     */
    static initialize(obj, key, name, maintainerId, creationDate, environmentKey, links) { 
        obj['key'] = key;
        obj['name'] = name;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('currentIteration')) {
                obj['currentIteration'] = IterationRep.constructFromObject(data['currentIteration']);
            }
            if (data.hasOwnProperty('draftIteration')) {
                obj['draftIteration'] = IterationRep.constructFromObject(data['draftIteration']);
            }
            if (data.hasOwnProperty('previousIterations')) {
                obj['previousIterations'] = ApiClient.convertToType(data['previousIterations'], [IterationRep]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Experiment.RequiredProperties) {
        ...
        if (data['currentIteration']) { // data not null
          IterationRep.validateJSON(data['currentIteration']);
        }
        // validate the optional field `draftIteration`
        if (data['draftIteration']) { // data not null
          IterationRep.validateJSON(data['draftIteration']);
        }
        if (data['previousIterations']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['previousIterations'])) {
                throw new Error("Expected the field `previousIterations` to be an array in the JSON data but got " + data['previousIterations']);
            }
            // validate the optional field `previousIterations` (array)
            for (const item of data['previousIterations']) {
                IterationRep.validateJSON(item);
            };
        }
...
Experiment.RequiredProperties = ["key", "name", "_maintainerId", "_creationDate", "environmentKey", "_links"];

/**
 * The experiment ID
 * @member {String} _id
 */
Experiment.prototype['_id'] = undefined;

/**
 * The experiment key
 * @member {String} key
 */
Experiment.prototype['key'] = undefined;
 ...
 */
Experiment.prototype['_maintainerId'] = undefined;

/**
 * @member {Number} _creationDate
 */
Experiment.prototype['_creationDate'] = undefined;

/**
 * @member {String} environmentKey
 */
Experiment.prototype['environmentKey'] = undefined;
 ...
 */
Experiment.prototype['_links'] = undefined;

/**
 * The holdout ID
 * @member {String} holdoutId
 */
Experiment.prototype['holdoutId'] = undefined;

/**
 * @member {module:model/IterationRep} currentIteration
 */
Experiment.prototype['currentIteration'] = undefined;

/**
 * @member {module:model/IterationRep} draftIteration
 */
Experiment.prototype['draftIteration'] = undefined;

/**
 * Details on the previous iterations for this experiment.
 * @member {Array.<module:model/IterationRep>} previousIterations
 */
Experiment.prototype['previousIterations'] = undefined;
