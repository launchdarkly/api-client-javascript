...
class Experiment {
     ...
     */
    constructor(key, name, maintainerId, creationDate, links) { 
        
        Experiment.initialize(this, key, name, maintainerId, creationDate, links);
    }
     ...
     */
    static initialize(obj, key, name, maintainerId, creationDate, links) { 
        obj['key'] = key;
        obj['name'] = name;
