 ...
 */
RuleClause.prototype['attribute'] = undefined;

/**
 * The operator to apply to the given attribute
 * @member {module:model/RuleClause.OpEnum} op
 */
RuleClause.prototype['op'] = undefined;

/**
 * Whether the operator should be negated
 * @member {Boolean} negate
 */
RuleClause.prototype['negate'] = undefined;
