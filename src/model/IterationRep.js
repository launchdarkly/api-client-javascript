...
class IterationRep {
    ...
    constructor(hypothesis, status, createdAt) { 
        ...
        IterationRep.initialize(this, hypothesis, status, createdAt);
    }
     ...
     */
    static initialize(obj, hypothesis, status, createdAt) { 
    ...
    /**
     * Constructs a <code>IterationRep</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IterationRep} obj Optional instance to populate.
     * @return {module:model/IterationRep} The populated <code>IterationRep</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IterationRep();

            if (data.hasOwnProperty('_id')) {
                obj['_id'] = ApiClient.convertToType(data['_id'], 'String');
            }
            if (data.hasOwnProperty('hypothesis')) {
                obj['hypothesis'] = ApiClient.convertToType(data['hypothesis'], 'String');
            }
            ...
            if (data.hasOwnProperty('reallocationFrequencyMillis')) {
                obj['reallocationFrequencyMillis'] = ApiClient.convertToType(data['reallocationFrequencyMillis'], 'Number');
            }
            if (data.hasOwnProperty('version')) {
                obj['version'] = ApiClient.convertToType(data['version'], 'Number');
            }
            if (data.hasOwnProperty('primaryMetric')) {
                obj['primaryMetric'] = DependentMetricOrMetricGroupRep.constructFromObject(data['primaryMetric']);
            }
            if (data.hasOwnProperty('primarySingleMetric')) {
                obj['primarySingleMetric'] = MetricV2Rep.constructFromObject(data['primarySingleMetric']);
            }
            if (data.hasOwnProperty('primaryFunnel')) {
                obj['primaryFunnel'] = DependentMetricGroupRepWithMetrics.constructFromObject(data['primaryFunnel']);
            }
            ...
            if (data.hasOwnProperty('metrics')) {
                obj['metrics'] = ApiClient.convertToType(data['metrics'], [DependentMetricOrMetricGroupRep]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>IterationRep</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IterationRep</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IterationRep.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['hypothesis'] && !(typeof data['hypothesis'] === 'string' || data['hypothesis'] instanceof String)) {
            throw new Error("Expected the field `hypothesis` to be a primitive type in the JSON string but got " + data['hypothesis']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['winningTreatmentId'] && !(typeof data['winningTreatmentId'] === 'string' || data['winningTreatmentId'] instanceof String)) {
            throw new Error("Expected the field `winningTreatmentId` to be a primitive type in the JSON string but got " + data['winningTreatmentId']);
        }
        // ensure the json data is a string
        if (data['winningReason'] && !(typeof data['winningReason'] === 'string' || data['winningReason'] instanceof String)) {
            throw new Error("Expected the field `winningReason` to be a primitive type in the JSON string but got " + data['winningReason']);
        }
        // validate the optional field `primaryMetric`
        if (data['primaryMetric']) { // data not null
          DependentMetricOrMetricGroupRep.validateJSON(data['primaryMetric']);
        }
        // validate the optional field `primarySingleMetric`
        if (data['primarySingleMetric']) { // data not null
          MetricV2Rep.validateJSON(data['primarySingleMetric']);
        }
        // validate the optional field `primaryFunnel`
        if (data['primaryFunnel']) { // data not null
          DependentMetricGroupRepWithMetrics.validateJSON(data['primaryFunnel']);
        }
        // ensure the json data is a string
        ...
        if (data['treatments']) { // data not null
            ...
            for (const item of data['treatments']) {
                TreatmentRep.validateJSON(item);
            };
        }
        if (data['secondaryMetrics']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['secondaryMetrics'])) {
                throw new Error("Expected the field `secondaryMetrics` to be an array in the JSON data but got " + data['secondaryMetrics']);
            }
            // validate the optional field `secondaryMetrics` (array)
            for (const item of data['secondaryMetrics']) {
                MetricV2Rep.validateJSON(item);
            };
        }
        if (data['metrics']) { // data not null
            ...
            for (const item of data['metrics']) {
                DependentMetricOrMetricGroupRep.validateJSON(item);
            };
        }
...
IterationRep.RequiredProperties = ["hypothesis", "status", "createdAt"];

/**
 * The iteration ID
 * @member {String} _id
 */
IterationRep.prototype['_id'] = undefined;

/**
 * The expected outcome of this experiment
 * @member {String} hypothesis
 */
IterationRep.prototype['hypothesis'] = undefined;
 ...
 */
IterationRep.prototype['createdAt'] = undefined;

/**
 * @member {Number} startedAt
 */
IterationRep.prototype['startedAt'] = undefined;

/**
 * @member {Number} endedAt
 */
IterationRep.prototype['endedAt'] = undefined;

/**
 * The ID of the treatment chosen when the experiment stopped
 * @member {String} winningTreatmentId
 */
 ...
 * @member {Object.<String, module:model/FlagRep>} flags
 */
 ...
 * @member {Number} reallocationFrequencyMillis
 */
IterationRep.prototype['reallocationFrequencyMillis'] = undefined;

/**
 * The current version that the iteration is on
 * @member {Number} version
 */
IterationRep.prototype['version'] = undefined;

/**
 * @member {module:model/DependentMetricOrMetricGroupRep} primaryMetric
 */
IterationRep.prototype['primaryMetric'] = undefined;

/**
 * @member {module:model/MetricV2Rep} primarySingleMetric
 */
IterationRep.prototype['primarySingleMetric'] = undefined;

/**
 * @member {module:model/DependentMetricGroupRepWithMetrics} primaryFunnel
 */
IterationRep.prototype['primaryFunnel'] = undefined;

/**
 * The unit of randomization for this iteration
 * @member {String} randomizationUnit
 */
IterationRep.prototype['randomizationUnit'] = undefined;

/**
 * The available attribute filters for this iteration
 * @member {Array.<String>} attributes
 */
IterationRep.prototype['attributes'] = undefined;

/**
 * Details on the variations you are testing in the experiment
 * @member {Array.<module:model/TreatmentRep>} treatments
 */
 ...
 * @member {Array.<module:model/DependentMetricOrMetricGroupRep>} metrics
 */
IterationRep.prototype['metrics'] = undefined;
