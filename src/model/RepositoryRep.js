...
class RepositoryRep {
    ...
    constructor(name, type, defaultBranch, enabled, version, links) { 
        ...
        RepositoryRep.initialize(this, name, type, defaultBranch, enabled, version, links);
    }
     ...
     */
    static initialize(obj, name, type, defaultBranch, enabled, version, links) { 
        obj['name'] = name;
        obj['type'] = type;
    ...
    /**
     * Constructs a <code>RepositoryRep</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryRep} obj Optional instance to populate.
     * @return {module:model/RepositoryRep} The populated <code>RepositoryRep</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryRep();
            ...
            if (data.hasOwnProperty('commitUrlTemplate')) {
                obj['commitUrlTemplate'] = ApiClient.convertToType(data['commitUrlTemplate'], 'String');
            }
            if (data.hasOwnProperty('hunkUrlTemplate')) {
                obj['hunkUrlTemplate'] = ApiClient.convertToType(data['hunkUrlTemplate'], 'String');
            }
            ...
            if (data.hasOwnProperty('branches')) {
                obj['branches'] = ApiClient.convertToType(data['branches'], [BranchRep]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryRep</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryRep</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RepositoryRep.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['commitUrlTemplate'] && !(typeof data['commitUrlTemplate'] === 'string' || data['commitUrlTemplate'] instanceof String)) {
            throw new Error("Expected the field `commitUrlTemplate` to be a primitive type in the JSON string but got " + data['commitUrlTemplate']);
        }
        // ensure the json data is a string
        if (data['hunkUrlTemplate'] && !(typeof data['hunkUrlTemplate'] === 'string' || data['hunkUrlTemplate'] instanceof String)) {
            throw new Error("Expected the field `hunkUrlTemplate` to be a primitive type in the JSON string but got " + data['hunkUrlTemplate']);
        }
        // ensure the json data is a string
...
RepositoryRep.RequiredProperties = ["name", "type", "defaultBranch", "enabled", "version", "_links"];
 ...
 */
RepositoryRep.prototype['_links'] = undefined;

/**
 * @member {module:model/Access} _access
 */
RepositoryRep.prototype['_access'] = undefined;
