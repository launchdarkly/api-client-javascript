...
class Metrics {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('inputTokens')) {
                obj['inputTokens'] = ApiClient.convertToType(data['inputTokens'], 'Number');
            }
            if (data.hasOwnProperty('outputTokens')) {
                obj['outputTokens'] = ApiClient.convertToType(data['outputTokens'], 'Number');
            }
            if (data.hasOwnProperty('totalTokens')) {
                obj['totalTokens'] = ApiClient.convertToType(data['totalTokens'], 'Number');
            }
            if (data.hasOwnProperty('generationCount')) {
                obj['generationCount'] = ApiClient.convertToType(data['generationCount'], 'Number');
            }
            if (data.hasOwnProperty('generationSuccessCount')) {
                obj['generationSuccessCount'] = ApiClient.convertToType(data['generationSuccessCount'], 'Number');
            }
            if (data.hasOwnProperty('generationErrorCount')) {
                obj['generationErrorCount'] = ApiClient.convertToType(data['generationErrorCount'], 'Number');
            }
            if (data.hasOwnProperty('thumbsUp')) {
                obj['thumbsUp'] = ApiClient.convertToType(data['thumbsUp'], 'Number');
            }
            if (data.hasOwnProperty('thumbsDown')) {
                obj['thumbsDown'] = ApiClient.convertToType(data['thumbsDown'], 'Number');
            }
            if (data.hasOwnProperty('durationMs')) {
                obj['durationMs'] = ApiClient.convertToType(data['durationMs'], 'Number');
            }
            if (data.hasOwnProperty('timeToFirstTokenMs')) {
                obj['timeToFirstTokenMs'] = ApiClient.convertToType(data['timeToFirstTokenMs'], 'Number');
            }
            if (data.hasOwnProperty('satisfactionRating')) {
                obj['satisfactionRating'] = ApiClient.convertToType(data['satisfactionRating'], 'Number');
            }
...
/**
 * @member {Number} inputTokens
 */
Metrics.prototype['inputTokens'] = undefined;

/**
 * @member {Number} outputTokens
 */
Metrics.prototype['outputTokens'] = undefined;

/**
 * @member {Number} totalTokens
 */
Metrics.prototype['totalTokens'] = undefined;

/**
 * Number of attempted generations
 * @member {Number} generationCount
 */
Metrics.prototype['generationCount'] = undefined;

/**
 * Number of successful generations
 * @member {Number} generationSuccessCount
 */
Metrics.prototype['generationSuccessCount'] = undefined;

/**
 * Number of generations with errors
 * @member {Number} generationErrorCount
 */
Metrics.prototype['generationErrorCount'] = undefined;

/**
 * @member {Number} thumbsUp
 */
Metrics.prototype['thumbsUp'] = undefined;

/**
 * @member {Number} thumbsDown
 */
Metrics.prototype['thumbsDown'] = undefined;

/**
 * @member {Number} durationMs
 */
Metrics.prototype['durationMs'] = undefined;

/**
 * @member {Number} timeToFirstTokenMs
 */
Metrics.prototype['timeToFirstTokenMs'] = undefined;

/**
 * A value between 0 and 1 representing satisfaction rating
 * @member {Number} satisfactionRating
 */
Metrics.prototype['satisfactionRating'] = undefined;

/**
 * Cost of input tokens in USD
 * @member {Number} inputCost
 */
Metrics.prototype['inputCost'] = undefined;
