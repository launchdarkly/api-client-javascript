...
/**
 * The PostDeploymentEventInput model module.
 * @module model/PostDeploymentEventInput
 * @version 18.0.0
 */
class PostDeploymentEventInput {
    /**
     * Constructs a new <code>PostDeploymentEventInput</code>.
     * @alias module:model/PostDeploymentEventInput
     * @param projectKey {String} The project key
     ...
     * @param version {String} The application version. You can set the application version to any string that includes only letters, numbers, periods (<code>.</code>), hyphens (<code>-</code>), or underscores (<code>_</code>).<br/><br/>We recommend setting the application version to at least the first seven characters of the SHA or to the tag of the GitHub commit for this deployment.
     * @param eventType {module:model/PostDeploymentEventInput.EventTypeEnum} The event type
     */
    constructor(projectKey, environmentKey, applicationKey, version, eventType) { 
        
        PostDeploymentEventInput.initialize(this, projectKey, environmentKey, applicationKey, version, eventType);
    }
     ...
     */
    static initialize(obj, projectKey, environmentKey, applicationKey, version, eventType) { 
    ...
    /**
     * Constructs a <code>PostDeploymentEventInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostDeploymentEventInput} obj Optional instance to populate.
     * @return {module:model/PostDeploymentEventInput} The populated <code>PostDeploymentEventInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostDeploymentEventInput();
            ...
            if (data.hasOwnProperty('applicationKind')) {
                obj['applicationKind'] = ApiClient.convertToType(data['applicationKind'], 'String');
            }
            ...
            if (data.hasOwnProperty('eventMetadata')) {
                obj['eventMetadata'] = ApiClient.convertToType(data['eventMetadata'], {'String': Object});
            }
            if (data.hasOwnProperty('deploymentMetadata')) {
                obj['deploymentMetadata'] = ApiClient.convertToType(data['deploymentMetadata'], {'String': Object});
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostDeploymentEventInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostDeploymentEventInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostDeploymentEventInput.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['applicationKind'] && !(typeof data['applicationKind'] === 'string' || data['applicationKind'] instanceof String)) {
            throw new Error("Expected the field `applicationKind` to be a primitive type in the JSON string but got " + data['applicationKind']);
        }
        // ensure the json data is a string
...
PostDeploymentEventInput.RequiredProperties = ["projectKey", "environmentKey", "applicationKey", "version", "eventType"];

/**
 * The project key
 * @member {String} projectKey
 */
PostDeploymentEventInput.prototype['projectKey'] = undefined;

/**
 * The environment key
 * @member {String} environmentKey
 */
PostDeploymentEventInput.prototype['environmentKey'] = undefined;
 ...
 */
PostDeploymentEventInput.prototype['applicationKey'] = undefined;

/**
 * The application name. This defines how the application is displayed
 * @member {String} applicationName
 */
PostDeploymentEventInput.prototype['applicationName'] = undefined;

/**
 * The kind of application. Default: <code>server</code>
 * @member {module:model/PostDeploymentEventInput.ApplicationKindEnum} applicationKind
 */
PostDeploymentEventInput.prototype['applicationKind'] = undefined;

/**
 * The application version. You can set the application version to any string that includes only letters, numbers, periods (<code>.</code>), hyphens (<code>-</code>), or underscores (<code>_</code>).<br/><br/>We recommend setting the application version to at least the first seven characters of the SHA or to the tag of the GitHub commit for this deployment.
 * @member {String} version
 */
PostDeploymentEventInput.prototype['version'] = undefined;

/**
 * The version name. This defines how the version is displayed
 * @member {String} versionName
 */
PostDeploymentEventInput.prototype['versionName'] = undefined;

/**
 * The event type
 * @member {module:model/PostDeploymentEventInput.EventTypeEnum} eventType
 */
PostDeploymentEventInput.prototype['eventType'] = undefined;

/**
 * @member {Number} eventTime
 */
PostDeploymentEventInput.prototype['eventTime'] = undefined;

/**
 * A JSON object containing metadata about the event
 * @member {Object.<String, Object>} eventMetadata
 */
PostDeploymentEventInput.prototype['eventMetadata'] = undefined;

/**
 * A JSON object containing metadata about the deployment
 * @member {Object.<String, Object>} deploymentMetadata
 */
PostDeploymentEventInput.prototype['deploymentMetadata'] = undefined;
...
/**
 * Allowed values for the <code>applicationKind</code> property.
 * @enum {String}
 * @readonly
 */
PostDeploymentEventInput['ApplicationKindEnum'] = {
 ...
 * @readonly
 */
PostDeploymentEventInput['EventTypeEnum'] = {
...
export default PostDeploymentEventInput;
