...
class Webhook {
     ...
     * @param id {String} The ID of this webhook
     * @param url {String} The URL to which LaunchDarkly sends an HTTP POST payload for this webhook
     * @param on {Boolean} Whether or not this webhook is enabled
     * @param tags {Array.<String>} List of tags for this webhook
     */
    constructor(links, id, url, on, tags) { 
        
        Webhook.initialize(this, links, id, url, on, tags);
    }
     ...
     */
    static initialize(obj, links, id, url, on, tags) { 
        obj['_links'] = links;
        obj['_id'] = id;
        obj['url'] = url;
        obj['on'] = on;
...
Webhook.RequiredProperties = ["_links", "_id", "url", "on", "tags"];
 ...
 */
Webhook.prototype['statements'] = undefined;

/**
 * Whether or not this webhook is enabled
 * @member {Boolean} on
 */
Webhook.prototype['on'] = undefined;
 ...
 */
Webhook.prototype['_access'] = undefined;
