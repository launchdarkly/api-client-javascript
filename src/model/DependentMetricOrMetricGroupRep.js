...
class DependentMetricOrMetricGroupRep {
     ...
     */
    constructor(key, name, kind, links, isGroup) { 
        
        DependentMetricOrMetricGroupRep.initialize(this, key, name, kind, links, isGroup);
    }
     ...
     */
    static initialize(obj, key, name, kind, links, isGroup) { 
        obj['key'] = key;
        obj['name'] = name;
        obj['kind'] = kind;
        obj['_links'] = links;
