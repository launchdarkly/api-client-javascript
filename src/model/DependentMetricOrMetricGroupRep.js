...
class DependentMetricOrMetricGroupRep {
    /**
     * Constructs a new <code>DependentMetricOrMetricGroupRep</code>.
     * @alias module:model/DependentMetricOrMetricGroupRep
     * @param key {String} A unique key to reference the metric or metric group
     * @param versionId {String} The version ID of the metric or metric group
     * @param name {String} A human-friendly name for the metric or metric group
     * @param kind {module:model/DependentMetricOrMetricGroupRep.KindEnum} If this is a metric, then it represents the kind of event the metric tracks. If this is a metric group, then it represents the group type
     * @param links {Object.<String, module:model/Link>} The location and content type of related resources
     * @param isGroup {Boolean} Whether this is a metric group or a metric
     */
    constructor(key, versionId, name, kind, links, isGroup) { 
        
        DependentMetricOrMetricGroupRep.initialize(this, key, versionId, name, kind, links, isGroup);
    }
     ...
     */
    static initialize(obj, key, versionId, name, kind, links, isGroup) { 
        obj['key'] = key;
    ...
    /**
     * Constructs a <code>DependentMetricOrMetricGroupRep</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DependentMetricOrMetricGroupRep} obj Optional instance to populate.
     * @return {module:model/DependentMetricOrMetricGroupRep} The populated <code>DependentMetricOrMetricGroupRep</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DependentMetricOrMetricGroupRep();
            ...
            if (data.hasOwnProperty('metrics')) {
                obj['metrics'] = ApiClient.convertToType(data['metrics'], [MetricInGroupRep]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DependentMetricOrMetricGroupRep</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DependentMetricOrMetricGroupRep</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DependentMetricOrMetricGroupRep.RequiredProperties) {
        ...
        if (data['metrics']) { // data not null
            ...
            for (const item of data['metrics']) {
                MetricInGroupRep.validateJSON(item);
            };
        }
...
DependentMetricOrMetricGroupRep.RequiredProperties = ["key", "_versionId", "name", "kind", "_links", "isGroup"];

/**
 * A unique key to reference the metric or metric group
 * @member {String} key
 */
DependentMetricOrMetricGroupRep.prototype['key'] = undefined;

/**
 * The version ID of the metric or metric group
 * @member {String} _versionId
 */
DependentMetricOrMetricGroupRep.prototype['_versionId'] = undefined;

/**
 * A human-friendly name for the metric or metric group
 * @member {String} name
 */
DependentMetricOrMetricGroupRep.prototype['name'] = undefined;
 ...
 * @member {module:model/DependentMetricOrMetricGroupRep.KindEnum} kind
 */
DependentMetricOrMetricGroupRep.prototype['kind'] = undefined;
 ...
 */
DependentMetricOrMetricGroupRep.prototype['isNumeric'] = undefined;

/**
 * The event key sent with the metric. Only relevant for custom metrics.
 * @member {String} eventKey
 */
DependentMetricOrMetricGroupRep.prototype['eventKey'] = undefined;

/**
 * The location and content type of related resources
 * @member {Object.<String, module:model/Link>} _links
 */
DependentMetricOrMetricGroupRep.prototype['_links'] = undefined;

/**
 * Whether this is a metric group or a metric
 * @member {Boolean} isGroup
 */
DependentMetricOrMetricGroupRep.prototype['isGroup'] = undefined;

/**
 * An ordered list of the metrics in this metric group
 * @member {Array.<module:model/MetricInGroupRep>} metrics
 */
DependentMetricOrMetricGroupRep.prototype['metrics'] = undefined;
 ...
 * @readonly
 */
DependentMetricOrMetricGroupRep['KindEnum'] = {
...
export default DependentMetricOrMetricGroupRep;
