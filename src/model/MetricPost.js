...
class MetricPost {
    /**
     * Constructs a new <code>MetricPost</code>.
     * @alias module:model/MetricPost
     * @param key {String} A unique key to reference the metric
     * @param kind {module:model/MetricPost.KindEnum} The kind of event your metric will track
     */
    constructor(key, kind) { 
        
        MetricPost.initialize(this, key, kind);
    }
     ...
     */
    static initialize(obj, key, kind) { 
        obj['key'] = key;
        obj['kind'] = kind;
    }

    /**
     * Constructs a <code>MetricPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MetricPost} obj Optional instance to populate.
     * @return {module:model/MetricPost} The populated <code>MetricPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MetricPost();
            ...
            if (data.hasOwnProperty('urls')) {
                obj['urls'] = ApiClient.convertToType(data['urls'], [UrlPost]);
            }
            ...
            if (data.hasOwnProperty('filters')) {
                obj['filters'] = EventFilter.constructFromObject(data['filters']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MetricPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MetricPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MetricPost.RequiredProperties) {
        ...
        if (data['filters']) { // data not null
          EventFilter.validateJSON(data['filters']);
        }
...
MetricPost.RequiredProperties = ["key", "kind"];

/**
 * A unique key to reference the metric
 * @member {String} key
 */
MetricPost.prototype['key'] = undefined;

/**
 * A human-friendly name for the metric
 * @member {String} name
 */
MetricPost.prototype['name'] = undefined;

/**
 * Description of the metric
 * @member {String} description
 */
MetricPost.prototype['description'] = undefined;

/**
 * The kind of event your metric will track
 * @member {module:model/MetricPost.KindEnum} kind
 */
MetricPost.prototype['kind'] = undefined;

/**
 * One or more CSS selectors. Required for click metrics only.
 * @member {String} selector
 */
MetricPost.prototype['selector'] = undefined;

/**
 * One or more target URLs. Required for click and pageview metrics only.
 * @member {Array.<module:model/UrlPost>} urls
 */
MetricPost.prototype['urls'] = undefined;
 ...
 */
MetricPost.prototype['isNumeric'] = undefined;

/**
 * The unit of measure. Applicable for numeric custom metrics only.
 * @member {String} unit
 */
MetricPost.prototype['unit'] = undefined;
 ...
 */
MetricPost.prototype['tags'] = undefined;
 ...
 */
MetricPost.prototype['maintainerId'] = undefined;
 ...
 */
MetricPost.prototype['dataSource'] = undefined;

/**
 * @member {module:model/EventFilter} filters
 */
MetricPost.prototype['filters'] = undefined;
