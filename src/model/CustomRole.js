...
class CustomRole {
     ...
     * @param id {String} The ID of the custom role
     ...
     * @param policy {Array.<module:model/Statement>} An array of the policies that comprise this custom role
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('resourceCategory')) {
                obj['resourceCategory'] = ApiClient.convertToType(data['resourceCategory'], 'String');
            }
            if (data.hasOwnProperty('assignedTo')) {
                obj['assignedTo'] = AssignedToRep.constructFromObject(data['assignedTo']);
            }
            if (data.hasOwnProperty('_presetBundleVersion')) {
                obj['_presetBundleVersion'] = ApiClient.convertToType(data['_presetBundleVersion'], 'Number');
            }
            if (data.hasOwnProperty('_presetStatements')) {
                obj['_presetStatements'] = ApiClient.convertToType(data['_presetStatements'], [Statement]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of CustomRole.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['basePermissions'] && !(typeof data['basePermissions'] === 'string' || data['basePermissions'] instanceof String)) {
            throw new Error("Expected the field `basePermissions` to be a primitive type in the JSON string but got " + data['basePermissions']);
        }
        // ensure the json data is a string
        if (data['resourceCategory'] && !(typeof data['resourceCategory'] === 'string' || data['resourceCategory'] instanceof String)) {
            throw new Error("Expected the field `resourceCategory` to be a primitive type in the JSON string but got " + data['resourceCategory']);
        }
        // validate the optional field `assignedTo`
        if (data['assignedTo']) { // data not null
          AssignedToRep.validateJSON(data['assignedTo']);
        }
        if (data['_presetStatements']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['_presetStatements'])) {
                throw new Error("Expected the field `_presetStatements` to be an array in the JSON data but got " + data['_presetStatements']);
            }
            // validate the optional field `_presetStatements` (array)
            for (const item of data['_presetStatements']) {
                Statement.validateJSON(item);
            };
        }
...
CustomRole.RequiredProperties = ["_id", "_links", "key", "name", "policy"];
...
/**
 * @member {String} resourceCategory
 */
CustomRole.prototype['resourceCategory'] = undefined;

/**
 * @member {module:model/AssignedToRep} assignedTo
 */
CustomRole.prototype['assignedTo'] = undefined;

/**
 * If created from a preset, the preset bundle version
 * @member {Number} _presetBundleVersion
 */
CustomRole.prototype['_presetBundleVersion'] = undefined;

/**
 * If created from a preset, the read-only statements copied from the preset
 * @member {Array.<module:model/Statement>} _presetStatements
 */
CustomRole.prototype['_presetStatements'] = undefined;
