...
class PatchSegmentInstruction {
    /**
     * Constructs a new <code>PatchSegmentInstruction</code>.
     * @alias module:model/PatchSegmentInstruction
     * @param kind {module:model/PatchSegmentInstruction.KindEnum} The type of change to make to the user's removal date from this segment
     * @param userKey {String} A unique key used to represent the user
     * @param targetType {module:model/PatchSegmentInstruction.TargetTypeEnum} The segment's target type
     */
    constructor(kind, userKey, targetType) { 
        
        PatchSegmentInstruction.initialize(this, kind, userKey, targetType);
    }
     ...
     */
    static initialize(obj, kind, userKey, targetType) { 
        obj['kind'] = kind;
        obj['userKey'] = userKey;
    ...
    /**
     * Constructs a <code>PatchSegmentInstruction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PatchSegmentInstruction} obj Optional instance to populate.
     * @return {module:model/PatchSegmentInstruction} The populated <code>PatchSegmentInstruction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatchSegmentInstruction();
    ...
    /**
     * Validates the JSON data with respect to <code>PatchSegmentInstruction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatchSegmentInstruction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PatchSegmentInstruction.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['userKey'] && !(typeof data['userKey'] === 'string' || data['userKey'] instanceof String)) {
            throw new Error("Expected the field `userKey` to be a primitive type in the JSON string but got " + data['userKey']);
        }
        // ensure the json data is a string
...
PatchSegmentInstruction.RequiredProperties = ["kind", "userKey", "targetType"];

/**
 * The type of change to make to the user's removal date from this segment
 * @member {module:model/PatchSegmentInstruction.KindEnum} kind
 */
PatchSegmentInstruction.prototype['kind'] = undefined;

/**
 * A unique key used to represent the user
 * @member {String} userKey
 */
PatchSegmentInstruction.prototype['userKey'] = undefined;

/**
 * The segment's target type
 * @member {module:model/PatchSegmentInstruction.TargetTypeEnum} targetType
 */
PatchSegmentInstruction.prototype['targetType'] = undefined;
 ...
 * @readonly
 */
PatchSegmentInstruction['KindEnum'] = {

    /**
     * value: "addExpireUserTargetDate"
     * @const
     */
    "addExpireUserTargetDate": "addExpireUserTargetDate",

    /**
     * value: "updateExpireUserTargetDate"
     * @const
     */
    "updateExpireUserTargetDate": "updateExpireUserTargetDate",

    /**
     * value: "removeExpireUserTargetDate"
     * @const
     */
 ...
 * @readonly
 */
PatchSegmentInstruction['TargetTypeEnum'] = {
...
export default PatchSegmentInstruction;
