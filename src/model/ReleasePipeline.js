...
class ReleasePipeline {
    /**
     * Constructs a new <code>ReleasePipeline</code>.
     * @alias module:model/ReleasePipeline
     * @param createdAt {Date} Timestamp of when the release pipeline was created
     * @param key {String} The release pipeline key
     * @param name {String} The release pipeline name
     * @param phases {Array.<module:model/Phase>} An ordered list of the release pipeline phases. Each phase is a logical grouping of one or more environments that share attributes for rolling out changes.
     */
    constructor(createdAt, key, name, phases) { 
        
        ReleasePipeline.initialize(this, createdAt, key, name, phases);
    }
     ...
     */
    static initialize(obj, createdAt, key, name, phases) { 
    ...
    /**
     * Constructs a <code>ReleasePipeline</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReleasePipeline} obj Optional instance to populate.
     * @return {module:model/ReleasePipeline} The populated <code>ReleasePipeline</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReleasePipeline();
            ...
            if (data.hasOwnProperty('isProjectDefault')) {
                obj['isProjectDefault'] = ApiClient.convertToType(data['isProjectDefault'], 'Boolean');
            }
            if (data.hasOwnProperty('_isLegacy')) {
                obj['_isLegacy'] = ApiClient.convertToType(data['_isLegacy'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ReleasePipeline</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReleasePipeline</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReleasePipeline.RequiredProperties) {
...
ReleasePipeline.RequiredProperties = ["createdAt", "key", "name", "phases"];

/**
 * Timestamp of when the release pipeline was created
 * @member {Date} createdAt
 */
ReleasePipeline.prototype['createdAt'] = undefined;

/**
 * The release pipeline description
 * @member {String} description
 */
ReleasePipeline.prototype['description'] = undefined;

/**
 * The release pipeline key
 * @member {String} key
 */
ReleasePipeline.prototype['key'] = undefined;

/**
 * The release pipeline name
 * @member {String} name
 */
ReleasePipeline.prototype['name'] = undefined;
 ...
 */
ReleasePipeline.prototype['phases'] = undefined;

/**
 * A list of the release pipeline's tags
 * @member {Array.<String>} tags
 */
ReleasePipeline.prototype['tags'] = undefined;

/**
 * The release pipeline version
 * @member {Number} _version
 */
ReleasePipeline.prototype['_version'] = undefined;

/**
 * @member {module:model/Access} _access
 */
ReleasePipeline.prototype['_access'] = undefined;

/**
 * Whether this release pipeline is the default pipeline for the project
 * @member {Boolean} isProjectDefault
 */
ReleasePipeline.prototype['isProjectDefault'] = undefined;

/**
 * Whether this release pipeline is a legacy pipeline
 * @member {Boolean} _isLegacy
 */
ReleasePipeline.prototype['_isLegacy'] = undefined;
