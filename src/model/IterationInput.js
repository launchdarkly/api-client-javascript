...
class IterationInput {
    /**
     * Constructs a new <code>IterationInput</code>.
     * @alias module:model/IterationInput
     * @param hypothesis {String} The expected outcome of this experiment
     * @param metrics {Array.<module:model/MetricInput>} 
     * @param treatments {Array.<module:model/TreatmentInput>} 
     * @param flags {Object.<String, module:model/FlagInput>} 
     */
    constructor(hypothesis, metrics, treatments, flags) { 
        
        IterationInput.initialize(this, hypothesis, metrics, treatments, flags);
    }
     ...
     */
    static initialize(obj, hypothesis, metrics, treatments, flags) { 
    ...
    /**
     * Constructs a <code>IterationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IterationInput} obj Optional instance to populate.
     * @return {module:model/IterationInput} The populated <code>IterationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IterationInput();
            ...
            if (data.hasOwnProperty('metrics')) {
                obj['metrics'] = ApiClient.convertToType(data['metrics'], [MetricInput]);
            }
            if (data.hasOwnProperty('primarySingleMetricKey')) {
                obj['primarySingleMetricKey'] = ApiClient.convertToType(data['primarySingleMetricKey'], 'String');
            }
            if (data.hasOwnProperty('primaryFunnelKey')) {
                obj['primaryFunnelKey'] = ApiClient.convertToType(data['primaryFunnelKey'], 'String');
            }
            if (data.hasOwnProperty('treatments')) {
                obj['treatments'] = ApiClient.convertToType(data['treatments'], [TreatmentInput]);
            }
            if (data.hasOwnProperty('flags')) {
                obj['flags'] = ApiClient.convertToType(data['flags'], {'String': FlagInput});
            }
    ...
    /**
     * Validates the JSON data with respect to <code>IterationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IterationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IterationInput.RequiredProperties) {
        ...
        if (data['metrics']) { // data not null
            ...
            for (const item of data['metrics']) {
                MetricInput.validateJSON(item);
            };
        }
        // ensure the json data is a string
        if (data['primarySingleMetricKey'] && !(typeof data['primarySingleMetricKey'] === 'string' || data['primarySingleMetricKey'] instanceof String)) {
            throw new Error("Expected the field `primarySingleMetricKey` to be a primitive type in the JSON string but got " + data['primarySingleMetricKey']);
        }
        // ensure the json data is a string
        if (data['primaryFunnelKey'] && !(typeof data['primaryFunnelKey'] === 'string' || data['primaryFunnelKey'] instanceof String)) {
            throw new Error("Expected the field `primaryFunnelKey` to be a primitive type in the JSON string but got " + data['primaryFunnelKey']);
        }
        if (data['treatments']) { // data not null
            ...
            for (const item of data['treatments']) {
                TreatmentInput.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
IterationInput.RequiredProperties = ["hypothesis", "metrics", "treatments", "flags"];

/**
 * The expected outcome of this experiment
 * @member {String} hypothesis
 */
IterationInput.prototype['hypothesis'] = undefined;
 ...
 */
IterationInput.prototype['canReshuffleTraffic'] = undefined;

/**
 * @member {Array.<module:model/MetricInput>} metrics
 */
IterationInput.prototype['metrics'] = undefined;
 ...
 * @member {String} primarySingleMetricKey
 */
IterationInput.prototype['primarySingleMetricKey'] = undefined;
 ...
 * @member {String} primaryFunnelKey
 */
IterationInput.prototype['primaryFunnelKey'] = undefined;

/**
 * @member {Array.<module:model/TreatmentInput>} treatments
 */
IterationInput.prototype['treatments'] = undefined;

/**
 * @member {Object.<String, module:model/FlagInput>} flags
 */
IterationInput.prototype['flags'] = undefined;
 ...
 */
IterationInput.prototype['attributes'] = undefined;
