    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('derived')) {
                obj['derived'] = ApiClient.convertToType(data['derived'], {'String': DerivedAttribute});
            }
            if (data.hasOwnProperty('privateAttrs')) {
                obj['privateAttrs'] = ApiClient.convertToType(data['privateAttrs'], ['String']);
            }
        }
        return obj;
    }
 ...
 */
User.prototype['secondary'] = undefined;

/**
 * @member {String} ip
 */
User.prototype['ip'] = undefined;
 ...
 */
User.prototype['anonymous'] = undefined;

/**
 * @member {Object.<String, Object>} custom
 */
User.prototype['custom'] = undefined;

/**
 * @member {Object.<String, module:model/DerivedAttribute>} derived
 */
User.prototype['derived'] = undefined;

/**
 * @member {Array.<String>} privateAttrs
 */
User.prototype['privateAttrs'] = undefined;
