...
class MetricGroupRep {
    /**
     * Constructs a new <code>MetricGroupRep</code>.
     * @alias module:model/MetricGroupRep
     * @param id {String} The ID of this metric group
     * @param key {String} A unique key to reference the metric group
     * @param name {String} A human-friendly name for the metric group
     * @param kind {module:model/MetricGroupRep.KindEnum} The type of the metric group
     * @param links {Object.<String, module:model/Link>} The location and content type of related resources
     * @param tags {Array.<String>} Tags for the metric group
     * @param creationDate {Number} 
     * @param lastModified {Number} 
     * @param maintainer {module:model/MaintainerRep} 
     * @param metrics {Array.<module:model/MetricInGroupRep>} An ordered list of the metrics in this metric group
     * @param version {Number} The version of this metric group
     */
    constructor(id, key, name, kind, links, tags, creationDate, lastModified, maintainer, metrics, version) { 
        
        MetricGroupRep.initialize(this, id, key, name, kind, links, tags, creationDate, lastModified, maintainer, metrics, version);
    }
     ...
     */
    static initialize(obj, id, key, name, kind, links, tags, creationDate, lastModified, maintainer, metrics, version) { 
        obj['_id'] = id;
        obj['key'] = key;
        obj['name'] = name;
        obj['kind'] = kind;
    ...
    /**
     * Constructs a <code>MetricGroupRep</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MetricGroupRep} obj Optional instance to populate.
     * @return {module:model/MetricGroupRep} The populated <code>MetricGroupRep</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MetricGroupRep();
            ...
            if (data.hasOwnProperty('_lastModified')) {
                obj['_lastModified'] = ApiClient.convertToType(data['_lastModified'], 'Number');
            }
            if (data.hasOwnProperty('maintainer')) {
                obj['maintainer'] = MaintainerRep.constructFromObject(data['maintainer']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MetricGroupRep</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MetricGroupRep</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MetricGroupRep.RequiredProperties) {
        ...
        if (data['maintainer']) { // data not null
          MaintainerRep.validateJSON(data['maintainer']);
        }
...
MetricGroupRep.RequiredProperties = ["_id", "key", "name", "kind", "_links", "tags", "_creationDate", "_lastModified", "maintainer", "metrics", "_version"];

/**
 * The ID of this metric group
 * @member {String} _id
 */
MetricGroupRep.prototype['_id'] = undefined;

/**
 * A unique key to reference the metric group
 * @member {String} key
 */
MetricGroupRep.prototype['key'] = undefined;

/**
 * A human-friendly name for the metric group
 * @member {String} name
 */
MetricGroupRep.prototype['name'] = undefined;

/**
 * The type of the metric group
 * @member {module:model/MetricGroupRep.KindEnum} kind
 */
MetricGroupRep.prototype['kind'] = undefined;

/**
 * Description of the metric group
 * @member {String} description
 */
MetricGroupRep.prototype['description'] = undefined;

/**
 * The location and content type of related resources
 * @member {Object.<String, module:model/Link>} _links
 */
MetricGroupRep.prototype['_links'] = undefined;

/**
 * @member {module:model/Access} _access
 */
MetricGroupRep.prototype['_access'] = undefined;

/**
 * Tags for the metric group
 * @member {Array.<String>} tags
 */
MetricGroupRep.prototype['tags'] = undefined;

/**
 * @member {Number} _creationDate
 */
MetricGroupRep.prototype['_creationDate'] = undefined;

/**
 * @member {Number} _lastModified
 */
MetricGroupRep.prototype['_lastModified'] = undefined;

/**
 * @member {module:model/MaintainerRep} maintainer
 */
MetricGroupRep.prototype['maintainer'] = undefined;

/**
 * An ordered list of the metrics in this metric group
 * @member {Array.<module:model/MetricInGroupRep>} metrics
 */
MetricGroupRep.prototype['metrics'] = undefined;

/**
 * The version of this metric group
 * @member {Number} _version
 */
MetricGroupRep.prototype['_version'] = undefined;

/**
 * @member {Array.<module:model/DependentExperimentRep>} experiments
 */
MetricGroupRep.prototype['experiments'] = undefined;
