...
import DependentMeasuredRolloutRep from './DependentMeasuredRolloutRep';
import DependentMetricGroupRep from './DependentMetricGroupRep';
import Filter from './Filter';
import FlagListingRep from './FlagListingRep';
import Link from './Link';
import MemberSummary from './MemberSummary';
import MetricDataSourceRefRep from './MetricDataSourceRefRep';
...
class MetricRep {
     ...
     * @param kind {module:model/MetricRep.KindEnum} The kind of event the metric tracks
    ...
    constructor(id, versionId, key, name, kind, links, tags, creationDate, dataSource) { 
        ...
        MetricRep.initialize(this, id, versionId, key, name, kind, links, tags, creationDate, dataSource);
    }
    ...
    /**
     * Constructs a <code>MetricRep</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MetricRep} obj Optional instance to populate.
     * @return {module:model/MetricRep} The populated <code>MetricRep</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('filters')) {
                obj['filters'] = Filter.constructFromObject(data['filters']);
            }
            ...
            if (data.hasOwnProperty('dataSource')) {
                obj['dataSource'] = MetricDataSourceRefRep.constructFromObject(data['dataSource']);
            }
            ...
            if (data.hasOwnProperty('experiments')) {
                obj['experiments'] = ApiClient.convertToType(data['experiments'], [DependentExperimentRep]);
            }
            if (data.hasOwnProperty('metricGroups')) {
                obj['metricGroups'] = ApiClient.convertToType(data['metricGroups'], [DependentMetricGroupRep]);
            }
            if (data.hasOwnProperty('lastUsedInExperiment')) {
                obj['lastUsedInExperiment'] = DependentExperimentRep.constructFromObject(data['lastUsedInExperiment']);
            }
            if (data.hasOwnProperty('lastUsedInGuardedRollout')) {
                obj['lastUsedInGuardedRollout'] = DependentMeasuredRolloutRep.constructFromObject(data['lastUsedInGuardedRollout']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MetricRep</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MetricRep</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MetricRep.RequiredProperties) {
        ...
        if (data['lastModified']) { // data not null
          Modification.validateJSON(data['lastModified']);
        }
        // ensure the json data is a string
        ...
        if (data['_maintainer']) { // data not null
          MemberSummary.validateJSON(data['_maintainer']);
        }
        // ensure the json data is a string
        ...
        if (data['filters']) { // data not null
          Filter.validateJSON(data['filters']);
        }
        // ensure the json data is a string
        ...
        if (data['eventDefault']) { // data not null
          MetricEventDefaultRep.validateJSON(data['eventDefault']);
        }
        // validate the optional field `dataSource`
        if (data['dataSource']) { // data not null
          MetricDataSourceRefRep.validateJSON(data['dataSource']);
        }
        // ensure the json data is a string
        ...
        if (data['experiments']) { // data not null
            ...
            for (const item of data['experiments']) {
                DependentExperimentRep.validateJSON(item);
            };
        }
        if (data['metricGroups']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['metricGroups'])) {
                throw new Error("Expected the field `metricGroups` to be an array in the JSON data but got " + data['metricGroups']);
            }
            // validate the optional field `metricGroups` (array)
            for (const item of data['metricGroups']) {
                DependentMetricGroupRep.validateJSON(item);
            };
        }
        // validate the optional field `lastUsedInExperiment`
        if (data['lastUsedInExperiment']) { // data not null
          DependentExperimentRep.validateJSON(data['lastUsedInExperiment']);
        }
        // validate the optional field `lastUsedInGuardedRollout`
        if (data['lastUsedInGuardedRollout']) { // data not null
          DependentMeasuredRolloutRep.validateJSON(data['lastUsedInGuardedRollout']);
        }
        if (data['_attachedFeatures']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['_attachedFeatures'])) {
                throw new Error("Expected the field `_attachedFeatures` to be an array in the JSON data but got " + data['_attachedFeatures']);
            }
            // validate the optional field `_attachedFeatures` (array)
            for (const item of data['_attachedFeatures']) {
                FlagListingRep.validateJSON(item);
            };
        }
 ...
 */
MetricRep.prototype['_versionId'] = undefined;
 ...
 * @member {String} key
 */
MetricRep.prototype['key'] = undefined;
 ...
 */
MetricRep.prototype['category'] = undefined;
...
/**
 * @member {module:model/Filter} filters
 */
MetricRep.prototype['filters'] = undefined;
 ...
 */
MetricRep.prototype['eventDefault'] = undefined;

/**
 * @member {module:model/MetricDataSourceRefRep} dataSource
 */
MetricRep.prototype['dataSource'] = undefined;

/**
 * Whether the metric version is archived
 * @member {Boolean} archived
 */
MetricRep.prototype['archived'] = undefined;

/**
 * @member {Number} archivedAt
 */
MetricRep.prototype['archivedAt'] = undefined;
...
/**
 * @member {Array.<module:model/DependentExperimentRep>} experiments
 */
MetricRep.prototype['experiments'] = undefined;

/**
 * Metric groups that use this metric
 * @member {Array.<module:model/DependentMetricGroupRep>} metricGroups
 */
MetricRep.prototype['metricGroups'] = undefined;

/**
 * @member {module:model/DependentExperimentRep} lastUsedInExperiment
 */
MetricRep.prototype['lastUsedInExperiment'] = undefined;

/**
 * @member {module:model/DependentMeasuredRolloutRep} lastUsedInGuardedRollout
 */
MetricRep.prototype['lastUsedInGuardedRollout'] = undefined;
 ...
 * @readonly
 */
MetricRep['UnitAggregationTypeEnum'] = {
