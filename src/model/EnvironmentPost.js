...
class EnvironmentPost {
     ...
     * @param color {String} A color to indicate this environment in the UI
     */
    constructor(name, key, color) { 
        
        EnvironmentPost.initialize(this, name, key, color);
    }
     ...
     */
    static initialize(obj, name, key, color) { 
        obj['name'] = name;
        obj['key'] = key;
        obj['color'] = color;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('source')) {
                obj['source'] = SourceEnv.constructFromObject(data['source']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EnvironmentPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnvironmentPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EnvironmentPost.RequiredProperties) {
        ...
        if (data['source']) { // data not null
          SourceEnv.validateJSON(data['source']);
        }
...
EnvironmentPost.RequiredProperties = ["name", "key", "color"];

/**
 * A human-friendly name for the new environment
 * @member {String} name
 */
EnvironmentPost.prototype['name'] = undefined;

/**
 * A project-unique key for the new environment
 * @member {String} key
 */
EnvironmentPost.prototype['key'] = undefined;

/**
 * A color to indicate this environment in the UI
 * @member {String} color
 */
EnvironmentPost.prototype['color'] = undefined;

/**
 * The default time (in minutes) that the PHP SDK can cache feature flag rules locally
 * @member {Number} defaultTtl
 */
EnvironmentPost.prototype['defaultTtl'] = undefined;
