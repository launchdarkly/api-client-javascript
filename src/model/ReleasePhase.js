...
class ReleasePhase {
    /**
     * Constructs a new <code>ReleasePhase</code>.
     * @alias module:model/ReleasePhase
     * @param id {String} The phase ID
    ...
    constructor(id, name, complete, creationDate, audiences) { 
        ...
        ReleasePhase.initialize(this, id, name, complete, creationDate, audiences);
    }
     ...
     */
    static initialize(obj, id, name, complete, creationDate, audiences) { 
        obj['_id'] = id;
        obj['_name'] = name;
        obj['complete'] = complete;
        obj['_creationDate'] = creationDate;
        obj['_audiences'] = audiences;
    }

    /**
     * Constructs a <code>ReleasePhase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReleasePhase} obj Optional instance to populate.
     * @return {module:model/ReleasePhase} The populated <code>ReleasePhase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReleasePhase();
            ...
            if (data.hasOwnProperty('_completionDate')) {
                obj['_completionDate'] = ApiClient.convertToType(data['_completionDate'], 'Number');
            }
            if (data.hasOwnProperty('_completedBy')) {
            ...
            if (data.hasOwnProperty('_startedDate')) {
                obj['_startedDate'] = ApiClient.convertToType(data['_startedDate'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ReleasePhase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReleasePhase</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReleasePhase.RequiredProperties) {
        ...
        if (data['_completedBy']) { // data not null
          CompletedBy.validateJSON(data['_completedBy']);
        }
        if (data['_audiences']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['_audiences'])) {
                throw new Error("Expected the field `_audiences` to be an array in the JSON data but got " + data['_audiences']);
            }
            // validate the optional field `_audiences` (array)
            for (const item of data['_audiences']) {
                ReleaseAudience.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
ReleasePhase.RequiredProperties = ["_id", "_name", "complete", "_creationDate", "_audiences"];

/**
 * The phase ID
 * @member {String} _id
 */
ReleasePhase.prototype['_id'] = undefined;

/**
 * The release phase name
 * @member {String} _name
 */
ReleasePhase.prototype['_name'] = undefined;

/**
 * Whether this phase is complete
 * @member {Boolean} complete
 */
ReleasePhase.prototype['complete'] = undefined;

/**
 * @member {Number} _creationDate
 */
ReleasePhase.prototype['_creationDate'] = undefined;

/**
 * @member {Number} _completionDate
 */
ReleasePhase.prototype['_completionDate'] = undefined;

/**
 * @member {module:model/CompletedBy} _completedBy
 */
ReleasePhase.prototype['_completedBy'] = undefined;
 ...
 */
ReleasePhase.prototype['status'] = undefined;

/**
 * Whether or not this phase has started
 * @member {Boolean} started
 */
ReleasePhase.prototype['started'] = undefined;

/**
 * @member {Number} _startedDate
 */
ReleasePhase.prototype['_startedDate'] = undefined;

/**
 * @member {Object} configuration
 */
ReleasePhase.prototype['configuration'] = undefined;
