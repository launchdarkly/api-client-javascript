...
class PatchSegmentExpiringTargetInstruction {
    /**
     * Constructs a new <code>PatchSegmentExpiringTargetInstruction</code>.
     * @alias module:model/PatchSegmentExpiringTargetInstruction
     * @param kind {module:model/PatchSegmentExpiringTargetInstruction.KindEnum} The type of change to make to the context's removal date from this segment
     * @param contextKey {String} A unique key used to represent the context
     * @param contextKind {String} The kind of context
     * @param targetType {module:model/PatchSegmentExpiringTargetInstruction.TargetTypeEnum} The segment's target type
     */
    constructor(kind, contextKey, contextKind, targetType) { 
        
        PatchSegmentExpiringTargetInstruction.initialize(this, kind, contextKey, contextKind, targetType);
    }
     ...
     */
    static initialize(obj, kind, contextKey, contextKind, targetType) { 
        obj['kind'] = kind;
        obj['contextKey'] = contextKey;
        obj['contextKind'] = contextKind;
        obj['targetType'] = targetType;
    }

    /**
     * Constructs a <code>PatchSegmentExpiringTargetInstruction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PatchSegmentExpiringTargetInstruction} obj Optional instance to populate.
     * @return {module:model/PatchSegmentExpiringTargetInstruction} The populated <code>PatchSegmentExpiringTargetInstruction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatchSegmentExpiringTargetInstruction();
            ...
            if (data.hasOwnProperty('contextKind')) {
                obj['contextKind'] = ApiClient.convertToType(data['contextKind'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PatchSegmentExpiringTargetInstruction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatchSegmentExpiringTargetInstruction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PatchSegmentExpiringTargetInstruction.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['contextKey'] && !(typeof data['contextKey'] === 'string' || data['contextKey'] instanceof String)) {
            throw new Error("Expected the field `contextKey` to be a primitive type in the JSON string but got " + data['contextKey']);
        }
        // ensure the json data is a string
        if (data['contextKind'] && !(typeof data['contextKind'] === 'string' || data['contextKind'] instanceof String)) {
            throw new Error("Expected the field `contextKind` to be a primitive type in the JSON string but got " + data['contextKind']);
        }
        // ensure the json data is a string
...
PatchSegmentExpiringTargetInstruction.RequiredProperties = ["kind", "contextKey", "contextKind", "targetType"];

/**
 * The type of change to make to the context's removal date from this segment
 * @member {module:model/PatchSegmentExpiringTargetInstruction.KindEnum} kind
 */
PatchSegmentExpiringTargetInstruction.prototype['kind'] = undefined;

/**
 * A unique key used to represent the context
 * @member {String} contextKey
 */
PatchSegmentExpiringTargetInstruction.prototype['contextKey'] = undefined;

/**
 * The kind of context
 * @member {String} contextKind
 */
PatchSegmentExpiringTargetInstruction.prototype['contextKind'] = undefined;

/**
 * The segment's target type
 * @member {module:model/PatchSegmentExpiringTargetInstruction.TargetTypeEnum} targetType
 */
PatchSegmentExpiringTargetInstruction.prototype['targetType'] = undefined;
 ...
 * @member {Number} value
 */
PatchSegmentExpiringTargetInstruction.prototype['value'] = undefined;
 ...
 */
PatchSegmentExpiringTargetInstruction.prototype['version'] = undefined;
 ...
 * @readonly
 */
PatchSegmentExpiringTargetInstruction['KindEnum'] = {

    /**
     * value: "addExpiringTarget"
     * @const
     */
    "addExpiringTarget": "addExpiringTarget",

    /**
     * value: "updateExpiringTarget"
     * @const
     */
    "updateExpiringTarget": "updateExpiringTarget",

    /**
     * value: "removeExpiringTarget"
     * @const
     */
 ...
 * @readonly
 */
PatchSegmentExpiringTargetInstruction['TargetTypeEnum'] = {
...
export default PatchSegmentExpiringTargetInstruction;
