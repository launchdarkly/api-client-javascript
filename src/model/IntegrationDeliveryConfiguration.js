...
class IntegrationDeliveryConfiguration {
    /**
     * Constructs a new <code>IntegrationDeliveryConfiguration</code>.
     * @alias module:model/IntegrationDeliveryConfiguration
     * @param links {module:model/IntegrationDeliveryConfigurationLinks} 
     ...
     */
    constructor(links, id, integrationKey, projectKey, environmentKey, config, on, tags, name, version) { 
        
        IntegrationDeliveryConfiguration.initialize(this, links, id, integrationKey, projectKey, environmentKey, config, on, tags, name, version);
    }
     ...
     */
    static initialize(obj, links, id, integrationKey, projectKey, environmentKey, config, on, tags, name, version) { 
        obj['_links'] = links;
        obj['_id'] = id;
    ...
    /**
     * Constructs a <code>IntegrationDeliveryConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IntegrationDeliveryConfiguration} obj Optional instance to populate.
     * @return {module:model/IntegrationDeliveryConfiguration} The populated <code>IntegrationDeliveryConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IntegrationDeliveryConfiguration();

            if (data.hasOwnProperty('_links')) {
                obj['_links'] = IntegrationDeliveryConfigurationLinks.constructFromObject(data['_links']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>IntegrationDeliveryConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IntegrationDeliveryConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IntegrationDeliveryConfiguration.RequiredProperties) {
        ...
        if (data['_links']) { // data not null
          IntegrationDeliveryConfigurationLinks.validateJSON(data['_links']);
        }
...
IntegrationDeliveryConfiguration.RequiredProperties = ["_links", "_id", "integrationKey", "projectKey", "environmentKey", "config", "on", "tags", "name", "version"];

/**
 * @member {module:model/IntegrationDeliveryConfigurationLinks} _links
 */
IntegrationDeliveryConfiguration.prototype['_links'] = undefined;

/**
 * The integration ID
 * @member {String} _id
 */
IntegrationDeliveryConfiguration.prototype['_id'] = undefined;

/**
 * The integration key
 * @member {String} integrationKey
 */
IntegrationDeliveryConfiguration.prototype['integrationKey'] = undefined;

/**
 * The project key
 * @member {String} projectKey
 */
IntegrationDeliveryConfiguration.prototype['projectKey'] = undefined;

/**
 * The environment key
 * @member {String} environmentKey
 */
IntegrationDeliveryConfiguration.prototype['environmentKey'] = undefined;

/**
 * @member {Object.<String, Object>} config
 */
IntegrationDeliveryConfiguration.prototype['config'] = undefined;

/**
 * Whether the configuration is turned on
 * @member {Boolean} on
 */
IntegrationDeliveryConfiguration.prototype['on'] = undefined;

/**
 * List of tags for this configuration
 * @member {Array.<String>} tags
 */
IntegrationDeliveryConfiguration.prototype['tags'] = undefined;

/**
 * Name of the configuration
 * @member {String} name
 */
IntegrationDeliveryConfiguration.prototype['name'] = undefined;

/**
 * Version of the current configuration
 * @member {Number} version
 */
IntegrationDeliveryConfiguration.prototype['version'] = undefined;

/**
 * @member {module:model/Access} _access
 */
IntegrationDeliveryConfiguration.prototype['_access'] = undefined;
...
export default IntegrationDeliveryConfiguration;
