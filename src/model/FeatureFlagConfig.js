...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Fallthrough', 'model/Prerequisite', 'model/Rule', 'model/Site', 'model/Target'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Fallthrough'), require('./Prerequisite'), require('./Rule'), require('./Site'), require('./Target'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyApi) {
      root.LaunchDarklyApi = {};
    }
    root.LaunchDarklyApi.FeatureFlagConfig = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.Fallthrough, root.LaunchDarklyApi.Prerequisite, root.LaunchDarklyApi.Rule, root.LaunchDarklyApi.Site, root.LaunchDarklyApi.Target);
  }
}(this, function(ApiClient, Fallthrough, Prerequisite, Rule, Site, Target) {
  'use strict';
   ...
   */
  exports.prototype['_environmentName'] = undefined;
