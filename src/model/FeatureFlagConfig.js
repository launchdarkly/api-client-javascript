...
class FeatureFlagConfig {
     ...
     * @param on {Boolean} Whether the flag is on
     * @param archived {Boolean} Boolean indicating if the feature flag is archived
     * @param salt {String} 
     * @param sel {String} 
     * @param lastModified {Number} 
     * @param version {Number} Version of the feature flag
     * @param site {module:model/Link} 
     * @param environmentName {String} The environment name
     * @param trackEvents {Boolean} Whether LaunchDarkly tracks events for the feature flag, for all rules
     * @param trackEventsFallthrough {Boolean} Whether LaunchDarkly tracks events for the feature flag, for the default rule
     */
    constructor(on, archived, salt, sel, lastModified, version, site, environmentName, trackEvents, trackEventsFallthrough) { 
        
        FeatureFlagConfig.initialize(this, on, archived, salt, sel, lastModified, version, site, environmentName, trackEvents, trackEventsFallthrough);
    }
     ...
     */
    static initialize(obj, on, archived, salt, sel, lastModified, version, site, environmentName, trackEvents, trackEventsFallthrough) { 
        obj['on'] = on;
        ...
        obj['version'] = version;
        obj['_site'] = site;
        obj['_environmentName'] = environmentName;
        obj['trackEvents'] = trackEvents;
        obj['trackEventsFallthrough'] = trackEventsFallthrough;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('contextTargets')) {
                obj['contextTargets'] = ApiClient.convertToType(data['contextTargets'], [Target]);
            }
            if (data.hasOwnProperty('rules')) {
                obj['rules'] = ApiClient.convertToType(data['rules'], [Rule]);
            }
            if (data.hasOwnProperty('fallthrough')) {
                obj['fallthrough'] = VariationOrRolloutRep.constructFromObject(data['fallthrough']);
            }
            ...
            if (data.hasOwnProperty('_environmentName')) {
                obj['_environmentName'] = ApiClient.convertToType(data['_environmentName'], 'String');
            }
            ...
            if (data.hasOwnProperty('_debugEventsUntilDate')) {
                obj['_debugEventsUntilDate'] = ApiClient.convertToType(data['_debugEventsUntilDate'], 'Number');
            }
            if (data.hasOwnProperty('_summary')) {
                obj['_summary'] = FlagSummary.constructFromObject(data['_summary']);
            }
            if (data.hasOwnProperty('evaluation')) {
                obj['evaluation'] = FlagConfigEvaluation.constructFromObject(data['evaluation']);
            }
            if (data.hasOwnProperty('migrationSettings')) {
                obj['migrationSettings'] = FlagConfigMigrationSettingsRep.constructFromObject(data['migrationSettings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FeatureFlagConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FeatureFlagConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FeatureFlagConfig.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['sel'] && !(typeof data['sel'] === 'string' || data['sel'] instanceof String)) {
            throw new Error("Expected the field `sel` to be a primitive type in the JSON string but got " + data['sel']);
        }
        ...
        if (data['contextTargets']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['contextTargets'])) {
                throw new Error("Expected the field `contextTargets` to be an array in the JSON data but got " + data['contextTargets']);
            }
            // validate the optional field `contextTargets` (array)
            for (const item of data['contextTargets']) {
                Target.validateJSON(item);
            };
        }
        ...
        if (data['fallthrough']) { // data not null
          VariationOrRolloutRep.validateJSON(data['fallthrough']);
        }
        if (data['prerequisites']) { // data not null
            // ensure the json data is an array
            ...
            for (const item of data['prerequisites']) {
                Prerequisite.validateJSON(item);
            };
        }
        ...
        // ensure the json data is a string
        if (data['_environmentName'] && !(typeof data['_environmentName'] === 'string' || data['_environmentName'] instanceof String)) {
            throw new Error("Expected the field `_environmentName` to be a primitive type in the JSON string but got " + data['_environmentName']);
        }
        // validate the optional field `_summary`
        if (data['_summary']) { // data not null
          FlagSummary.validateJSON(data['_summary']);
        }
        // validate the optional field `evaluation`
        if (data['evaluation']) { // data not null
          FlagConfigEvaluation.validateJSON(data['evaluation']);
        }
        // validate the optional field `migrationSettings`
        if (data['migrationSettings']) { // data not null
          FlagConfigMigrationSettingsRep.validateJSON(data['migrationSettings']);
        }
...
FeatureFlagConfig.RequiredProperties = ["on", "archived", "salt", "sel", "lastModified", "version", "_site", "_environmentName", "trackEvents", "trackEventsFallthrough"];

/**
 * Whether the flag is on
 * @member {Boolean} on
 */
FeatureFlagConfig.prototype['on'] = undefined;

/**
 * Boolean indicating if the feature flag is archived
 * @member {Boolean} archived
 */
FeatureFlagConfig.prototype['archived'] = undefined;

/**
 * @member {String} salt
 */
FeatureFlagConfig.prototype['salt'] = undefined;

/**
 * @member {String} sel
 */
FeatureFlagConfig.prototype['sel'] = undefined;

/**
 * @member {Number} lastModified
 */
FeatureFlagConfig.prototype['lastModified'] = undefined;

/**
 * Version of the feature flag
 * @member {Number} version
 */
FeatureFlagConfig.prototype['version'] = undefined;
 ...
 */
FeatureFlagConfig.prototype['targets'] = undefined;
 ...
 * @member {Array.<module:model/Target>} contextTargets
 */
FeatureFlagConfig.prototype['contextTargets'] = undefined;
 ...
 */
FeatureFlagConfig.prototype['rules'] = undefined;

/**
 * @member {module:model/VariationOrRolloutRep} fallthrough
 */
FeatureFlagConfig.prototype['fallthrough'] = undefined;

/**
 * The ID of the variation to serve when the flag is off
 * @member {Number} offVariation
 */
FeatureFlagConfig.prototype['offVariation'] = undefined;
 ...
 */
FeatureFlagConfig.prototype['prerequisites'] = undefined;

/**
 * @member {module:model/Link} _site
 */
FeatureFlagConfig.prototype['_site'] = undefined;

/**
 * @member {module:model/Access} _access
 */
FeatureFlagConfig.prototype['_access'] = undefined;

/**
 * The environment name
 * @member {String} _environmentName
 */
FeatureFlagConfig.prototype['_environmentName'] = undefined;

/**
 * Whether LaunchDarkly tracks events for the feature flag, for all rules
 * @member {Boolean} trackEvents
 */
FeatureFlagConfig.prototype['trackEvents'] = undefined;

/**
 * Whether LaunchDarkly tracks events for the feature flag, for the default rule
 * @member {Boolean} trackEventsFallthrough
 */
FeatureFlagConfig.prototype['trackEventsFallthrough'] = undefined;

/**
 * @member {Number} _debugEventsUntilDate
 */
FeatureFlagConfig.prototype['_debugEventsUntilDate'] = undefined;

/**
 * @member {module:model/FlagSummary} _summary
 */
FeatureFlagConfig.prototype['_summary'] = undefined;

/**
 * @member {module:model/FlagConfigEvaluation} evaluation
 */
FeatureFlagConfig.prototype['evaluation'] = undefined;

/**
 * @member {module:model/FlagConfigMigrationSettingsRep} migrationSettings
 */
FeatureFlagConfig.prototype['migrationSettings'] = undefined;
