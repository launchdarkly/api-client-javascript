...
import AccessRep from './AccessRep';
...
class FeatureFlagConfig {
     ...
     * @param targets {Array.<module:model/Target>} 
     * @param rules {Array.<module:model/Rule>} 
     * @param fallthrough {module:model/VariationOrRolloutRep} 
     * @param prerequisites {Array.<module:model/Prerequisite>} 
     * @param site {module:model/Link} 
     * @param environmentName {String} 
     * @param trackEvents {Boolean} 
     * @param trackEventsFallthrough {Boolean} 
     */
    constructor(on, archived, salt, sel, lastModified, version, targets, rules, fallthrough, prerequisites, site, environmentName, trackEvents, trackEventsFallthrough) { 
        
        FeatureFlagConfig.initialize(this, on, archived, salt, sel, lastModified, version, targets, rules, fallthrough, prerequisites, site, environmentName, trackEvents, trackEventsFallthrough);
    }
     ...
     */
    static initialize(obj, on, archived, salt, sel, lastModified, version, targets, rules, fallthrough, prerequisites, site, environmentName, trackEvents, trackEventsFallthrough) { 
        obj['on'] = on;
