...
class InsightGroup {
    /**
     * Constructs a new <code>InsightGroup</code>.
     * @alias module:model/InsightGroup
     * @param key {String} The insight group key
     * @param name {String} The insight group name
     * @param projectKey {String} The project key
     * @param environmentKey {String} The environment key
     * @param createdAt {Number} 
     */
    constructor(key, name, projectKey, environmentKey, createdAt) { 
        
        InsightGroup.initialize(this, key, name, projectKey, environmentKey, createdAt);
    }
     ...
     */
    static initialize(obj, key, name, projectKey, environmentKey, createdAt) { 
        obj['key'] = key;
        obj['name'] = name;
    ...
    /**
     * Constructs a <code>InsightGroup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InsightGroup} obj Optional instance to populate.
     * @return {module:model/InsightGroup} The populated <code>InsightGroup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InsightGroup();

            if (data.hasOwnProperty('environment')) {
                obj['environment'] = Environment.constructFromObject(data['environment']);
            }
            if (data.hasOwnProperty('scores')) {
                obj['scores'] = InsightGroupScores.constructFromObject(data['scores']);
            }
            if (data.hasOwnProperty('scoreMetadata')) {
                obj['scoreMetadata'] = InsightGroupCollectionScoreMetadata.constructFromObject(data['scoreMetadata']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>InsightGroup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InsightGroup</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InsightGroup.RequiredProperties) {
        ...
        if (data['scores']) { // data not null
          InsightGroupScores.validateJSON(data['scores']);
        }
        // validate the optional field `scoreMetadata`
        if (data['scoreMetadata']) { // data not null
          InsightGroupCollectionScoreMetadata.validateJSON(data['scoreMetadata']);
        }
...
InsightGroup.RequiredProperties = ["key", "name", "projectKey", "environmentKey", "createdAt"];

/**
 * @member {module:model/Environment} environment
 */
InsightGroup.prototype['environment'] = undefined;

/**
 * @member {module:model/InsightGroupScores} scores
 */
InsightGroup.prototype['scores'] = undefined;

/**
 * @member {module:model/InsightGroupCollectionScoreMetadata} scoreMetadata
 */
InsightGroup.prototype['scoreMetadata'] = undefined;

/**
 * The insight group key
 * @member {String} key
 */
InsightGroup.prototype['key'] = undefined;

/**
 * The insight group name
 * @member {String} name
 */
InsightGroup.prototype['name'] = undefined;

/**
 * The project key
 * @member {String} projectKey
 */
InsightGroup.prototype['projectKey'] = undefined;

/**
 * The environment key
 * @member {String} environmentKey
 */
InsightGroup.prototype['environmentKey'] = undefined;

/**
 * The application keys
 * @member {Array.<String>} applicationKeys
 */
InsightGroup.prototype['applicationKeys'] = undefined;

/**
 * @member {Number} createdAt
 */
InsightGroup.prototype['createdAt'] = undefined;
