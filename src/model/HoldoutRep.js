...
class HoldoutRep {
    /**
     * Constructs a new <code>HoldoutRep</code>.
     * @alias module:model/HoldoutRep
     * @param id {String} 
     * @param status {module:model/HoldoutRep.StatusEnum} 
    ...
    constructor(id, status, holdoutAmount, createdAt, updatedAt, baseExperiment) { 
        ...
        HoldoutRep.initialize(this, id, status, holdoutAmount, createdAt, updatedAt, baseExperiment);
    }
    ...
    /**
     * Constructs a <code>HoldoutRep</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HoldoutRep} obj Optional instance to populate.
     * @return {module:model/HoldoutRep} The populated <code>HoldoutRep</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HoldoutRep();
            ...
            if (data.hasOwnProperty('experiments')) {
                obj['experiments'] = ApiClient.convertToType(data['experiments'], [RelatedExperimentRep]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>HoldoutRep</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HoldoutRep</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HoldoutRep.RequiredProperties) {
        ...
        if (data['experiments']) { // data not null
            ...
            for (const item of data['experiments']) {
                RelatedExperimentRep.validateJSON(item);
            };
        }
...
HoldoutRep.RequiredProperties = ["_id", "status", "holdoutAmount", "createdAt", "updatedAt", "baseExperiment"];

/**
 * @member {String} _id
 */
HoldoutRep.prototype['_id'] = undefined;

/**
 * @member {module:model/HoldoutRep.StatusEnum} status
 */
HoldoutRep.prototype['status'] = undefined;

/**
 * @member {String} description
 */
HoldoutRep.prototype['description'] = undefined;

/**
 * The percentage of traffic allocated to this holdout.
 * @member {String} holdoutAmount
 */
HoldoutRep.prototype['holdoutAmount'] = undefined;

/**
 * @member {Number} createdAt
 */
HoldoutRep.prototype['createdAt'] = undefined;

/**
 * @member {Number} updatedAt
 */
HoldoutRep.prototype['updatedAt'] = undefined;

/**
 * @member {module:model/Experiment} baseExperiment
 */
HoldoutRep.prototype['baseExperiment'] = undefined;

/**
 * @member {Array.<module:model/RelatedExperimentRep>} experiments
 */
HoldoutRep.prototype['experiments'] = undefined;
