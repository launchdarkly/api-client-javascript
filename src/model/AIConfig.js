...
import AIConfigMaintainer from './AIConfigMaintainer';
...
class AIConfig {
    /**
     * Constructs a new <code>AIConfig</code>.
     * @alias module:model/AIConfig
     * @param description {String} 
     * @param key {String} 
     * @param name {String} 
     * @param tags {Array.<String>} 
     * @param version {Number} 
     * @param variations {Array.<module:model/AIConfigVariation>} 
     * @param createdAt {Number} 
     * @param updatedAt {Number} 
     */
    constructor(description, key, name, tags, version, variations, createdAt, updatedAt) { 
        
        AIConfig.initialize(this, description, key, name, tags, version, variations, createdAt, updatedAt);
    }
    ...
    /**
     * Constructs a <code>AIConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AIConfig} obj Optional instance to populate.
     * @return {module:model/AIConfig} The populated <code>AIConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AIConfig();
            ...
            if (data.hasOwnProperty('_maintainer')) {
                obj['_maintainer'] = AIConfigMaintainer.constructFromObject(data['_maintainer']);
            }
            ...
            if (data.hasOwnProperty('variations')) {
                obj['variations'] = ApiClient.convertToType(data['variations'], [AIConfigVariation]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AIConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AIConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AIConfig.RequiredProperties) {
        ...
        if (data['_maintainer']) { // data not null
          AIConfigMaintainer.validateJSON(data['_maintainer']);
        }
        // ensure the json data is a string
...
AIConfig.RequiredProperties = ["description", "key", "name", "tags", "version", "variations", "createdAt", "updatedAt"];

/**
 * @member {module:model/AiConfigsAccess} _access
 */
AIConfig.prototype['_access'] = undefined;

/**
 * @member {module:model/ParentAndSelfLinks} _links
 */
AIConfig.prototype['_links'] = undefined;

/**
 * @member {String} description
 */
AIConfig.prototype['description'] = undefined;

/**
 * @member {String} key
 */
AIConfig.prototype['key'] = undefined;

/**
 * @member {module:model/AIConfigMaintainer} _maintainer
 */
AIConfig.prototype['_maintainer'] = undefined;

/**
 * @member {module:model/AIConfig.ModeEnum} mode
 * @default 'completion'
 */
AIConfig.prototype['mode'] = 'completion';

/**
 * @member {String} name
 */
AIConfig.prototype['name'] = undefined;

/**
 * @member {Array.<String>} tags
 */
AIConfig.prototype['tags'] = undefined;

/**
 * @member {Number} version
 */
AIConfig.prototype['version'] = undefined;

/**
 * @member {Array.<module:model/AIConfigVariation>} variations
 */
AIConfig.prototype['variations'] = undefined;

/**
 * @member {Number} createdAt
 */
AIConfig.prototype['createdAt'] = undefined;
