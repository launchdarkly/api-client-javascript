...
class Import {
     ...
     * @param id {String} The import ID
     * @param segmentKey {String} The segment key
     * @param creationTime {Number} 
     * @param mode {String} The import mode used, either <code>merge</code> or <code>replace</code>
     * @param status {module:model/Import.StatusEnum} The import status
     * @param links {Object.<String, module:model/Link>} The location and content type of related resources
     */
    constructor(id, segmentKey, creationTime, mode, status, links) { 
        
        Import.initialize(this, id, segmentKey, creationTime, mode, status, links);
    }
     ...
     */
    static initialize(obj, id, segmentKey, creationTime, mode, status, links) { 
        obj['id'] = id;
        obj['segmentKey'] = segmentKey;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('segmentKey')) {
                obj['segmentKey'] = ApiClient.convertToType(data['segmentKey'], 'String');
            }
            ...
            if (data.hasOwnProperty('files')) {
                obj['files'] = ApiClient.convertToType(data['files'], [FileRep]);
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['segmentKey'] && !(typeof data['segmentKey'] === 'string' || data['segmentKey'] instanceof String)) {
            throw new Error("Expected the field `segmentKey` to be a primitive type in the JSON string but got " + data['segmentKey']);
        }
        // ensure the json data is a string
...
Import.RequiredProperties = ["id", "segmentKey", "creationTime", "mode", "status", "_links"];
...
/**
 * The segment key
 * @member {String} segmentKey
 */
Import.prototype['segmentKey'] = undefined;

/**
 * @member {Number} creationTime
 */
Import.prototype['creationTime'] = undefined;

/**
 * The import mode used, either <code>merge</code> or <code>replace</code>
 * @member {String} mode
 */
Import.prototype['mode'] = undefined;
 ...
 * @member {Array.<module:model/FileRep>} files
 */
Import.prototype['files'] = undefined;

/**
 * The location and content type of related resources
 * @member {Object.<String, module:model/Link>} _links
 */
Import.prototype['_links'] = undefined;
