...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LaunchDarklyApi.FeatureFlagChangeRequestConfigBody = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.SemanticPatchInstruction);
  }
  ...
  /**
   * The FeatureFlagChangeRequestConfigBody model module.
   * @module model/FeatureFlagChangeRequestConfigBody
   * @version 3.9.1
   */

  /**
   * Constructs a new <code>FeatureFlagChangeRequestConfigBody</code>.
   * @alias module:model/FeatureFlagChangeRequestConfigBody
   * @class
  ...
  /**
   * Constructs a <code>FeatureFlagChangeRequestConfigBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FeatureFlagChangeRequestConfigBody} obj Optional instance to populate.
   * @return {module:model/FeatureFlagChangeRequestConfigBody} The populated <code>FeatureFlagChangeRequestConfigBody</code> instance.
   */
