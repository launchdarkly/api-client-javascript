...
class Project {
     ...
     */
    constructor(links, id, key, includeInSnippetByDefault, name, tags) { 
        
        Project.initialize(this, links, id, key, includeInSnippetByDefault, name, tags);
    }
     ...
     */
    static initialize(obj, links, id, key, includeInSnippetByDefault, name, tags) { 
        obj['_links'] = links;
        obj['_id'] = id;
        obj['key'] = key;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('environments')) {
                obj['environments'] = Environments.constructFromObject(data['environments']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['environments']) { // data not null
          Environments.validateJSON(data['environments']);
        }
...
Project.RequiredProperties = ["_links", "_id", "key", "includeInSnippetByDefault", "name", "tags"];

/**
 * The location and content type of related resources
 * @member {Object.<String, module:model/Link>} _links
 */
Project.prototype['_links'] = undefined;
 ...
 */
Project.prototype['includeInSnippetByDefault'] = undefined;

/**
 * @member {module:model/ClientSideAvailability} defaultClientSideAvailability
 */
Project.prototype['defaultClientSideAvailability'] = undefined;
 ...
 */
Project.prototype['defaultReleasePipelineKey'] = undefined;

/**
 * @member {module:model/Environments} environments
 */
Project.prototype['environments'] = undefined;
