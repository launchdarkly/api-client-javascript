...
import StatementRep from './StatementRep';
...
class RelayAutoConfigRep {
     ...
     * @param id {String} 
     * @param name {String} 
     * @param policy {Array.<module:model/StatementRep>} 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('_creator')) {
                obj['_creator'] = MemberSummaryRep.constructFromObject(data['_creator']);
            }
            ...
            if (data.hasOwnProperty('policy')) {
                obj['policy'] = ApiClient.convertToType(data['policy'], [StatementRep]);
            }
...
/**
 * @member {module:model/MemberSummaryRep} _creator
 */
...
/**
 * @member {Array.<module:model/StatementRep>} policy
 */
