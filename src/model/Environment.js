...
class Environment {
     ...
     * @param secureMode {Boolean} Secure mode ensures that a user of the client-side SDK cannot impersonate another user.
     * @param defaultTrackEvents {Boolean} Enables tracking detailed information for new flags by default.
     * @param requireComments {Boolean} Whether members who modify flags and user segments through the LaunchDarkly user interface are required to add a comment
     * @param confirmChanges {Boolean} Whether members who modify flags and user segments through the LaunchDarkly user interface are required to confirm those changes
