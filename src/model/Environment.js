...
class Environment {
     ...
     * @param id {String} The ID for the environment. Use this as the client-side ID for authorization in some client-side SDKs, and to associate LaunchDarkly environments with CDN integrations in edge SDKs.
     * @param key {String} A project-unique key for the new environment
     * @param name {String} A human-friendly name for the new environment
     * @param apiKey {String} The SDK key for the environment. Use this for authorization in server-side SDKs.
     * @param mobileKey {String} The mobile key for the environment. Use this for authorization in mobile SDKs.
     * @param color {String} The color used to indicate this environment in the UI
     * @param defaultTtl {Number} The default time (in minutes) that the PHP SDK can cache feature flag rules locally
     * @param secureMode {Boolean} Ensures that one end user of the client-side SDK cannot inspect the variations for another end user
     * @param defaultTrackEvents {Boolean} Enables tracking detailed information for new flags by default
     * @param requireComments {Boolean} Whether members who modify flags and segments through the LaunchDarkly user interface are required to add a comment
     * @param confirmChanges {Boolean} Whether members who modify flags and segments through the LaunchDarkly user interface are required to confirm those changes
     * @param tags {Array.<String>} A list of tags for this environment
     * @param critical {Boolean} Whether the environment is critical
     */
    constructor(links, id, key, name, apiKey, mobileKey, color, defaultTtl, secureMode, defaultTrackEvents, requireComments, confirmChanges, tags, critical) { 
        
        Environment.initialize(this, links, id, key, name, apiKey, mobileKey, color, defaultTtl, secureMode, defaultTrackEvents, requireComments, confirmChanges, tags, critical);
    }
     ...
     */
    static initialize(obj, links, id, key, name, apiKey, mobileKey, color, defaultTtl, secureMode, defaultTrackEvents, requireComments, confirmChanges, tags, critical) { 
        obj['_links'] = links;
        obj['_id'] = id;
        obj['key'] = key;
        obj['name'] = name;
        obj['apiKey'] = apiKey;
        obj['mobileKey'] = mobileKey;
        obj['color'] = color;
        obj['defaultTtl'] = defaultTtl;
        obj['secureMode'] = secureMode;
        obj['defaultTrackEvents'] = defaultTrackEvents;
        obj['requireComments'] = requireComments;
        obj['confirmChanges'] = confirmChanges;
        obj['tags'] = tags;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('resourceApprovalSettings')) {
                obj['resourceApprovalSettings'] = ApiClient.convertToType(data['resourceApprovalSettings'], {'String': ApprovalSettings});
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['mobileKey'] && !(typeof data['mobileKey'] === 'string' || data['mobileKey'] instanceof String)) {
            throw new Error("Expected the field `mobileKey` to be a primitive type in the JSON string but got " + data['mobileKey']);
        }
        // ensure the json data is a string
...
Environment.RequiredProperties = ["_links", "_id", "key", "name", "apiKey", "mobileKey", "color", "defaultTtl", "secureMode", "defaultTrackEvents", "requireComments", "confirmChanges", "tags", "critical"];
 ...
 * @member {String} _id
 */
Environment.prototype['_id'] = undefined;

/**
 * A project-unique key for the new environment
 * @member {String} key
 */
Environment.prototype['key'] = undefined;
 ...
 */
Environment.prototype['defaultTrackEvents'] = undefined;
 ...
 */
Environment.prototype['requireComments'] = undefined;
 ...
 */
Environment.prototype['confirmChanges'] = undefined;
 ...
 */
Environment.prototype['approvalSettings'] = undefined;

/**
 * Details on the approval settings for this environment for each resource kind
 * @member {Object.<String, module:model/ApprovalSettings>} resourceApprovalSettings
 */
Environment.prototype['resourceApprovalSettings'] = undefined;

/**
 * Whether the environment is critical
 * @member {Boolean} critical
 */
Environment.prototype['critical'] = undefined;
