...
class TreatmentResultRep {
    /**
     * Constructs a new <code>TreatmentResultRep</code>.
     * @alias module:model/TreatmentResultRep
     */
    constructor() { 
        
        TreatmentResultRep.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TreatmentResultRep</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TreatmentResultRep} obj Optional instance to populate.
     * @return {module:model/TreatmentResultRep} The populated <code>TreatmentResultRep</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TreatmentResultRep();
            ...
            if (data.hasOwnProperty('dataMean')) {
                obj['dataMean'] = ApiClient.convertToType(data['dataMean'], 'Number');
            }
            if (data.hasOwnProperty('dataStdDev')) {
                obj['dataStdDev'] = ApiClient.convertToType(data['dataStdDev'], 'Number');
            }
            if (data.hasOwnProperty('credibleInterval')) {
                obj['credibleInterval'] = CredibleIntervalRep.constructFromObject(data['credibleInterval']);
            }
            if (data.hasOwnProperty('pBest')) {
                obj['pBest'] = ApiClient.convertToType(data['pBest'], 'Number');
            }
            if (data.hasOwnProperty('relativeDifferences')) {
                obj['relativeDifferences'] = ApiClient.convertToType(data['relativeDifferences'], [RelativeDifferenceRep]);
            }
            ...
            if (data.hasOwnProperty('eventValuesSum')) {
                obj['eventValuesSum'] = ApiClient.convertToType(data['eventValuesSum'], 'Number');
            }
            ...
            if (data.hasOwnProperty('standardDeviationRatio')) {
                obj['standardDeviationRatio'] = ApiClient.convertToType(data['standardDeviationRatio'], 'Number');
            }
            if (data.hasOwnProperty('covariateImbalance')) {
                obj['covariateImbalance'] = ApiClient.convertToType(data['covariateImbalance'], 'Number');
            }
            if (data.hasOwnProperty('varianceReduction')) {
                obj['varianceReduction'] = ApiClient.convertToType(data['varianceReduction'], 'Number');
            }
            if (data.hasOwnProperty('model')) {
                obj['model'] = ApiClient.convertToType(data['model'], 'String');
            }
            if (data.hasOwnProperty('bayesianNormal')) {
                obj['bayesianNormal'] = BayesianNormalStatsRep.constructFromObject(data['bayesianNormal']);
            }
            if (data.hasOwnProperty('bayesianBeta')) {
                obj['bayesianBeta'] = BayesianBetaBinomialStatsRep.constructFromObject(data['bayesianBeta']);
            }
        }
        return obj;
    }
 ...
 */
TreatmentResultRep.prototype['treatmentId'] = undefined;

/**
 * The name of the treatment
 * @member {String} treatmentName
 */
TreatmentResultRep.prototype['treatmentName'] = undefined;
 ...
 * @member {Number} mean
 */
TreatmentResultRep.prototype['mean'] = undefined;

/**
 * The mean of the data, with no priors effecting the result.
 * @member {Number} dataMean
 */
TreatmentResultRep.prototype['dataMean'] = undefined;

/**
 * The standard deviation of the data, with no priors effecting the result.
 * @member {Number} dataStdDev
 */
TreatmentResultRep.prototype['dataStdDev'] = undefined;

/**
 * @member {module:model/CredibleIntervalRep} credibleInterval
 */
TreatmentResultRep.prototype['credibleInterval'] = undefined;
 ...
 * @member {Number} pBest
 */
TreatmentResultRep.prototype['pBest'] = undefined;

/**
 * Estimates of the relative difference between this treatment's mean and the mean of each other treatment
 * @member {Array.<module:model/RelativeDifferenceRep>} relativeDifferences
 */
TreatmentResultRep.prototype['relativeDifferences'] = undefined;

/**
 * The number of units exposed to this treatment that have event values, including those that are configured to default to 0
 * @member {Number} units
 */
TreatmentResultRep.prototype['units'] = undefined;

/**
 * The number of units exposed to this treatment.
 * @member {Number} traffic
 */
TreatmentResultRep.prototype['traffic'] = undefined;

/**
 * The sum of the event values for the units exposed to this treatment.
 * @member {Number} eventValuesSum
 */
TreatmentResultRep.prototype['eventValuesSum'] = undefined;

/**
 * @member {module:model/Distribution} distribution
 */
TreatmentResultRep.prototype['distribution'] = undefined;

/**
 * The outcome-covariate correlation
 * @member {Number} correlation
 */
TreatmentResultRep.prototype['correlation'] = undefined;

/**
 * The ratio of the outcome SD to covariate SD
 * @member {Number} standardDeviationRatio
 */
TreatmentResultRep.prototype['standardDeviationRatio'] = undefined;

/**
 * The imbalance between the covariate mean for the arm and the covariate mean for the experiment
 * @member {Number} covariateImbalance
 */
TreatmentResultRep.prototype['covariateImbalance'] = undefined;

/**
 * The reduction in variance resulting from CUPED
 * @member {Number} varianceReduction
 */
TreatmentResultRep.prototype['varianceReduction'] = undefined;
 ...
 * @member {module:model/TreatmentResultRep.ModelEnum} model
 */
TreatmentResultRep.prototype['model'] = undefined;

/**
 * @member {module:model/BayesianNormalStatsRep} bayesianNormal
 */
TreatmentResultRep.prototype['bayesianNormal'] = undefined;

/**
 * @member {module:model/BayesianBetaBinomialStatsRep} bayesianBeta
 */
TreatmentResultRep.prototype['bayesianBeta'] = undefined;
 ...
 * @readonly
 */
TreatmentResultRep['ModelEnum'] = {

    /**
     * value: "bayesianNormal"
     * @const
     */
...
export default TreatmentResultRep;
