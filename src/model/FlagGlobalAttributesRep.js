...
import MemberSummaryRep from './MemberSummaryRep';
...
class FlagGlobalAttributesRep {
     ...
     * @param temporary {Boolean} Whether or not the flag is a temporary flag
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('variationJsonSchema')) {
                obj['variationJsonSchema'] = ApiClient.convertToType(data['variationJsonSchema'], Object);
            }
            ...
            if (data.hasOwnProperty('_maintainer')) {
                obj['_maintainer'] = MemberSummaryRep.constructFromObject(data['_maintainer']);
            }
...
/**
 * @member {Object} variationJsonSchema
 */
FlagGlobalAttributesRep.prototype['variationJsonSchema'] = undefined;
...
/**
 * @member {module:model/MemberSummaryRep} _maintainer
 */
