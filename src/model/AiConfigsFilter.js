...
/**
 * The AiConfigsFilter model module.
 * @module model/AiConfigsFilter
 * @version 18.0.2
 */
class AiConfigsFilter {
    /**
     * Constructs a new <code>AiConfigsFilter</code>.
     * @alias module:model/AiConfigsFilter
     * @param type {module:model/AiConfigsFilter.TypeEnum} Filter type. One of [contextAttribute, eventProperty, group]
     * @param op {String} 
     * @param values {Array.<Object>} The context attribute / event property values or group member nodes
     * @param negate {Boolean} If set, then take the inverse of the operator. 'in' becomes 'not in'.
     */
    constructor(type, op, values, negate) { 
        
        AiConfigsFilter.initialize(this, type, op, values, negate);
    }
     ...
     */
    static initialize(obj, type, op, values, negate) { 
        obj['type'] = type;
        obj['op'] = op;
        obj['values'] = values;
        obj['negate'] = negate;
    ...
    /**
     * Constructs a <code>AiConfigsFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AiConfigsFilter} obj Optional instance to populate.
     * @return {module:model/AiConfigsFilter} The populated <code>AiConfigsFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AiConfigsFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>AiConfigsFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AiConfigsFilter</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AiConfigsFilter.RequiredProperties) {
...
export default AiConfigsFilter;
