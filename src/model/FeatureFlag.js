...
class FeatureFlag {
     ...
     * @param name {String} A human-friendly name for the feature flag
     * @param kind {module:model/FeatureFlag.KindEnum} Kind of feature flag
     * @param key {String} A unique key used to reference the flag in your code
     ...
     * @param temporary {Boolean} Whether the flag is a temporary flag
     * @param tags {Array.<String>} Tags for the feature flag
     * @param links {Object.<String, module:model/Link>} The location and content type of related resources
     * @param experiments {module:model/ExperimentInfoRep} 
     * @param customProperties {Object.<String, module:model/CustomProperty>} 
     * @param archived {Boolean} Boolean indicating if the feature flag is archived
     */
    constructor(name, kind, key, version, creationDate, variations, temporary, tags, links, experiments, customProperties, archived) { 
        
        FeatureFlag.initialize(this, name, kind, key, version, creationDate, variations, temporary, tags, links, experiments, customProperties, archived);
    }
     ...
     */
    static initialize(obj, name, kind, key, version, creationDate, variations, temporary, tags, links, experiments, customProperties, archived) { 
        obj['name'] = name;
        obj['kind'] = kind;
        obj['key'] = key;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('_maintainerTeam')) {
                obj['_maintainerTeam'] = MaintainerTeam.constructFromObject(data['_maintainerTeam']);
            }
            if (data.hasOwnProperty('goalIds')) {
                obj['goalIds'] = ApiClient.convertToType(data['goalIds'], ['String']);
            }
            if (data.hasOwnProperty('experiments')) {
                obj['experiments'] = ExperimentInfoRep.constructFromObject(data['experiments']);
            }
            ...
            if (data.hasOwnProperty('deprecatedDate')) {
                obj['deprecatedDate'] = ApiClient.convertToType(data['deprecatedDate'], 'Number');
            }
            if (data.hasOwnProperty('defaults')) {
                obj['defaults'] = Defaults.constructFromObject(data['defaults']);
            }
            if (data.hasOwnProperty('_purpose')) {
                obj['_purpose'] = ApiClient.convertToType(data['_purpose'], 'String');
            }
            if (data.hasOwnProperty('migrationSettings')) {
                obj['migrationSettings'] = FlagMigrationSettingsRep.constructFromObject(data['migrationSettings']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FeatureFlag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FeatureFlag</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FeatureFlag.RequiredProperties) {
        ...
        if (data['clientSideAvailability']) { // data not null
          ClientSideAvailability.validateJSON(data['clientSideAvailability']);
        }
        ...
        // ensure the json data is a string
        if (data['maintainerTeamKey'] && !(typeof data['maintainerTeamKey'] === 'string' || data['maintainerTeamKey'] instanceof String)) {
            throw new Error("Expected the field `maintainerTeamKey` to be a primitive type in the JSON string but got " + data['maintainerTeamKey']);
        }
        // validate the optional field `_maintainerTeam`
        if (data['_maintainerTeam']) { // data not null
          MaintainerTeam.validateJSON(data['_maintainerTeam']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['goalIds'])) {
            throw new Error("Expected the field `goalIds` to be an array in the JSON data but got " + data['goalIds']);
        }
        // validate the optional field `experiments`
        if (data['experiments']) { // data not null
          ExperimentInfoRep.validateJSON(data['experiments']);
        }
        ...
        // ensure the json data is a string
        if (data['_purpose'] && !(typeof data['_purpose'] === 'string' || data['_purpose'] instanceof String)) {
            throw new Error("Expected the field `_purpose` to be a primitive type in the JSON string but got " + data['_purpose']);
        }
        // validate the optional field `migrationSettings`
        if (data['migrationSettings']) { // data not null
          FlagMigrationSettingsRep.validateJSON(data['migrationSettings']);
        }
...
FeatureFlag.RequiredProperties = ["name", "kind", "key", "_version", "creationDate", "variations", "temporary", "tags", "_links", "experiments", "customProperties", "archived"];
 ...
 * @member {module:model/FeatureFlag.KindEnum} kind
 */
FeatureFlag.prototype['kind'] = undefined;

/**
 * Description of the feature flag
 * @member {String} description
 */
FeatureFlag.prototype['description'] = undefined;

/**
 * A unique key used to reference the flag in your code
 * @member {String} key
 */
FeatureFlag.prototype['key'] = undefined;

/**
 * Version of the feature flag
 * @member {Number} _version
 */
FeatureFlag.prototype['_version'] = undefined;

/**
 * @member {Number} creationDate
 */
FeatureFlag.prototype['creationDate'] = undefined;
 ...
 */
FeatureFlag.prototype['includeInSnippet'] = undefined;

/**
 * @member {module:model/ClientSideAvailability} clientSideAvailability
 */
FeatureFlag.prototype['clientSideAvailability'] = undefined;

/**
 * An array of possible variations for the flag
 * @member {Array.<module:model/Variation>} variations
 */
FeatureFlag.prototype['variations'] = undefined;

/**
 * Whether the flag is a temporary flag
 * @member {Boolean} temporary
 */
FeatureFlag.prototype['temporary'] = undefined;

/**
 * Tags for the feature flag
 * @member {Array.<String>} tags
 */
FeatureFlag.prototype['tags'] = undefined;

/**
 * The location and content type of related resources
 * @member {Object.<String, module:model/Link>} _links
 */
FeatureFlag.prototype['_links'] = undefined;

/**
 * Associated maintainerId for the feature flag
 * @member {String} maintainerId
 */
FeatureFlag.prototype['maintainerId'] = undefined;

/**
 * @member {module:model/MemberSummary} _maintainer
 */
FeatureFlag.prototype['_maintainer'] = undefined;

/**
 * The key of the associated team that maintains this feature flag
 * @member {String} maintainerTeamKey
 */
FeatureFlag.prototype['maintainerTeamKey'] = undefined;

/**
 * @member {module:model/MaintainerTeam} _maintainerTeam
 */
FeatureFlag.prototype['_maintainerTeam'] = undefined;

/**
 * Deprecated, use <code>experiments</code> instead
 * @member {Array.<String>} goalIds
 */
FeatureFlag.prototype['goalIds'] = undefined;

/**
 * @member {module:model/ExperimentInfoRep} experiments
 */
FeatureFlag.prototype['experiments'] = undefined;

/**
 * @member {Object.<String, module:model/CustomProperty>} customProperties
 */
FeatureFlag.prototype['customProperties'] = undefined;

/**
 * Boolean indicating if the feature flag is archived
 * @member {Boolean} archived
 */
FeatureFlag.prototype['archived'] = undefined;

/**
 * @member {Number} archivedDate
 */
FeatureFlag.prototype['archivedDate'] = undefined;

/**
 * Boolean indicating if the feature flag is deprecated
 * @member {Boolean} deprecated
 */
FeatureFlag.prototype['deprecated'] = undefined;

/**
 * @member {Number} deprecatedDate
 */
FeatureFlag.prototype['deprecatedDate'] = undefined;

/**
 * @member {module:model/Defaults} defaults
 */
FeatureFlag.prototype['defaults'] = undefined;

/**
 * @member {String} _purpose
 */
FeatureFlag.prototype['_purpose'] = undefined;

/**
 * @member {module:model/FlagMigrationSettingsRep} migrationSettings
 */
FeatureFlag.prototype['migrationSettings'] = undefined;
 ...
 */
FeatureFlag.prototype['environments'] = undefined;
