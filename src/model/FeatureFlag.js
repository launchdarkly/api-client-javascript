...
class FeatureFlag {
     ...
     */
    constructor(name, kind, key, version, creationDate, variations, temporary, tags, links, experiments, customProperties, archived, environments) { 
        
        FeatureFlag.initialize(this, name, kind, key, version, creationDate, variations, temporary, tags, links, experiments, customProperties, archived, environments);
    }
     ...
     */
    static initialize(obj, name, kind, key, version, creationDate, variations, temporary, tags, links, experiments, customProperties, archived, environments) { 
        obj['name'] = name;
        obj['kind'] = kind;
        obj['key'] = key;
