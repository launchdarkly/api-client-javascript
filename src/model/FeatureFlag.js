...
class FeatureFlag {
     ...
     * @param deprecated {Boolean} Boolean indicating if the feature flag is deprecated
     * @param environments {Object.<String, module:model/FeatureFlagConfig>} Details on the environments for this flag. Only returned if the request is filtered by environment, using the <code>filterEnv</code> query parameter.
     */
    constructor(name, kind, key, version, creationDate, variations, temporary, tags, links, experiments, customProperties, archived, deprecated, environments) { 
        
        FeatureFlag.initialize(this, name, kind, key, version, creationDate, variations, temporary, tags, links, experiments, customProperties, archived, deprecated, environments);
    }
     ...
     */
    static initialize(obj, name, kind, key, version, creationDate, variations, temporary, tags, links, experiments, customProperties, archived, deprecated, environments) { 
        obj['name'] = name;
        obj['kind'] = kind;
        obj['key'] = key;
