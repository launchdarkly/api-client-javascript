...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CustomProperty', 'model/FeatureFlagConfig', 'model/Links', 'model/Member', 'model/Variation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CustomProperty'), require('./FeatureFlagConfig'), require('./Links'), require('./Member'), require('./Variation'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyApi) {
      root.LaunchDarklyApi = {};
    }
    root.LaunchDarklyApi.FeatureFlag = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.CustomProperty, root.LaunchDarklyApi.FeatureFlagConfig, root.LaunchDarklyApi.Links, root.LaunchDarklyApi.Member, root.LaunchDarklyApi.Variation);
  }
}(this, function(ApiClient, CustomProperty, FeatureFlagConfig, Links, Member, Variation) {
  'use strict';
