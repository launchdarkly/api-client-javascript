...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ClientSideAvailability', 'model/CustomProperty', 'model/Defaults', 'model/FeatureFlagConfig', 'model/Links', 'model/Member', 'model/Variation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ClientSideAvailability'), require('./CustomProperty'), require('./Defaults'), require('./FeatureFlagConfig'), require('./Links'), require('./Member'), require('./Variation'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyApi) {
      root.LaunchDarklyApi = {};
    }
    root.LaunchDarklyApi.FeatureFlag = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.ClientSideAvailability, root.LaunchDarklyApi.CustomProperty, root.LaunchDarklyApi.Defaults, root.LaunchDarklyApi.FeatureFlagConfig, root.LaunchDarklyApi.Links, root.LaunchDarklyApi.Member, root.LaunchDarklyApi.Variation);
  }
}(this, function(ApiClient, ClientSideAvailability, CustomProperty, Defaults, FeatureFlagConfig, Links, Member, Variation) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_maintainer'))
        obj.maintainer = Member.constructFromObject(data['_maintainer']);
  ...
  /**
   * @member {module:model/Member} maintainer
   */
  exports.prototype.maintainer = undefined;
