...
class Team {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('_idpSynced')) {
                obj['_idpSynced'] = ApiClient.convertToType(data['_idpSynced'], 'Boolean');
            }
            if (data.hasOwnProperty('roleAttributes')) {
                obj['roleAttributes'] = ApiClient.convertToType(data['roleAttributes'], {'String': Array});
            }
            if (data.hasOwnProperty('roles')) {
                obj['roles'] = TeamCustomRoles.constructFromObject(data['roles']);
            }
            if (data.hasOwnProperty('members')) {
                obj['members'] = TeamMembers.constructFromObject(data['members']);
            }
            if (data.hasOwnProperty('projects')) {
                obj['projects'] = TeamProjects.constructFromObject(data['projects']);
            }
            if (data.hasOwnProperty('maintainers')) {
                obj['maintainers'] = TeamMaintainers.constructFromObject(data['maintainers']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['roles']) { // data not null
          TeamCustomRoles.validateJSON(data['roles']);
        }
        // validate the optional field `members`
        if (data['members']) { // data not null
          TeamMembers.validateJSON(data['members']);
        }
        // validate the optional field `projects`
        if (data['projects']) { // data not null
          TeamProjects.validateJSON(data['projects']);
        }
        // validate the optional field `maintainers`
        if (data['maintainers']) { // data not null
          TeamMaintainers.validateJSON(data['maintainers']);
        }
 ...
 */
Team.prototype['_access'] = undefined;

/**
 * @member {Number} _creationDate
 */
Team.prototype['_creationDate'] = undefined;

/**
 * The location and content type of related resources
 * @member {Object.<String, module:model/Link>} _links
 */
Team.prototype['_links'] = undefined;

/**
 * @member {Number} _lastModified
 */
Team.prototype['_lastModified'] = undefined;

/**
 * The team version
 * @member {Number} _version
 */
Team.prototype['_version'] = undefined;
 ...
 * @member {Boolean} _idpSynced
 */
Team.prototype['_idpSynced'] = undefined;

/**
 * @member {Object.<String, Array.<String>>} roleAttributes
 */
Team.prototype['roleAttributes'] = undefined;

/**
 * @member {module:model/TeamCustomRoles} roles
 */
Team.prototype['roles'] = undefined;

/**
 * @member {module:model/TeamMembers} members
 */
Team.prototype['members'] = undefined;

/**
 * @member {module:model/TeamProjects} projects
 */
Team.prototype['projects'] = undefined;

/**
 * @member {module:model/TeamMaintainers} maintainers
 */
Team.prototype['maintainers'] = undefined;
