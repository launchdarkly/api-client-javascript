...
class Filter {
     ...
     * @param type {module:model/Filter.TypeEnum} Filter type. One of [contextAttribute, eventProperty, group]
     * @param op {String} 
    ...
    constructor(type, op, values, negate) { 
        ...
        Filter.initialize(this, type, op, values, negate);
    }
...
Filter.RequiredProperties = ["type", "op", "values", "negate"];
