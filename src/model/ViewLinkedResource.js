...
import ViewLinkedResourceDetails from './ViewLinkedResourceDetails';
...
class ViewLinkedResource {
    /**
     * Constructs a new <code>ViewLinkedResource</code>.
     * @alias module:model/ViewLinkedResource
     * @param links {module:model/ParentAndSelfLinks} 
     * @param resourceKey {String} Key of the resource (flag, segment, AI config or metric)
     * @param resourceType {module:model/ViewLinkedResource.ResourceTypeEnum} 
     * @param linkedAt {Number} 
     */
    constructor(links, resourceKey, resourceType, linkedAt) { 
        
        ViewLinkedResource.initialize(this, links, resourceKey, resourceType, linkedAt);
    }
     ...
     */
    static initialize(obj, links, resourceKey, resourceType, linkedAt) { 
        obj['_links'] = links;
        obj['resourceKey'] = resourceKey;
        obj['resourceType'] = resourceType;
        obj['linkedAt'] = linkedAt;
    }

    /**
     * Constructs a <code>ViewLinkedResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ViewLinkedResource} obj Optional instance to populate.
     * @return {module:model/ViewLinkedResource} The populated <code>ViewLinkedResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ViewLinkedResource();
            ...
            if (data.hasOwnProperty('linkedAt')) {
                obj['linkedAt'] = ApiClient.convertToType(data['linkedAt'], 'Number');
            }
            if (data.hasOwnProperty('resourceDetails')) {
                obj['resourceDetails'] = ViewLinkedResourceDetails.constructFromObject(data['resourceDetails']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ViewLinkedResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ViewLinkedResource</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ViewLinkedResource.RequiredProperties) {
        ...
        if (data['resourceDetails']) { // data not null
          ViewLinkedResourceDetails.validateJSON(data['resourceDetails']);
        }
...
ViewLinkedResource.RequiredProperties = ["_links", "resourceKey", "resourceType", "linkedAt"];

/**
 * @member {module:model/ParentAndSelfLinks} _links
 */
ViewLinkedResource.prototype['_links'] = undefined;

/**
 * Key of the resource (flag, segment, AI config or metric)
 * @member {String} resourceKey
 */
ViewLinkedResource.prototype['resourceKey'] = undefined;

/**
 * Environment ID of the resource (only present for segments)
 * @member {String} environmentId
 */
ViewLinkedResource.prototype['environmentId'] = undefined;

/**
 * Environment Key of the resource (only present for segments)
 * @member {String} environmentKey
 */
ViewLinkedResource.prototype['environmentKey'] = undefined;

/**
 * @member {module:model/ViewLinkedResource.ResourceTypeEnum} resourceType
 */
ViewLinkedResource.prototype['resourceType'] = undefined;

/**
 * @member {Number} linkedAt
 */
ViewLinkedResource.prototype['linkedAt'] = undefined;

/**
 * @member {module:model/ViewLinkedResourceDetails} resourceDetails
 */
ViewLinkedResource.prototype['resourceDetails'] = undefined;
 ...
 * @readonly
 */
ViewLinkedResource['ResourceTypeEnum'] = {
...
export default ViewLinkedResource;
