...
class ReleasePolicy {
    /**
     * Constructs a new <code>ReleasePolicy</code>.
     * @alias module:model/ReleasePolicy
     * @param id {String} The unique identifier of the release policy
     * @param rank {Number} The rank/priority of the release policy
     * @param releaseMethod {module:model/ReleaseMethod} 
     * @param name {String} The name of the release policy
     * @param key {String} The human-readable key of the release policy
     */
    constructor(id, rank, releaseMethod, name, key) { 
        
        ReleasePolicy.initialize(this, id, rank, releaseMethod, name, key);
    }
     ...
     */
    static initialize(obj, id, rank, releaseMethod, name, key) { 
        obj['_id'] = id;
        obj['rank'] = rank;
        obj['releaseMethod'] = releaseMethod;
        obj['name'] = name;
        obj['key'] = key;
    }

    /**
     * Constructs a <code>ReleasePolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReleasePolicy} obj Optional instance to populate.
     * @return {module:model/ReleasePolicy} The populated <code>ReleasePolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReleasePolicy();

            if (data.hasOwnProperty('_access')) {
                obj['_access'] = ReleasePoliciesAccessRep.constructFromObject(data['_access']);
            }
            if (data.hasOwnProperty('_id')) {
                obj['_id'] = ApiClient.convertToType(data['_id'], 'String');
            }
            if (data.hasOwnProperty('scope')) {
                obj['scope'] = ReleasePolicyScope.constructFromObject(data['scope']);
            }
            if (data.hasOwnProperty('rank')) {
                obj['rank'] = ApiClient.convertToType(data['rank'], 'Number');
            }
            if (data.hasOwnProperty('releaseMethod')) {
                obj['releaseMethod'] = ReleaseMethod.constructFromObject(data['releaseMethod']);
            }
            if (data.hasOwnProperty('guardedReleaseConfig')) {
    ...
    /**
     * Validates the JSON data with respect to <code>ReleasePolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReleasePolicy</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReleasePolicy.RequiredProperties) {
        ...
        if (data['_access']) { // data not null
          ReleasePoliciesAccessRep.validateJSON(data['_access']);
        }
        ...
        if (data['scope']) { // data not null
          ReleasePolicyScope.validateJSON(data['scope']);
        }
...
ReleasePolicy.RequiredProperties = ["_id", "rank", "releaseMethod", "name", "key"];

/**
 * @member {module:model/ReleasePoliciesAccessRep} _access
 */
ReleasePolicy.prototype['_access'] = undefined;

/**
 * The unique identifier of the release policy
 * @member {String} _id
 */
ReleasePolicy.prototype['_id'] = undefined;

/**
 * @member {module:model/ReleasePolicyScope} scope
 */
ReleasePolicy.prototype['scope'] = undefined;

/**
 * The rank/priority of the release policy
 * @member {Number} rank
 */
ReleasePolicy.prototype['rank'] = undefined;

/**
 * @member {module:model/ReleaseMethod} releaseMethod
 */
ReleasePolicy.prototype['releaseMethod'] = undefined;

/**
 * @member {module:model/GuardedReleaseConfig} guardedReleaseConfig
 */
 ...
 * @member {String} name
 */
ReleasePolicy.prototype['name'] = undefined;

/**
 * The human-readable key of the release policy
 * @member {String} key
 */
ReleasePolicy.prototype['key'] = undefined;
