...
class BigSegmentStoreIntegration {
    /**
     * Constructs a new <code>BigSegmentStoreIntegration</code>.
     * @alias module:model/BigSegmentStoreIntegration
     * @param links {module:model/BigSegmentStoreIntegrationLinks} 
     * @param id {String} The integration ID
     * @param integrationKey {module:model/BigSegmentStoreIntegration.IntegrationKeyEnum} The integration key
     * @param projectKey {String} The project key
     * @param environmentKey {String} The environment key
     * @param config {Object.<String, Object>} 
     * @param on {Boolean} Whether the configuration is turned on
     * @param tags {Array.<String>} List of tags for this configuration
     * @param name {String} Name of the configuration
     * @param version {Number} Version of the current configuration
     * @param status {module:model/BigSegmentStoreStatus} 
     */
    constructor(links, id, integrationKey, projectKey, environmentKey, config, on, tags, name, version, status) { 
        
        BigSegmentStoreIntegration.initialize(this, links, id, integrationKey, projectKey, environmentKey, config, on, tags, name, version, status);
    }
     ...
     */
    static initialize(obj, links, id, integrationKey, projectKey, environmentKey, config, on, tags, name, version, status) { 
        obj['_links'] = links;
        obj['_id'] = id;
    ...
    /**
     * Constructs a <code>BigSegmentStoreIntegration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigSegmentStoreIntegration} obj Optional instance to populate.
     * @return {module:model/BigSegmentStoreIntegration} The populated <code>BigSegmentStoreIntegration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigSegmentStoreIntegration();

            if (data.hasOwnProperty('_links')) {
                obj['_links'] = BigSegmentStoreIntegrationLinks.constructFromObject(data['_links']);
            }
            ...
            if (data.hasOwnProperty('_status')) {
                obj['_status'] = BigSegmentStoreStatus.constructFromObject(data['_status']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BigSegmentStoreIntegration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigSegmentStoreIntegration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BigSegmentStoreIntegration.RequiredProperties) {
        ...
        if (data['_links']) { // data not null
          BigSegmentStoreIntegrationLinks.validateJSON(data['_links']);
        }
        ...
        // validate the optional field `_status`
        if (data['_status']) { // data not null
          BigSegmentStoreStatus.validateJSON(data['_status']);
        }
...
BigSegmentStoreIntegration.RequiredProperties = ["_links", "_id", "integrationKey", "projectKey", "environmentKey", "config", "on", "tags", "name", "version", "_status"];

/**
 * @member {module:model/BigSegmentStoreIntegrationLinks} _links
 */
BigSegmentStoreIntegration.prototype['_links'] = undefined;

/**
 * The integration ID
 * @member {String} _id
 */
BigSegmentStoreIntegration.prototype['_id'] = undefined;

/**
 * The integration key
 * @member {module:model/BigSegmentStoreIntegration.IntegrationKeyEnum} integrationKey
 */
BigSegmentStoreIntegration.prototype['integrationKey'] = undefined;

/**
 * The project key
 * @member {String} projectKey
 */
BigSegmentStoreIntegration.prototype['projectKey'] = undefined;

/**
 * The environment key
 * @member {String} environmentKey
 */
BigSegmentStoreIntegration.prototype['environmentKey'] = undefined;

/**
 * @member {Object.<String, Object>} config
 */
BigSegmentStoreIntegration.prototype['config'] = undefined;

/**
 * Whether the configuration is turned on
 * @member {Boolean} on
 */
BigSegmentStoreIntegration.prototype['on'] = undefined;

/**
 * List of tags for this configuration
 * @member {Array.<String>} tags
 */
BigSegmentStoreIntegration.prototype['tags'] = undefined;

/**
 * Name of the configuration
 * @member {String} name
 */
BigSegmentStoreIntegration.prototype['name'] = undefined;

/**
 * Version of the current configuration
 * @member {Number} version
 */
BigSegmentStoreIntegration.prototype['version'] = undefined;

/**
 * @member {module:model/Access} _access
 */
BigSegmentStoreIntegration.prototype['_access'] = undefined;

/**
 * @member {module:model/BigSegmentStoreStatus} _status
 */
BigSegmentStoreIntegration.prototype['_status'] = undefined;
...
/**
 * Allowed values for the <code>integrationKey</code> property.
 * @enum {String}
 * @readonly
 */
...
export default BigSegmentStoreIntegration;
