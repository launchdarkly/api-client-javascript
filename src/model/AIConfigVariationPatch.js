...
import VariationToolPost from './VariationToolPost';

/**
 * The AIConfigVariationPatch model module.
 * @module model/AIConfigVariationPatch
 * @version 18.0.0
 */
class AIConfigVariationPatch {
    /**
     * Constructs a new <code>AIConfigVariationPatch</code>.
     * @alias module:model/AIConfigVariationPatch
     */
    constructor() { 
        
        AIConfigVariationPatch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AIConfigVariationPatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AIConfigVariationPatch} obj Optional instance to populate.
     * @return {module:model/AIConfigVariationPatch} The populated <code>AIConfigVariationPatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AIConfigVariationPatch();
            ...
            if (data.hasOwnProperty('tools')) {
                obj['tools'] = ApiClient.convertToType(data['tools'], [VariationToolPost]);
            }
            if (data.hasOwnProperty('toolKeys')) {
                obj['toolKeys'] = ApiClient.convertToType(data['toolKeys'], ['String']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AIConfigVariationPatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AIConfigVariationPatch</code>.
     */
    static validateJSON(data) {
        ...
        if (data['tools']) { // data not null
            ...
            for (const item of data['tools']) {
                VariationToolPost.validateJSON(item);
            };
        }
        // ensure the json data is an array
        if (!Array.isArray(data['toolKeys'])) {
            throw new Error("Expected the field `toolKeys` to be an array in the JSON data but got " + data['toolKeys']);
        }
 ...
 */
AIConfigVariationPatch.prototype['comment'] = undefined;

/**
 * Description for agent when AI Config is in agent mode.
 * @member {String} description
 */
AIConfigVariationPatch.prototype['description'] = undefined;

/**
 * Instructions for agent when AI Config is in agent mode.
 * @member {String} instructions
 */
AIConfigVariationPatch.prototype['instructions'] = undefined;

/**
 * @member {Array.<module:model/Message>} messages
 */
AIConfigVariationPatch.prototype['messages'] = undefined;

/**
 * @member {Object} model
 */
AIConfigVariationPatch.prototype['model'] = undefined;

/**
 * @member {String} modelConfigKey
 */
AIConfigVariationPatch.prototype['modelConfigKey'] = undefined;

/**
 * @member {String} name
 */
AIConfigVariationPatch.prototype['name'] = undefined;

/**
 * @member {Boolean} published
 */
AIConfigVariationPatch.prototype['published'] = undefined;

/**
 * One of 'archived', 'published'
 * @member {String} state
 */
AIConfigVariationPatch.prototype['state'] = undefined;

/**
 * List of tools to use for this variation. The latest version of the tool will be used.
 * @member {Array.<module:model/VariationToolPost>} tools
 */
AIConfigVariationPatch.prototype['tools'] = undefined;

/**
 * List of tool keys to use for this variation. The latest version of the tool will be used.
 * @member {Array.<String>} toolKeys
 */
AIConfigVariationPatch.prototype['toolKeys'] = undefined;

/**
 * @member {module:model/JudgeConfiguration} judgeConfiguration
 */
AIConfigVariationPatch.prototype['judgeConfiguration'] = undefined;
...
export default AIConfigVariationPatch;
