...
/**
 * The NewMemberForm model module.
 * @module model/NewMemberForm
 * @version 20.0.0
 */
class NewMemberForm {
    /**
     * Constructs a new <code>NewMemberForm</code>.
     * @alias module:model/NewMemberForm
     * @param email {String} The member's email
     */
    constructor(email) { 
        
        NewMemberForm.initialize(this, email);
    }
    ...
    /**
     * Constructs a <code>NewMemberForm</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewMemberForm} obj Optional instance to populate.
     * @return {module:model/NewMemberForm} The populated <code>NewMemberForm</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewMemberForm();
    ...
    /**
     * Validates the JSON data with respect to <code>NewMemberForm</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewMemberForm</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NewMemberForm.RequiredProperties) {
        ...
        if (!Array.isArray(data['teamKeys'])) {
            throw new Error("Expected the field `teamKeys` to be an array in the JSON data but got " + data['teamKeys']);
        }
...
NewMemberForm.RequiredProperties = ["email"];

/**
 * The member's email
 * @member {String} email
 */
NewMemberForm.prototype['email'] = undefined;

/**
 * The member's password
 * @member {String} password
 */
NewMemberForm.prototype['password'] = undefined;

/**
 * The member's first name
 * @member {String} firstName
 */
NewMemberForm.prototype['firstName'] = undefined;

/**
 * The member's last name
 * @member {String} lastName
 */
NewMemberForm.prototype['lastName'] = undefined;

/**
 * The member's initial role, if you are using a base role for the initial role
 * @member {module:model/NewMemberForm.RoleEnum} role
 */
NewMemberForm.prototype['role'] = undefined;
 ...
 */
NewMemberForm.prototype['customRoles'] = undefined;

/**
 * An array of the member's teams
 * @member {Array.<String>} teamKeys
 */
NewMemberForm.prototype['teamKeys'] = undefined;

/**
 * @member {Object.<String, Array.<String>>} roleAttributes
 */
NewMemberForm.prototype['roleAttributes'] = undefined;
