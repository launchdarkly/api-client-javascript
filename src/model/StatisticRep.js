...
/**
 * The StatisticRep model module.
 * @module model/StatisticRep
 * @version 19.0.0
 */
class StatisticRep {
    /**
     * Constructs a new <code>StatisticRep</code>.
     * @alias module:model/StatisticRep
     * @param name {String} The repository name
     * @param type {module:model/StatisticRep.TypeEnum} The type of repository
     * @param sourceLink {String} A URL to access the repository
     ...
     * @param hunkCount {Number} The number of code reference hunks in which the flag appears in this repository
     * @param fileCount {Number} The number of files in which the flag appears in this repository
     * @param links {Object.<String, module:model/Link>} The location and content type of related resources
     */
    constructor(name, type, sourceLink, defaultBranch, enabled, version, hunkCount, fileCount, links) { 
        
        StatisticRep.initialize(this, name, type, sourceLink, defaultBranch, enabled, version, hunkCount, fileCount, links);
    }
     ...
     */
    static initialize(obj, name, type, sourceLink, defaultBranch, enabled, version, hunkCount, fileCount, links) { 
        obj['name'] = name;
        obj['type'] = type;
        ...
        obj['enabled'] = enabled;
        obj['version'] = version;
        obj['hunkCount'] = hunkCount;
        obj['fileCount'] = fileCount;
        obj['_links'] = links;
    }

    /**
     * Constructs a <code>StatisticRep</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatisticRep} obj Optional instance to populate.
     * @return {module:model/StatisticRep} The populated <code>StatisticRep</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatisticRep();
            ...
            if (data.hasOwnProperty('hunkCount')) {
                obj['hunkCount'] = ApiClient.convertToType(data['hunkCount'], 'Number');
            }
            ...
            if (data.hasOwnProperty('latestCommitTime')) {
                obj['latestCommitTime'] = ApiClient.convertToType(data['latestCommitTime'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StatisticRep</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatisticRep</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatisticRep.RequiredProperties) {
...
StatisticRep.RequiredProperties = ["name", "type", "sourceLink", "defaultBranch", "enabled", "version", "hunkCount", "fileCount", "_links"];

/**
 * The repository name
 * @member {String} name
 */
StatisticRep.prototype['name'] = undefined;

/**
 * The type of repository
 * @member {module:model/StatisticRep.TypeEnum} type
 */
StatisticRep.prototype['type'] = undefined;

/**
 * A URL to access the repository
 * @member {String} sourceLink
 */
StatisticRep.prototype['sourceLink'] = undefined;

/**
 * The repository's default branch
 * @member {String} defaultBranch
 */
StatisticRep.prototype['defaultBranch'] = undefined;

/**
 * Whether or not a repository is enabled for code reference scanning
 * @member {Boolean} enabled
 */
StatisticRep.prototype['enabled'] = undefined;

/**
 * The version of the repository's saved information
 * @member {Number} version
 */
StatisticRep.prototype['version'] = undefined;

/**
 * The number of code reference hunks in which the flag appears in this repository
 * @member {Number} hunkCount
 */
StatisticRep.prototype['hunkCount'] = undefined;

/**
 * The number of files in which the flag appears in this repository
 * @member {Number} fileCount
 */
StatisticRep.prototype['fileCount'] = undefined;

/**
 * The location and content type of related resources
 * @member {Object.<String, module:model/Link>} _links
 */
StatisticRep.prototype['_links'] = undefined;

/**
 * @member {Number} latestCommitTime
 */
StatisticRep.prototype['latestCommitTime'] = undefined;
