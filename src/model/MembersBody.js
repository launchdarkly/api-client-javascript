...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CustomRoleKeyOrId', 'model/NonOwnerRole', 'model/Statements'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CustomRoleKeyOrId'), require('./NonOwnerRole'), require('./Statements'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyRestApi) {
      root.LaunchDarklyRestApi = {};
    }
    root.LaunchDarklyRestApi.MembersBody = factory(root.LaunchDarklyRestApi.ApiClient, root.LaunchDarklyRestApi.CustomRoleKeyOrId, root.LaunchDarklyRestApi.NonOwnerRole, root.LaunchDarklyRestApi.Statements);
  }
}(this, function(ApiClient, CustomRoleKeyOrId, NonOwnerRole, Statements) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('role')) {
        obj['role'] = NonOwnerRole.constructFromObject(data['role']);
      }
  ...
  /**
   * @member {module:model/NonOwnerRole} role
   */
