...
/**
 * The ApprovalRequestSettingsPatch model module.
 * @module model/ApprovalRequestSettingsPatch
 * @version 19.0.0
 */
class ApprovalRequestSettingsPatch {
    /**
     * Constructs a new <code>ApprovalRequestSettingsPatch</code>.
     * @alias module:model/ApprovalRequestSettingsPatch
     * @param environmentKey {String} 
     * @param resourceKind {String} 
     */
    constructor(environmentKey, resourceKind) { 
        
        ApprovalRequestSettingsPatch.initialize(this, environmentKey, resourceKind);
    }
     ...
     */
    static initialize(obj, environmentKey, resourceKind) { 
        obj['environmentKey'] = environmentKey;
        obj['resourceKind'] = resourceKind;
    }

    /**
     * Constructs a <code>ApprovalRequestSettingsPatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApprovalRequestSettingsPatch} obj Optional instance to populate.
     * @return {module:model/ApprovalRequestSettingsPatch} The populated <code>ApprovalRequestSettingsPatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApprovalRequestSettingsPatch();
    ...
    /**
     * Validates the JSON data with respect to <code>ApprovalRequestSettingsPatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApprovalRequestSettingsPatch</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApprovalRequestSettingsPatch.RequiredProperties) {
...
ApprovalRequestSettingsPatch.RequiredProperties = ["environmentKey", "resourceKind"];
 ...
 */
ApprovalRequestSettingsPatch.prototype['autoApplyApprovedChanges'] = undefined;

/**
 * Whether to skip approvals for pending changes
 * @member {Boolean} bypassApprovalsForPendingChanges
 */
ApprovalRequestSettingsPatch.prototype['bypassApprovalsForPendingChanges'] = undefined;

/**
 * Allow applying the change as long as at least one person has approved
 * @member {Boolean} canApplyDeclinedChanges
 */
ApprovalRequestSettingsPatch.prototype['canApplyDeclinedChanges'] = undefined;

/**
 * Allow someone who makes an approval request to apply their own change
 * @member {Boolean} canReviewOwnRequest
 */
ApprovalRequestSettingsPatch.prototype['canReviewOwnRequest'] = undefined;

/**
 * @member {String} environmentKey
 */
ApprovalRequestSettingsPatch.prototype['environmentKey'] = undefined;
 ...
 */
ApprovalRequestSettingsPatch.prototype['minNumApprovals'] = undefined;

/**
 * If approvals are required for this environment
 * @member {Boolean} required
 */
ApprovalRequestSettingsPatch.prototype['required'] = undefined;
 ...
 */
ApprovalRequestSettingsPatch.prototype['requiredApprovalTags'] = undefined;

/**
 * @member {String} resourceKind
 */
ApprovalRequestSettingsPatch.prototype['resourceKind'] = undefined;

/**
 * Arbitrary service-specific configuration
 * @member {Object.<String, Object>} serviceConfig
 */
ApprovalRequestSettingsPatch.prototype['serviceConfig'] = undefined;

/**
 * Which service to use for managing approvals
 * @member {String} serviceKind
 */
ApprovalRequestSettingsPatch.prototype['serviceKind'] = undefined;
 ...
 */
ApprovalRequestSettingsPatch.prototype['serviceKindConfigurationId'] = undefined;
...
export default ApprovalRequestSettingsPatch;
