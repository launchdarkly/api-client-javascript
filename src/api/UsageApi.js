...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LaunchDarklyApi.UsageApi = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.EvaluationUsageError, root.LaunchDarklyApi.Events, root.LaunchDarklyApi.MAU, root.LaunchDarklyApi.MAUbyCategory, root.LaunchDarklyApi.Stream, root.LaunchDarklyApi.StreamBySDK, root.LaunchDarklyApi.StreamSDKVersion, root.LaunchDarklyApi.StreamUsageError, root.LaunchDarklyApi.Streams, root.LaunchDarklyApi.Usage, root.LaunchDarklyApi.UsageError);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/UsageApi~getEvaluationsCallback
     ...
     * @param {module:api/UsageApi~getEvaluationsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/UsageApi~getEventCallback
     * @param {String} error Error message, if any.
     * @param {module:model/StreamSDKVersion} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/UsageApi~getEventCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StreamSDKVersion}
     */
     ...
     * @callback module:api/UsageApi~getEventsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UsageApi~getEventsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/UsageApi~getMAUCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UsageApi~getMAUCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/UsageApi~getMAUByCategoryCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UsageApi~getMAUByCategoryCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/UsageApi~getStreamCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UsageApi~getStreamCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/UsageApi~getStreamBySDKCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} source The source of where the stream comes from.
     * @param {module:api/UsageApi~getStreamBySDKCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/UsageApi~getStreamSDKVersionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/StreamSDKVersion} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} source The source of where the stream comes from.
     * @param {module:api/UsageApi~getStreamSDKVersionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StreamSDKVersion}
     */
     ...
     * @callback module:api/UsageApi~getStreamsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UsageApi~getStreamsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/UsageApi~getUsageCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UsageApi~getUsageCallback} callback The callback function, accepting three arguments: error, data, response
