...
/**
* SegmentsBeta service.
* @module api/SegmentsBetaApi
* @version 12.1.0
*/
export default class SegmentsBetaApi {

    /**
    * Constructs a new SegmentsBetaApi. 
    * @alias module:api/SegmentsBetaApi
    * @class
    ...
    */
     ...
     * @callback module:api/SegmentsBetaApi~createBigSegmentExportCallback
     ...
     * @param {module:api/SegmentsBetaApi~createBigSegmentExportCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/SegmentsBetaApi~createBigSegmentImportCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} opts.file CSV file containing keys
     * @param {String} opts.mode Import mode. Use either `merge` or `replace`
     * @param {module:api/SegmentsBetaApi~createBigSegmentImportCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/SegmentsBetaApi~getBigSegmentExportCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/SegmentsBetaApi~getBigSegmentExportCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/SegmentsBetaApi~getBigSegmentImportCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/SegmentsBetaApi~getBigSegmentImportCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/SegmentsBetaApi~getContextInstanceSegmentsMembershipByEnvCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/SegmentsBetaApi~getContextInstanceSegmentsMembershipByEnvCallback} callback The callback function, accepting three arguments: error, data, response
