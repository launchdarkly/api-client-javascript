...
export default class FlagTriggersApi {
    ...
    /**
    * Constructs a new FlagTriggersApi. 
    * @alias module:api/FlagTriggersApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createTriggerWorkflow operation.
     * @callback module:api/FlagTriggersApi~createTriggerWorkflowCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TriggerWorkflowRep} data The data returned by the service call.
     ...
     * @param {module:model/TriggerPost} triggerPost 
     * @param {module:api/FlagTriggersApi~createTriggerWorkflowCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TriggerWorkflowRep}
     */
    createTriggerWorkflow(projKey, envKey, flagKey, triggerPost, callback) {
      let postBody = triggerPost;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling createTriggerWorkflow");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling createTriggerWorkflow");
      }
      // verify the required parameter 'flagKey' is set
      if (flagKey === undefined || flagKey === null) {
        throw new Error("Missing the required parameter 'flagKey' when calling createTriggerWorkflow");
      }
      // verify the required parameter 'triggerPost' is set
      if (triggerPost === undefined || triggerPost === null) {
        throw new Error("Missing the required parameter 'triggerPost' when calling createTriggerWorkflow");
      }
      ...
      let returnType = TriggerWorkflowRep;
      return this.apiClient.callApi(
        '/api/v2/flags/{projKey}/{flagKey}/triggers/{envKey}', 'POST',
    ...
    /**
     * Callback function to receive the result of the deleteTriggerWorkflow operation.
     * @callback module:api/FlagTriggersApi~deleteTriggerWorkflowCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/FlagTriggersApi~deleteTriggerWorkflowCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteTriggerWorkflow(projKey, envKey, flagKey, id, callback) {
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling deleteTriggerWorkflow");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling deleteTriggerWorkflow");
      }
      // verify the required parameter 'flagKey' is set
      if (flagKey === undefined || flagKey === null) {
        throw new Error("Missing the required parameter 'flagKey' when calling deleteTriggerWorkflow");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteTriggerWorkflow");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/api/v2/flags/{projKey}/{flagKey}/triggers/{envKey}/{id}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getTriggerWorkflowById operation.
     * @callback module:api/FlagTriggersApi~getTriggerWorkflowByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TriggerWorkflowRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} envKey The environment key
     * @param {String} id The flag trigger ID
     * @param {module:api/FlagTriggersApi~getTriggerWorkflowByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TriggerWorkflowRep}
     */
    getTriggerWorkflowById(projKey, flagKey, envKey, id, callback) {
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getTriggerWorkflowById");
      }
      // verify the required parameter 'flagKey' is set
      if (flagKey === undefined || flagKey === null) {
        throw new Error("Missing the required parameter 'flagKey' when calling getTriggerWorkflowById");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling getTriggerWorkflowById");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getTriggerWorkflowById");
      }
      ...
      let returnType = TriggerWorkflowRep;
      return this.apiClient.callApi(
        '/api/v2/flags/{projKey}/{flagKey}/triggers/{envKey}/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getTriggerWorkflows operation.
     * @callback module:api/FlagTriggersApi~getTriggerWorkflowsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TriggerWorkflowCollectionRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} envKey The environment key
     * @param {String} flagKey The flag key
     * @param {module:api/FlagTriggersApi~getTriggerWorkflowsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TriggerWorkflowCollectionRep}
     */
    getTriggerWorkflows(projKey, envKey, flagKey, callback) {
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getTriggerWorkflows");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling getTriggerWorkflows");
      }
      // verify the required parameter 'flagKey' is set
      if (flagKey === undefined || flagKey === null) {
        throw new Error("Missing the required parameter 'flagKey' when calling getTriggerWorkflows");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = TriggerWorkflowCollectionRep;
      return this.apiClient.callApi(
        '/api/v2/flags/{projKey}/{flagKey}/triggers/{envKey}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the patchTriggerWorkflow operation.
     * @callback module:api/FlagTriggersApi~patchTriggerWorkflowCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TriggerWorkflowRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} flagKey The flag key
     * @param {String} id The flag trigger ID
     * @param {module:model/FlagTriggerInput} flagTriggerInput 
     * @param {module:api/FlagTriggersApi~patchTriggerWorkflowCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TriggerWorkflowRep}
     */
    patchTriggerWorkflow(projKey, envKey, flagKey, id, flagTriggerInput, callback) {
      let postBody = flagTriggerInput;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling patchTriggerWorkflow");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling patchTriggerWorkflow");
      }
      // verify the required parameter 'flagKey' is set
      if (flagKey === undefined || flagKey === null) {
        throw new Error("Missing the required parameter 'flagKey' when calling patchTriggerWorkflow");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling patchTriggerWorkflow");
      }
      // verify the required parameter 'flagTriggerInput' is set
      if (flagTriggerInput === undefined || flagTriggerInput === null) {
        throw new Error("Missing the required parameter 'flagTriggerInput' when calling patchTriggerWorkflow");
      }
      ...
      let returnType = TriggerWorkflowRep;
      return this.apiClient.callApi(
        '/api/v2/flags/{projKey}/{flagKey}/triggers/{envKey}/{id}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
