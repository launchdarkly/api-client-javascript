...
export default class ApplicationsBetaApi {
    ...
    */
     ...
     * @param {String} applicationKey The application key
     * @param {Object} opts Optional parameters
     * @param {String} opts.filter Accepts filter by `key`, `name`, `supported`, and `autoAdded`. To learn more about the filter syntax, read [Filtering applications and application versions](/tag/Applications-(beta)#filtering-contexts-and-context-instances).
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.filter Accepts filter by `key`, `name`, `kind`, and `autoAdded`. To learn more about the filter syntax, read [Filtering applications and application versions](/tag/Applications-(beta)#filtering-contexts-and-context-instances).
