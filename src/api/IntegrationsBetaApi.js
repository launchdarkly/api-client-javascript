...
export default class IntegrationsBetaApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createIntegrationConfiguration operation.
     * @callback module:api/IntegrationsBetaApi~createIntegrationConfigurationCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IntegrationConfigurationsRep} data The data returned by the service call.
     ...
     * @param {module:model/IntegrationConfigurationPost} integrationConfigurationPost 
     * @param {module:api/IntegrationsBetaApi~createIntegrationConfigurationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IntegrationConfigurationsRep}
     */
    createIntegrationConfiguration(integrationKey, integrationConfigurationPost, callback) {
      let postBody = integrationConfigurationPost;
      // verify the required parameter 'integrationKey' is set
      if (integrationKey === undefined || integrationKey === null) {
        throw new Error("Missing the required parameter 'integrationKey' when calling createIntegrationConfiguration");
      }
      // verify the required parameter 'integrationConfigurationPost' is set
      if (integrationConfigurationPost === undefined || integrationConfigurationPost === null) {
        throw new Error("Missing the required parameter 'integrationConfigurationPost' when calling createIntegrationConfiguration");
      }
      ...
      let returnType = IntegrationConfigurationsRep;
      return this.apiClient.callApi(
        '/api/v2/integration-configurations/keys/{integrationKey}', 'POST',
    ...
    /**
     * Callback function to receive the result of the deleteIntegrationConfiguration operation.
     * @callback module:api/IntegrationsBetaApi~deleteIntegrationConfigurationCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/IntegrationsBetaApi~deleteIntegrationConfigurationCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteIntegrationConfiguration(integrationConfigurationId, callback) {
      let postBody = null;
      // verify the required parameter 'integrationConfigurationId' is set
      if (integrationConfigurationId === undefined || integrationConfigurationId === null) {
        throw new Error("Missing the required parameter 'integrationConfigurationId' when calling deleteIntegrationConfiguration");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/api/v2/integration-configurations/{integrationConfigurationId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getAllIntegrationConfigurations operation.
     * @callback module:api/IntegrationsBetaApi~getAllIntegrationConfigurationsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IntegrationConfigurationCollectionRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/IntegrationsBetaApi~getAllIntegrationConfigurationsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IntegrationConfigurationCollectionRep}
     */
    getAllIntegrationConfigurations(integrationKey, callback) {
      let postBody = null;
      // verify the required parameter 'integrationKey' is set
      if (integrationKey === undefined || integrationKey === null) {
        throw new Error("Missing the required parameter 'integrationKey' when calling getAllIntegrationConfigurations");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = IntegrationConfigurationCollectionRep;
      return this.apiClient.callApi(
        '/api/v2/integration-configurations/keys/{integrationKey}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getIntegrationConfiguration operation.
     * @callback module:api/IntegrationsBetaApi~getIntegrationConfigurationCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IntegrationConfigurationsRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/IntegrationsBetaApi~getIntegrationConfigurationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IntegrationConfigurationsRep}
     */
    getIntegrationConfiguration(integrationConfigurationId, callback) {
      let postBody = null;
      // verify the required parameter 'integrationConfigurationId' is set
      if (integrationConfigurationId === undefined || integrationConfigurationId === null) {
        throw new Error("Missing the required parameter 'integrationConfigurationId' when calling getIntegrationConfiguration");
      }
      ...
      let returnType = IntegrationConfigurationsRep;
      return this.apiClient.callApi(
        '/api/v2/integration-configurations/{integrationConfigurationId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateIntegrationConfiguration operation.
     * @callback module:api/IntegrationsBetaApi~updateIntegrationConfigurationCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IntegrationConfigurationsRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/IntegrationsBetaApi~updateIntegrationConfigurationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IntegrationConfigurationsRep}
     */
    updateIntegrationConfiguration(integrationConfigurationId, patchOperation, callback) {
      let postBody = patchOperation;
      // verify the required parameter 'integrationConfigurationId' is set
      if (integrationConfigurationId === undefined || integrationConfigurationId === null) {
        throw new Error("Missing the required parameter 'integrationConfigurationId' when calling updateIntegrationConfiguration");
      }
      // verify the required parameter 'patchOperation' is set
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling updateIntegrationConfiguration");
      }
      ...
      let returnType = IntegrationConfigurationsRep;
      return this.apiClient.callApi(
        '/api/v2/integration-configurations/{integrationConfigurationId}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
