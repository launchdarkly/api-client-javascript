...
/**
* MetricsBeta service.
* @module api/MetricsBetaApi
* @version 17.2.0
*/
export default class MetricsBetaApi {

    /**
    * Constructs a new MetricsBetaApi. 
    * @alias module:api/MetricsBetaApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createMetricGroup operation.
     * @callback module:api/MetricsBetaApi~createMetricGroupCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MetricGroupRep} data The data returned by the service call.
     ...
     * @param {module:model/MetricGroupPost} metricGroupPost 
     * @param {module:api/MetricsBetaApi~createMetricGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MetricGroupRep}
     */
    createMetricGroup(projectKey, metricGroupPost, callback) {
      let postBody = metricGroupPost;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling createMetricGroup");
      }
      // verify the required parameter 'metricGroupPost' is set
      if (metricGroupPost === undefined || metricGroupPost === null) {
        throw new Error("Missing the required parameter 'metricGroupPost' when calling createMetricGroup");
      }
    ...
    /**
     * Callback function to receive the result of the deleteMetricGroup operation.
     * @callback module:api/MetricsBetaApi~deleteMetricGroupCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MetricsBetaApi~deleteMetricGroupCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteMetricGroup(projectKey, metricGroupKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling deleteMetricGroup");
      }
      // verify the required parameter 'metricGroupKey' is set
      if (metricGroupKey === undefined || metricGroupKey === null) {
        throw new Error("Missing the required parameter 'metricGroupKey' when calling deleteMetricGroup");
      }
    ...
    /**
     * Callback function to receive the result of the getMetricGroup operation.
     * @callback module:api/MetricsBetaApi~getMetricGroupCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MetricGroupRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MetricsBetaApi~getMetricGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MetricGroupRep}
     */
    getMetricGroup(projectKey, metricGroupKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getMetricGroup");
      }
      // verify the required parameter 'metricGroupKey' is set
      if (metricGroupKey === undefined || metricGroupKey === null) {
        throw new Error("Missing the required parameter 'metricGroupKey' when calling getMetricGroup");
      }
    ...
    /**
     * Callback function to receive the result of the getMetricGroups operation.
     * @callback module:api/MetricsBetaApi~getMetricGroupsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MetricGroupCollectionRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} projectKey The project key
     * @param {Object} opts Optional parameters
     * @param {String} opts.filter Accepts filter by `experimentStatus`, `query`, `kind`, `hasConnections`, `maintainerIds`, and `maintainerTeamKey`. Example: `filter=experimentStatus equals 'running' and query equals 'test'`.
     ...
     * @param {String} opts.expand A comma-separated list of properties that can reveal additional information in the response.
     * @param {Number} opts.limit The number of metric groups to return in the response. Defaults to 20. Maximum limit is 50.
     ...
     * @param {module:api/MetricsBetaApi~getMetricGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MetricGroupCollectionRep}
     */
    getMetricGroups(projectKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getMetricGroups");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = MetricGroupCollectionRep;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the patchMetricGroup operation.
     * @callback module:api/MetricsBetaApi~patchMetricGroupCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MetricGroupRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MetricsBetaApi~patchMetricGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MetricGroupRep}
     */
    patchMetricGroup(projectKey, metricGroupKey, patchOperation, callback) {
      let postBody = patchOperation;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling patchMetricGroup");
      }
      // verify the required parameter 'metricGroupKey' is set
      if (metricGroupKey === undefined || metricGroupKey === null) {
        throw new Error("Missing the required parameter 'metricGroupKey' when calling patchMetricGroup");
      }
      // verify the required parameter 'patchOperation' is set
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling patchMetricGroup");
      }
