...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PatchOperation', 'model/UserSegment', 'model/UserSegmentBody', 'model/UserSegments', 'model/UserTargetingExpirationForSegment'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PatchOperation'), require('../model/UserSegment'), require('../model/UserSegmentBody'), require('../model/UserSegments'), require('../model/UserTargetingExpirationForSegment'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyApi) {
      root.LaunchDarklyApi = {};
    }
    root.LaunchDarklyApi.UserSegmentsApi = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.PatchOperation, root.LaunchDarklyApi.UserSegment, root.LaunchDarklyApi.UserSegmentBody, root.LaunchDarklyApi.UserSegments, root.LaunchDarklyApi.UserTargetingExpirationForSegment);
  }
}(this, function(ApiClient, PatchOperation, UserSegment, UserSegmentBody, UserSegments, UserTargetingExpirationForSegment) {
  'use strict';
