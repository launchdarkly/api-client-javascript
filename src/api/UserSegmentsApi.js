...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/UserSegmentsApi~updateBigSegmentTargetsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/UserSegmentsApi~updateBigSegmentTargetsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.updateBigSegmentTargets = function(projectKey, environmentKey, userSegmentKey, bigSegmentTargetsBody, callback) {
      ...
      // verify the required parameter 'userSegmentKey' is set
      if (userSegmentKey === undefined || userSegmentKey === null) {
        throw new Error("Missing the required parameter 'userSegmentKey' when calling updateBigSegmentTargets");
      }

      // verify the required parameter 'bigSegmentTargetsBody' is set
      if (bigSegmentTargetsBody === undefined || bigSegmentTargetsBody === null) {
        throw new Error("Missing the required parameter 'bigSegmentTargetsBody' when calling updateBigSegmentTargets");
      }
