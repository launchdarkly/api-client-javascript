...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BigSegmentTargetsBody', 'model/PatchOperation', 'model/UserSegment', 'model/UserSegmentBody', 'model/UserSegments', 'model/UserTargetingExpirationForSegment'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BigSegmentTargetsBody'), require('../model/PatchOperation'), require('../model/UserSegment'), require('../model/UserSegmentBody'), require('../model/UserSegments'), require('../model/UserTargetingExpirationForSegment'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyApi) {
      root.LaunchDarklyApi = {};
    }
    root.LaunchDarklyApi.UserSegmentsApi = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.BigSegmentTargetsBody, root.LaunchDarklyApi.PatchOperation, root.LaunchDarklyApi.UserSegment, root.LaunchDarklyApi.UserSegmentBody, root.LaunchDarklyApi.UserSegments, root.LaunchDarklyApi.UserTargetingExpirationForSegment);
  }
}(this, function(ApiClient, BigSegmentTargetsBody, PatchOperation, UserSegment, UserSegmentBody, UserSegments, UserTargetingExpirationForSegment) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the updatedBigSegmentTargets operation.
     * @callback module:api/UserSegmentsApi~updatedBigSegmentTargetsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
     * @param {String} userSegmentKey The user segment's key. The key identifies the user segment in your code.
     * @param {module:model/BigSegmentTargetsBody} bigSegmentTargetsBody Add or remove user targets to the included or excluded lists on a big segment. Contact your account manager for early access to this feature.
     * @param {module:api/UserSegmentsApi~updatedBigSegmentTargetsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.updatedBigSegmentTargets = function(projectKey, environmentKey, userSegmentKey, bigSegmentTargetsBody, callback) {
      var postBody = bigSegmentTargetsBody;

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling updatedBigSegmentTargets");
      }

      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling updatedBigSegmentTargets");
      }

      // verify the required parameter 'userSegmentKey' is set
      if (userSegmentKey === undefined || userSegmentKey === null) {
        throw new Error("Missing the required parameter 'userSegmentKey' when calling updatedBigSegmentTargets");
      }

      // verify the required parameter 'bigSegmentTargetsBody' is set
      if (bigSegmentTargetsBody === undefined || bigSegmentTargetsBody === null) {
        throw new Error("Missing the required parameter 'bigSegmentTargetsBody' when calling updatedBigSegmentTargets");
      }
      ...
      return this.apiClient.callApi(
        '/segments/{projectKey}/{environmentKey}/{userSegmentKey}/users', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
