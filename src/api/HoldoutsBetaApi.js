...
export default class HoldoutsBetaApi {
    ...
    /**
    * Constructs a new HoldoutsBetaApi. 
    * @alias module:api/HoldoutsBetaApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAllHoldouts operation.
     * @callback module:api/HoldoutsBetaApi~getAllHoldoutsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/HoldoutsCollectionRep} data The data returned by the service call.
     ...
     * @param {Number} opts.limit The number of holdouts to return in the response. Defaults to 20
     ...
     * @param {module:api/HoldoutsBetaApi~getAllHoldoutsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/HoldoutsCollectionRep}
     */
    getAllHoldouts(projectKey, environmentKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getAllHoldouts");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getAllHoldouts");
      }
      ...
      let returnType = HoldoutsCollectionRep;
      return this.apiClient.callApi(
        '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts', 'GET',
    ...
    /**
     * Callback function to receive the result of the getHoldout operation.
     * @callback module:api/HoldoutsBetaApi~getHoldoutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/HoldoutDetailRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.expand A comma-separated list of properties that can reveal additional information in the response. Supported fields are explained above. Holdout experiment expansion fields have no prefix. Related experiment expansion fields have `rel-` as a prefix.
     * @param {module:api/HoldoutsBetaApi~getHoldoutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/HoldoutDetailRep}
     */
    getHoldout(projectKey, environmentKey, holdoutKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getHoldout");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getHoldout");
      }
      // verify the required parameter 'holdoutKey' is set
      if (holdoutKey === undefined || holdoutKey === null) {
        throw new Error("Missing the required parameter 'holdoutKey' when calling getHoldout");
      }

      let pathParams = {
        'projectKey': projectKey,
        'environmentKey': environmentKey,
        'holdoutKey': holdoutKey
      };
      let queryParams = {
        'expand': opts['expand']
      };
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = HoldoutDetailRep;
      return this.apiClient.callApi(
        '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/{holdoutKey}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getHoldoutById operation.
     * @callback module:api/HoldoutsBetaApi~getHoldoutByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/HoldoutRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/HoldoutsBetaApi~getHoldoutByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/HoldoutRep}
     */
    getHoldoutById(projectKey, environmentKey, holdoutId, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getHoldoutById");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getHoldoutById");
      }
      // verify the required parameter 'holdoutId' is set
      if (holdoutId === undefined || holdoutId === null) {
        throw new Error("Missing the required parameter 'holdoutId' when calling getHoldoutById");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = HoldoutRep;
      return this.apiClient.callApi(
        '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/id/{holdoutId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the patchHoldout operation.
     * @callback module:api/HoldoutsBetaApi~patchHoldoutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/HoldoutRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/HoldoutPatchInput} holdoutPatchInput 
     * @param {module:api/HoldoutsBetaApi~patchHoldoutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/HoldoutRep}
     */
    patchHoldout(projectKey, environmentKey, holdoutKey, holdoutPatchInput, callback) {
      let postBody = holdoutPatchInput;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling patchHoldout");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling patchHoldout");
      }
      // verify the required parameter 'holdoutKey' is set
      if (holdoutKey === undefined || holdoutKey === null) {
        throw new Error("Missing the required parameter 'holdoutKey' when calling patchHoldout");
      }
      // verify the required parameter 'holdoutPatchInput' is set
      if (holdoutPatchInput === undefined || holdoutPatchInput === null) {
        throw new Error("Missing the required parameter 'holdoutPatchInput' when calling patchHoldout");
      }
      ...
      let returnType = HoldoutRep;
      return this.apiClient.callApi(
        '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/{holdoutKey}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the postHoldout operation.
     * @callback module:api/HoldoutsBetaApi~postHoldoutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/HoldoutRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} projectKey The project key
     * @param {String} environmentKey The environment key
     * @param {module:model/HoldoutPostRequest} holdoutPostRequest 
     * @param {module:api/HoldoutsBetaApi~postHoldoutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/HoldoutRep}
     */
    postHoldout(projectKey, environmentKey, holdoutPostRequest, callback) {
      let postBody = holdoutPostRequest;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling postHoldout");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling postHoldout");
      }
      // verify the required parameter 'holdoutPostRequest' is set
      if (holdoutPostRequest === undefined || holdoutPostRequest === null) {
        throw new Error("Missing the required parameter 'holdoutPostRequest' when calling postHoldout");
      }
      ...
      let returnType = HoldoutRep;
      return this.apiClient.callApi(
        '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
