...
export default class MetricsApi {
    ...
    */
     ...
     * @param {String} opts.filter A comma-separated list of filters. This endpoint only accepts filtering by `tags`. To learn more about the filter syntax, read the 'Filtering metrics' section above.
