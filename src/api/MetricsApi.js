...
export default class MetricsApi {
    ...
    */
     ...
     */
    deleteMetric(projectKey, metricKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling deleteMetric");
      }
      // verify the required parameter 'metricKey' is set
      if (metricKey === undefined || metricKey === null) {
        throw new Error("Missing the required parameter 'metricKey' when calling deleteMetric");
      }
     ...
     * @callback module:api/MetricsApi~getMetricCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MetricRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.versionId The specific version ID of the metric
     ...
     */
    getMetric(projectKey, metricKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getMetric");
      }
      // verify the required parameter 'metricKey' is set
      if (metricKey === undefined || metricKey === null) {
        throw new Error("Missing the required parameter 'metricKey' when calling getMetric");
      }
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/MetricCollectionRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.expand A comma-separated list of properties that can reveal additional information in the response.
     * @param {Number} opts.limit The number of metrics to return in the response. Defaults to 20. Maximum limit is 50.
     ...
     * @param {String} opts.sort A field to sort the items by. Prefix field by a dash ( - ) to sort in descending order. This endpoint supports sorting by `createdAt` or `name`.
     * @param {String} opts.filter A comma-separated list of filters. This endpoint accepts filtering by `query`, `tags`, 'eventKind', 'isNumeric', 'unitAggregationType`, `hasConnections`, `maintainerIds`, and `maintainerTeamKey`. To learn more about the filter syntax, read the 'Filtering metrics' section above.
     ...
     */
    getMetrics(projectKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getMetrics");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = MetricCollectionRep;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the patchMetric operation.
     * @callback module:api/MetricsApi~patchMetricCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MetricRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MetricsApi~patchMetricCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MetricRep}
     */
    patchMetric(projectKey, metricKey, patchOperation, callback) {
      let postBody = patchOperation;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling patchMetric");
      }
      // verify the required parameter 'metricKey' is set
      if (metricKey === undefined || metricKey === null) {
        throw new Error("Missing the required parameter 'metricKey' when calling patchMetric");
      }
      // verify the required parameter 'patchOperation' is set
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling patchMetric");
      }
    ...
    /**
     * Callback function to receive the result of the postMetric operation.
     * @callback module:api/MetricsApi~postMetricCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MetricRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} projectKey The project key
     * @param {module:model/MetricPost} metricPost 
     * @param {module:api/MetricsApi~postMetricCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MetricRep}
     */
    postMetric(projectKey, metricPost, callback) {
      let postBody = metricPost;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling postMetric");
      }
      // verify the required parameter 'metricPost' is set
      if (metricPost === undefined || metricPost === null) {
        throw new Error("Missing the required parameter 'metricPost' when calling postMetric");
      }
