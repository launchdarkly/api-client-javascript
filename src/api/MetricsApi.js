...
export default class MetricsApi {
    ...
    */
     ...
     */
    deleteMetric(projectKey, key, callback) {
      let postBody = null;
      ...
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling deleteMetric");
      }
     ...
     */
    getMetric(projectKey, key, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
      ...
      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling getMetric");
      }
      ...
      return this.apiClient.callApi(
        '/api/v2/metrics/{projectKey}/{key}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     */
    getMetrics(projectKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
     ...
     * data is of type: {@link module:model/MetricRep}
     */
    patchMetric(projectKey, key, patchOperation, callback) {
      ...
      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling patchMetric");
      }
      ...
      let returnType = MetricRep;
      return this.apiClient.callApi(
        '/api/v2/metrics/{projectKey}/{key}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
