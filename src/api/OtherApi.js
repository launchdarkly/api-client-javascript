...
export default class OtherApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {Object.<String, module:model/{String: Link}>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link Object.<String, module:model/{String: Link}>}
     */
    getRoot(callback) {
      let postBody = null;
