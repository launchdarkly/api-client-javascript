...
export default class OtherApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {Object.<String, module:model/{String: InlineResponse200}>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link Object.<String, module:model/{String: InlineResponse200}>}
     */
    getRoot(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = {'String': InlineResponse200};
      return this.apiClient.callApi(
        '/api/v2', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
