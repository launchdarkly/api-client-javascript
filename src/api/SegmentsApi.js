...
export default class SegmentsApi {
    ...
    */
     ...
     */
    getSegments(projectKey, environmentKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
     ...
     */
    patchExpiringTargetsForSegment(projectKey, environmentKey, segmentKey, patchSegmentRequest, callback) {
      ...
      if (patchSegmentRequest === undefined || patchSegmentRequest === null) {
        throw new Error("Missing the required parameter 'patchSegmentRequest' when calling patchExpiringTargetsForSegment");
      }
