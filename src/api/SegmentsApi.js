...
export default class SegmentsApi {
    ...
    */
     ...
     * @param {Boolean} opts.waitOnApprovals Whether to wait for approvals before processing the import
     ...
     * @param {String} environmentKey The environment key
     * @param {Object} opts Optional parameters
     * @param {Number} opts.limit The number of segments to return. Defaults to 20.
     ...
     * @param {String} opts.sort Accepts sorting order and fields. Fields can be comma separated. Possible fields are 'creationDate', 'name', 'lastModified'. Example: `sort=name` sort by names ascending or `sort=-name,creationDate` sort by names descending and creationDate ascending.
     * @param {String} opts.filter Accepts filter by `excludedKeys`, `external`, `includedKeys`, `query`, `tags`, `unbounded`. To learn more about the filter syntax, read the  'Filtering segments' section above.
