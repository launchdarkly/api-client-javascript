...
export default class WebhooksApi {
    ...
    */
     ...
     * @callback module:api/WebhooksApi~getAllWebhooksCallback
     * @param {String} error Error message, if any.
     ...
     * data is of type: {@link module:model/Webhook}
     */
    patchWebhook(id, patchOperation, callback) {
      let postBody = patchOperation;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling patchWebhook");
      }
      // verify the required parameter 'patchOperation' is set
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling patchWebhook");
      }
     ...
     * @param {module:model/WebhookPost} webhookPost 
     ...
     * data is of type: {@link module:model/Webhook}
     */
    postWebhook(webhookPost, callback) {
      let postBody = webhookPost;
