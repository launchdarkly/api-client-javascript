...
export default class FollowFlagsApi {
    ...
    /**
    * Constructs a new FollowFlagsApi. 
    * @alias module:api/FollowFlagsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the deleteFlagFollowers operation.
     * @callback module:api/FollowFlagsApi~deleteFlagFollowersCallback
     ...
     * @param {module:api/FollowFlagsApi~deleteFlagFollowersCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteFlagFollowers(projectKey, featureFlagKey, environmentKey, memberId, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling deleteFlagFollowers");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling deleteFlagFollowers");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling deleteFlagFollowers");
      }
      // verify the required parameter 'memberId' is set
      if (memberId === undefined || memberId === null) {
        throw new Error("Missing the required parameter 'memberId' when calling deleteFlagFollowers");
      }
    ...
    /**
     * Callback function to receive the result of the getFlagFollowers operation.
     * @callback module:api/FollowFlagsApi~getFlagFollowersCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FlagFollowersGetRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} featureFlagKey The feature flag key
     * @param {String} environmentKey The environment key
     * @param {module:api/FollowFlagsApi~getFlagFollowersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FlagFollowersGetRep}
     */
    getFlagFollowers(projectKey, featureFlagKey, environmentKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getFlagFollowers");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling getFlagFollowers");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getFlagFollowers");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = FlagFollowersGetRep;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getFollowersByProjEnv operation.
     * @callback module:api/FollowFlagsApi~getFollowersByProjEnvCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FlagFollowersByProjEnvGetRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} projectKey The project key
     * @param {String} environmentKey The environment key
     * @param {module:api/FollowFlagsApi~getFollowersByProjEnvCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FlagFollowersByProjEnvGetRep}
     */
    getFollowersByProjEnv(projectKey, environmentKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getFollowersByProjEnv");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getFollowersByProjEnv");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = FlagFollowersByProjEnvGetRep;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the putFlagFollowers operation.
     * @callback module:api/FollowFlagsApi~putFlagFollowersCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/FollowFlagsApi~putFlagFollowersCallback} callback The callback function, accepting three arguments: error, data, response
     */
    putFlagFollowers(projectKey, featureFlagKey, environmentKey, memberId, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling putFlagFollowers");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling putFlagFollowers");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling putFlagFollowers");
      }
      // verify the required parameter 'memberId' is set
      if (memberId === undefined || memberId === null) {
        throw new Error("Missing the required parameter 'memberId' when calling putFlagFollowers");
      }
