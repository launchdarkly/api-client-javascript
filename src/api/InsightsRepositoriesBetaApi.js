...
/**
* InsightsRepositoriesBeta service.
* @module api/InsightsRepositoriesBetaApi
* @version 15.1.0
*/
export default class InsightsRepositoriesBetaApi {

    /**
    * Constructs a new InsightsRepositoriesBetaApi. 
    * @alias module:api/InsightsRepositoriesBetaApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the associateRepositoriesAndProjects operation.
     * @callback module:api/InsightsRepositoriesBetaApi~associateRepositoriesAndProjectsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InsightsRepositoryProjectCollection} data The data returned by the service call.
     ...
     * Associate repositories with projects
     * @param {module:model/InsightsRepositoryProjectMappings} insightsRepositoryProjectMappings 
     * @param {module:api/InsightsRepositoriesBetaApi~associateRepositoriesAndProjectsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InsightsRepositoryProjectCollection}
     */
    associateRepositoriesAndProjects(insightsRepositoryProjectMappings, callback) {
      let postBody = insightsRepositoryProjectMappings;
      // verify the required parameter 'insightsRepositoryProjectMappings' is set
      if (insightsRepositoryProjectMappings === undefined || insightsRepositoryProjectMappings === null) {
        throw new Error("Missing the required parameter 'insightsRepositoryProjectMappings' when calling associateRepositoriesAndProjects");
      }
      ...
      let returnType = InsightsRepositoryProjectCollection;
    ...
    /**
     * Callback function to receive the result of the deleteRepositoryProject operation.
     * @callback module:api/InsightsRepositoriesBetaApi~deleteRepositoryProjectCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/InsightsRepositoriesBetaApi~deleteRepositoryProjectCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteRepositoryProject(repositoryKey, projectKey, callback) {
      let postBody = null;
      // verify the required parameter 'repositoryKey' is set
      if (repositoryKey === undefined || repositoryKey === null) {
        throw new Error("Missing the required parameter 'repositoryKey' when calling deleteRepositoryProject");
      }
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling deleteRepositoryProject");
      }
    ...
    /**
     * Callback function to receive the result of the getInsightsRepositories operation.
     * @callback module:api/InsightsRepositoriesBetaApi~getInsightsRepositoriesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InsightsRepositoryCollection} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.expand Expand properties in response. Options: `projects`
     * @param {module:api/InsightsRepositoriesBetaApi~getInsightsRepositoriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InsightsRepositoryCollection}
     */
    getInsightsRepositories(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = InsightsRepositoryCollection;
      return this.apiClient.callApi(
