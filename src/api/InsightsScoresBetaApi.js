...
export default class InsightsScoresBetaApi {
    ...
    /**
    * Constructs a new InsightsScoresBetaApi. 
    * @alias module:api/InsightsScoresBetaApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createInsightGroup operation.
     * @callback module:api/InsightsScoresBetaApi~createInsightGroupCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InsightGroup} data The data returned by the service call.
     ...
     * Create insight group
     * @param {module:model/PostInsightGroupParams} postInsightGroupParams 
     * @param {module:api/InsightsScoresBetaApi~createInsightGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InsightGroup}
     */
    createInsightGroup(postInsightGroupParams, callback) {
      let postBody = postInsightGroupParams;
      // verify the required parameter 'postInsightGroupParams' is set
      if (postInsightGroupParams === undefined || postInsightGroupParams === null) {
        throw new Error("Missing the required parameter 'postInsightGroupParams' when calling createInsightGroup");
      }
    ...
    /**
     * Callback function to receive the result of the deleteInsightGroup operation.
     * @callback module:api/InsightsScoresBetaApi~deleteInsightGroupCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/InsightsScoresBetaApi~deleteInsightGroupCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteInsightGroup(insightGroupKey, callback) {
      let postBody = null;
      // verify the required parameter 'insightGroupKey' is set
      if (insightGroupKey === undefined || insightGroupKey === null) {
        throw new Error("Missing the required parameter 'insightGroupKey' when calling deleteInsightGroup");
      }

      let pathParams = {
        'insightGroupKey': insightGroupKey
      };
      let queryParams = {
      };
      let headerParams = {
    ...
    /**
     * Callback function to receive the result of the getInsightGroup operation.
     * @callback module:api/InsightsScoresBetaApi~getInsightGroupCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InsightGroup} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.expand Options: `scores`, `environment`
     * @param {module:api/InsightsScoresBetaApi~getInsightGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InsightGroup}
     */
    getInsightGroup(insightGroupKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'insightGroupKey' is set
      if (insightGroupKey === undefined || insightGroupKey === null) {
        throw new Error("Missing the required parameter 'insightGroupKey' when calling getInsightGroup");
      }
    ...
    /**
     * Callback function to receive the result of the getInsightGroups operation.
     * @callback module:api/InsightsScoresBetaApi~getInsightGroupsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InsightGroupCollection} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.limit The number of insight groups to return. Default is 20. Must be between 1 and 20 inclusive.
     ...
     * @param {String} opts.sort Sort flag list by field. Prefix field with <code>-</code> to sort in descending order. Allowed fields: name
     * @param {String} opts.query Filter list of insights groups by name.
     * @param {String} opts.expand Options: `scores`, `environment`, `metadata`
     * @param {module:api/InsightsScoresBetaApi~getInsightGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InsightGroupCollection}
     */
    getInsightGroups(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = InsightGroupCollection;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getInsightsScores operation.
     * @callback module:api/InsightsScoresBetaApi~getInsightsScoresCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InsightScores} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/InsightsScoresBetaApi~getInsightsScoresCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InsightScores}
     */
    getInsightsScores(projectKey, environmentKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getInsightsScores");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getInsightsScores");
      }
    ...
    /**
     * Callback function to receive the result of the patchInsightGroup operation.
     * @callback module:api/InsightsScoresBetaApi~patchInsightGroupCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InsightGroup} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/InsightsScoresBetaApi~patchInsightGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InsightGroup}
     */
    patchInsightGroup(insightGroupKey, patchOperation, callback) {
      let postBody = patchOperation;
      // verify the required parameter 'insightGroupKey' is set
      if (insightGroupKey === undefined || insightGroupKey === null) {
        throw new Error("Missing the required parameter 'insightGroupKey' when calling patchInsightGroup");
      }
      // verify the required parameter 'patchOperation' is set
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling patchInsightGroup");
      }
