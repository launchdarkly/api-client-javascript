...
export default class ScheduledChangesApi {
    ...
    /**
    * Constructs a new ScheduledChangesApi. 
    * @alias module:api/ScheduledChangesApi
    * @class
    ...
    */
     ...
     * @callback module:api/ScheduledChangesApi~deleteFlagConfigScheduledChangesCallback
     ...
     * @param {module:api/ScheduledChangesApi~deleteFlagConfigScheduledChangesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteFlagConfigScheduledChanges(projectKey, featureFlagKey, environmentKey, id, callback) {
      let postBody = null;
      ...
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteFlagConfigScheduledChanges");
      }
    ...
    /**
     * Callback function to receive the result of the getFeatureFlagScheduledChange operation.
     * @callback module:api/ScheduledChangesApi~getFeatureFlagScheduledChangeCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} environmentKey The environment key
     * @param {String} id The scheduled change id
     * @param {module:api/ScheduledChangesApi~getFeatureFlagScheduledChangeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagScheduledChange}
     */
    getFeatureFlagScheduledChange(projectKey, featureFlagKey, environmentKey, id, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getFeatureFlagScheduledChange");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling getFeatureFlagScheduledChange");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getFeatureFlagScheduledChange");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getFeatureFlagScheduledChange");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = FeatureFlagScheduledChange;
      return this.apiClient.callApi(
     ...
     * @callback module:api/ScheduledChangesApi~getFlagConfigScheduledChangesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} featureFlagKey The feature flag key
     * @param {String} environmentKey The environment key
     * @param {module:api/ScheduledChangesApi~getFlagConfigScheduledChangesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagScheduledChanges}
     */
    getFlagConfigScheduledChanges(projectKey, featureFlagKey, environmentKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = FeatureFlagScheduledChanges;
      return this.apiClient.callApi(
     ...
     * @callback module:api/ScheduledChangesApi~patchFlagConfigScheduledChangeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeatureFlagScheduledChange} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} environmentKey The environment key
     * @param {String} id The scheduled change ID
     * @param {module:model/FlagScheduledChangesInput} flagScheduledChangesInput 
     * @param {Object} opts Optional parameters
     * @param {Boolean} opts.ignoreConflicts Whether to succeed (`true`) or fail (`false`) when these new instructions conflict with existing scheduled changes
     * @param {module:api/ScheduledChangesApi~patchFlagConfigScheduledChangeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagScheduledChange}
     */
    patchFlagConfigScheduledChange(projectKey, featureFlagKey, environmentKey, id, flagScheduledChangesInput, opts, callback) {
      opts = opts || {};
      let postBody = flagScheduledChangesInput;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
      ...
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling patchFlagConfigScheduledChange");
      }
      // verify the required parameter 'flagScheduledChangesInput' is set
      if (flagScheduledChangesInput === undefined || flagScheduledChangesInput === null) {
        throw new Error("Missing the required parameter 'flagScheduledChangesInput' when calling patchFlagConfigScheduledChange");
      }
     ...
     * @callback module:api/ScheduledChangesApi~postFlagConfigScheduledChangesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeatureFlagScheduledChange} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} featureFlagKey The feature flag key
     * @param {String} environmentKey The environment key
     * @param {module:model/PostFlagScheduledChangesInput} postFlagScheduledChangesInput 
     * @param {Object} opts Optional parameters
     * @param {Boolean} opts.ignoreConflicts Whether to succeed (`true`) or fail (`false`) when these instructions conflict with existing scheduled changes
     * @param {module:api/ScheduledChangesApi~postFlagConfigScheduledChangesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagScheduledChange}
     */
    postFlagConfigScheduledChanges(projectKey, featureFlagKey, environmentKey, postFlagScheduledChangesInput, opts, callback) {
      opts = opts || {};
      let postBody = postFlagScheduledChangesInput;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
      ...
      // verify the required parameter 'postFlagScheduledChangesInput' is set
      if (postFlagScheduledChangesInput === undefined || postFlagScheduledChangesInput === null) {
        throw new Error("Missing the required parameter 'postFlagScheduledChangesInput' when calling postFlagConfigScheduledChanges");
      }
