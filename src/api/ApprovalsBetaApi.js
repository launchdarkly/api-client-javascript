...
export default class ApprovalsBetaApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getApprovalRequestSettings operation.
     * @callback module:api/ApprovalsBetaApi~getApprovalRequestSettingsCallback
     * @param {String} error Error message, if any.
     * @param {Object.<String, module:model/{String: ApprovalRequestSettingWithEnvs}>} data The data returned by the service call.
     ...
     * @param {String} [environmentKey] An environment key filter to apply to the approval request settings.
     * @param {String} [resourceKind] A resource kind filter to apply to the approval request settings.
     * @param {String} [expand] A comma-separated list of fields to expand in the response. Options include 'default' and 'strict'.
     * @param {module:api/ApprovalsBetaApi~getApprovalRequestSettingsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object.<String, module:model/{String: ApprovalRequestSettingWithEnvs}>}
     */
    getApprovalRequestSettings(lDAPIVersion, projectKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'lDAPIVersion' is set
      if (lDAPIVersion === undefined || lDAPIVersion === null) {
        throw new Error("Missing the required parameter 'lDAPIVersion' when calling getApprovalRequestSettings");
      }
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getApprovalRequestSettings");
      }
      ...
      let returnType = {'String': ApprovalRequestSettingWithEnvs};
      return this.apiClient.callApi(
        '/api/v2/approval-requests/projects/{projectKey}/settings', 'GET',
    ...
    /**
     * Callback function to receive the result of the patchApprovalRequest operation.
     * @callback module:api/ApprovalsBetaApi~patchApprovalRequestCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ApprovalsBetaApi~patchApprovalRequestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FlagConfigApprovalRequestResponse}
     */
    patchApprovalRequest(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling patchApprovalRequest");
      }
      ...
      return this.apiClient.callApi(
        '/api/v2/approval-requests/{id}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the patchApprovalRequestSettings operation.
     * @callback module:api/ApprovalsBetaApi~patchApprovalRequestSettingsCallback
     * @param {String} error Error message, if any.
     * @param {Object.<String, module:model/{String: ApprovalRequestSettingWithEnvs}>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} projectKey 
     * @param {Object} opts Optional parameters
     * @param {module:model/ApprovalRequestSettingsPatch} [approvalRequestSettingsPatch] Approval request settings to update
     * @param {module:api/ApprovalsBetaApi~patchApprovalRequestSettingsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object.<String, module:model/{String: ApprovalRequestSettingWithEnvs}>}
     */
    patchApprovalRequestSettings(lDAPIVersion, projectKey, opts, callback) {
      opts = opts || {};
      let postBody = opts['approvalRequestSettingsPatch'];
      // verify the required parameter 'lDAPIVersion' is set
      if (lDAPIVersion === undefined || lDAPIVersion === null) {
        throw new Error("Missing the required parameter 'lDAPIVersion' when calling patchApprovalRequestSettings");
      }
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling patchApprovalRequestSettings");
      }
      ...
      let returnType = {'String': ApprovalRequestSettingWithEnvs};
      return this.apiClient.callApi(
        '/api/v2/approval-requests/projects/{projectKey}/settings', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the patchFlagConfigApprovalRequest operation.
     * @callback module:api/ApprovalsBetaApi~patchFlagConfigApprovalRequestCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FlagConfigApprovalRequestResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id The approval ID
     * @param {module:api/ApprovalsBetaApi~patchFlagConfigApprovalRequestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FlagConfigApprovalRequestResponse}
     */
    patchFlagConfigApprovalRequest(projectKey, featureFlagKey, environmentKey, id, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling patchFlagConfigApprovalRequest");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling patchFlagConfigApprovalRequest");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling patchFlagConfigApprovalRequest");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling patchFlagConfigApprovalRequest");
      }
      ...
      let returnType = FlagConfigApprovalRequestResponse;
      return this.apiClient.callApi(
        '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{id}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
