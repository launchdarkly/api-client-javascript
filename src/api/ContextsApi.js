...
export default class ContextsApi {
    ...
    */
     ...
     * @param {Number} opts.limit Specifies the maximum number of items in the collection to return (max: 100, default: 100)
     ...
     * @param {Number} opts.limit Specifies the maximum number of items in the collection to return (max: 100, default: 50)
     ...
     * @param {String} opts.filter A comma-separated list of context filters. This endpoint only accepts an `applicationId` filter. To learn more about the filter syntax, read [Filtering contexts and context instances](https://launchdarkly.com/docs/ld-docs/api/contexts#filtering-contexts-and-context-instances).
     ...
     * @param {String} opts.continuationToken Limits results to contexts with sort values after the value specified. You can use this for pagination, however, we recommend using the `next` link we provide instead.
     * @param {String} opts.sort Specifies a field by which to sort. LaunchDarkly supports sorting by timestamp in ascending order by specifying `ts` for this value, or descending order by specifying `-ts`.
     * @param {String} opts.filter A comma-separated list of context filters. To learn more about the filter syntax, read [Filtering contexts and context instances](https://launchdarkly.com/docs/ld-docs/api/contexts#filtering-contexts-and-context-instances).
     * @param {Boolean} opts.includeTotalCount Specifies whether to include or omit the total count of matching contexts. Defaults to true.
