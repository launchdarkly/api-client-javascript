...
export default class DataExportDestinationsApi {
    ...
    */
     ...
     */
    deleteDestination(projKey, envKey, id, callback) {
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling deleteDestination");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling deleteDestination");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteDestination");
      }
     ...
     */
    getDestination(projKey, envKey, id, callback) {
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getDestination");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling getDestination");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getDestination");
      }
      ...
      return this.apiClient.callApi(
        '/api/v2/destinations/{projKey}/{envKey}/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * data is of type: {@link module:model/Destination}
     */
    patchDestination(projKey, envKey, id, patchOperation, callback) {
      let postBody = patchOperation;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling patchDestination");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling patchDestination");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling patchDestination");
      }
      // verify the required parameter 'patchOperation' is set
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling patchDestination");
      }
      ...
      let returnType = Destination;
      return this.apiClient.callApi(
        '/api/v2/destinations/{projKey}/{envKey}/{id}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @param {String} projKey The project key
     * @param {String} envKey The environment key
     * @param {module:model/DestinationPost} destinationPost 
     ...
     * data is of type: {@link module:model/Destination}
     */
    postDestination(projKey, envKey, destinationPost, callback) {
      let postBody = destinationPost;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling postDestination");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling postDestination");
      }
      // verify the required parameter 'destinationPost' is set
      if (destinationPost === undefined || destinationPost === null) {
        throw new Error("Missing the required parameter 'destinationPost' when calling postDestination");
      }
      ...
      let returnType = Destination;
      return this.apiClient.callApi(
        '/api/v2/destinations/{projKey}/{envKey}', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
