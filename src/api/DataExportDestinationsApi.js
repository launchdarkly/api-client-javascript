...
export default class DataExportDestinationsApi {
    ...
    */
     ...
     */
    deleteDestination(projectKey, environmentKey, id, callback) {
      let postBody = null;
     ...
     */
    getDestination(projectKey, environmentKey, id, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
     ...
     * data is of type: {@link module:model/Destination}
     */
    patchDestination(projectKey, environmentKey, id, patchOperation, callback) {
     ...
     * data is of type: {@link module:model/Destination}
     */
    postDestination(projectKey, environmentKey, destinationPost, callback) {
    ...
    /**
     * Callback function to receive the result of the postGenerateWarehouseDestinationKeyPair operation.
     * @callback module:api/DataExportDestinationsApi~postGenerateWarehouseDestinationKeyPairCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GenerateWarehouseDestinationKeyPairPostRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/DataExportDestinationsApi~postGenerateWarehouseDestinationKeyPairCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GenerateWarehouseDestinationKeyPairPostRep}
     */
    postGenerateWarehouseDestinationKeyPair(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GenerateWarehouseDestinationKeyPairPostRep;
      return this.apiClient.callApi(
        '/api/v2/destinations/generate-warehouse-destination-key-pair', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
