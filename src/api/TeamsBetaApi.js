...
export default class TeamsBetaApi {
    ...
    /**
    * Constructs a new TeamsBetaApi. 
    * @alias module:api/TeamsBetaApi
    * @class
    ...
    */
     ...
     * @callback module:api/TeamsBetaApi~deleteTeamCallback
     ...
     * @callback module:api/TeamsBetaApi~getTeamMaintainersCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TeamsBetaApi~getTeamMaintainersCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/TeamsBetaApi~getTeamRolesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} opts.offset Where to start in the list. This is for use with pagination. For example, an offset of 10 would skip the first ten items and then return the next `limit` items.
     * @param {module:api/TeamsBetaApi~getTeamRolesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/TeamsBetaApi~getTeamsCallback
     * @param {String} error Error message, if any.
     ...
     * data is of type: {@link module:model/Team}
     */
    patchTeam(teamKey, teamPatchInput, callback) {
     ...
     * @callback module:api/TeamsBetaApi~postTeamCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Team} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/Team}
     */
    postTeam(teamPostInput, callback) {
