...
export default class ApprovalsApi {
    ...
    */
     ...
     */
    deleteApprovalRequest(projectKey, featureFlagKey, environmentKey, id, callback) {
      let postBody = null;
     ...
     * data is of type: {@link module:model/FlagConfigApprovalRequestResponse}
     */
    postApprovalRequest(projectKey, featureFlagKey, environmentKey, createFlagConfigApprovalRequestRequest, callback) {
      ...
      if (createFlagConfigApprovalRequestRequest === undefined || createFlagConfigApprovalRequestRequest === null) {
        throw new Error("Missing the required parameter 'createFlagConfigApprovalRequestRequest' when calling postApprovalRequest");
      }
    ...
    /**
     * Callback function to receive the result of the postApprovalRequestApplyRequest operation.
     * @callback module:api/ApprovalsApi~postApprovalRequestApplyRequestCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FlagConfigApprovalRequestResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ApprovalsApi~postApprovalRequestApplyRequestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FlagConfigApprovalRequestResponse}
     */
    postApprovalRequestApplyRequest(projectKey, featureFlagKey, environmentKey, id, postApprovalRequestApplyRequest, callback) {
      let postBody = postApprovalRequestApplyRequest;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling postApprovalRequestApplyRequest");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling postApprovalRequestApplyRequest");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling postApprovalRequestApplyRequest");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling postApprovalRequestApplyRequest");
      }
      ...
      if (postApprovalRequestApplyRequest === undefined || postApprovalRequestApplyRequest === null) {
        throw new Error("Missing the required parameter 'postApprovalRequestApplyRequest' when calling postApprovalRequestApplyRequest");
      }
     ...
     * data is of type: {@link module:model/FlagConfigApprovalRequestResponse}
     */
    postApprovalRequestReview(projectKey, featureFlagKey, environmentKey, id, postApprovalRequestReviewRequest, callback) {
      let postBody = postApprovalRequestReviewRequest;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling postApprovalRequestReview");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling postApprovalRequestReview");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling postApprovalRequestReview");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
