...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UserRecord', 'model/Users'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/UserRecord'), require('../model/Users'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyApi) {
      root.LaunchDarklyApi = {};
    }
    root.LaunchDarklyApi.UsersApi = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.UserRecord, root.LaunchDarklyApi.Users);
  }
}(this, function(ApiClient, UserRecord, Users) {
  'use strict';
