...
export default class UsersApi {
    ...
    */
     ...
     */
    deleteUser(projectKey, environmentKey, userKey, callback) {
      let postBody = null;
     ...
     * @param {Number} opts.offset Deprecated, use `searchAfter` instead. Specifies the first item to return in the collection.
     ...
     */
    getSearchUsers(projectKey, environmentKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
     ...
     */
    getUser(projectKey, environmentKey, userKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
