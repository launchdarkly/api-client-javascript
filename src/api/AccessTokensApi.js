...
export default class AccessTokensApi {
    ...
    */
     ...
     * @param {Number} opts.limit The number of access tokens to return in the response. Defaults to 25.
     ...
     * data is of type: {@link module:model/Token}
     */
    patchToken(id, patchOperation, callback) {
      ...
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling patchToken");
      }
     ...
     * @param {module:model/AccessTokenPost} accessTokenPost 
     ...
     * data is of type: {@link module:model/Token}
     */
    postToken(accessTokenPost, callback) {
      let postBody = accessTokenPost;
      // verify the required parameter 'accessTokenPost' is set
      if (accessTokenPost === undefined || accessTokenPost === null) {
        throw new Error("Missing the required parameter 'accessTokenPost' when calling postToken");
      }
     ...
     * data is of type: {@link module:model/Token}
     */
    resetToken(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling resetToken");
      }
