...
* @module api/OAuth2ClientsApi
* @version 17.0.0
*/
export default class OAuth2ClientsApi {

    /**
    * Constructs a new OAuth2ClientsApi. 
    * @alias module:api/OAuth2ClientsApi
    * @class
    ...
    */
     ...
     * @callback module:api/OAuth2ClientsApi~createOAuth2ClientCallback
     ...
     * @param {module:model/OauthClientPost} oauthClientPost 
     * @param {module:api/OAuth2ClientsApi~createOAuth2ClientCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Client}
     */
    createOAuth2Client(oauthClientPost, callback) {
      let postBody = oauthClientPost;
      // verify the required parameter 'oauthClientPost' is set
      if (oauthClientPost === undefined || oauthClientPost === null) {
        throw new Error("Missing the required parameter 'oauthClientPost' when calling createOAuth2Client");
      }
     ...
     * @callback module:api/OAuth2ClientsApi~deleteOAuthClientCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/OAuth2ClientsApi~deleteOAuthClientCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteOAuthClient(clientId, callback) {
      let postBody = null;
      // verify the required parameter 'clientId' is set
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling deleteOAuthClient");
      }
     ...
     * @callback module:api/OAuth2ClientsApi~getOAuthClientByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Client} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} clientId The client ID
     * @param {module:api/OAuth2ClientsApi~getOAuthClientByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Client}
     */
    getOAuthClientById(clientId, callback) {
      let postBody = null;
      // verify the required parameter 'clientId' is set
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling getOAuthClientById");
      }
     ...
     * @callback module:api/OAuth2ClientsApi~getOAuthClientsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/OAuth2ClientsApi~getOAuthClientsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ClientCollection}
     */
    getOAuthClients(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ClientCollection;
      return this.apiClient.callApi(
     ...
     * @callback module:api/OAuth2ClientsApi~patchOAuthClientCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Client} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/OAuth2ClientsApi~patchOAuthClientCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Client}
     */
    patchOAuthClient(clientId, patchOperation, callback) {
      let postBody = patchOperation;
      // verify the required parameter 'clientId' is set
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling patchOAuthClient");
      }
      // verify the required parameter 'patchOperation' is set
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling patchOAuthClient");
      }
