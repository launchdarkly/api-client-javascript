...
export default class AccountUsageBetaApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getContextsClientsideUsage operation.
     * @callback module:api/AccountUsageBetaApi~getContextsClientsideUsageCallback
     ...
     * @param {String} [contextKind] A context kind to filter results by. Can be specified multiple times, one query parameter per context kind.
     ...
     * @param {module:api/AccountUsageBetaApi~getContextsClientsideUsageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SeriesListRep}
     */
    getContextsClientsideUsage(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/api/v2/usage/clientside-contexts', 'GET',
    ...
    /**
     * Callback function to receive the result of the getContextsServersideUsage operation.
     * @callback module:api/AccountUsageBetaApi~getContextsServersideUsageCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SeriesListRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [aggregationType] Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`, `rolling_30d`.
     * @param {String} [granularity] Specifies the data granularity. Defaults to `daily`. Valid values depend on `aggregationType`: **month_to_date** supports `daily` and `monthly`; **incremental** and **rolling_30d** support `daily` only.
     * @param {module:api/AccountUsageBetaApi~getContextsServersideUsageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SeriesListRep}
     */
    getContextsServersideUsage(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = SeriesListRep;
      return this.apiClient.callApi(
        '/api/v2/usage/serverside-contexts', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getContextsTotalUsage operation.
     * @callback module:api/AccountUsageBetaApi~getContextsTotalUsageCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SeriesListRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [aggregationType] Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`, `rolling_30d`.
     * @param {String} [granularity] Specifies the data granularity. Defaults to `daily`. Valid values depend on `aggregationType`: **month_to_date** supports `daily` and `monthly`; **incremental** and **rolling_30d** support `daily` only.
     * @param {module:api/AccountUsageBetaApi~getContextsTotalUsageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SeriesListRep}
     */
    getContextsTotalUsage(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = SeriesListRep;
      return this.apiClient.callApi(
        '/api/v2/usage/total-contexts', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @param {String} [projectKey] A project key to filter results by. Can be specified multiple times, one query parameter per project key.
     * @param {String} [environmentKey] An environment key to filter results by. If specified, exactly one `projectKey` must be provided. Can be specified multiple times, one query parameter per environment key.
     * @param {String} [eventKind] An event kind to filter results by. Can be specified multiple times, one query parameter per event kind.
     * @param {String} [groupBy] If specified, returns data for each distinct value of the given field. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension.<br/>Valid values: `environmentId`, `eventKind`.
     * @param {String} [aggregationType] Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`.
     * @param {String} [granularity] Specifies the data granularity. Defaults to `daily`. `monthly` granularity is only supported with the **month_to_date** aggregation type.<br/>Valid values: `daily`, `hourly`, `monthly`.
     ...
     * data is of type: {@link module:model/SeriesListRep}
     */
    getEvaluationsUsage(projectKey, environmentKey, featureFlagKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getEvaluationsUsage");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getEvaluationsUsage");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling getEvaluationsUsage");
      }
    ...
    /**
     * Callback function to receive the result of the getExperimentationEventsUsage operation.
     * @callback module:api/AccountUsageBetaApi~getExperimentationEventsUsageCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SeriesListRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [projectKey] A project key to filter results by. Can be specified multiple times, one query parameter per project key.
     * @param {String} [environmentKey] An environment key to filter results by. If specified, exactly one `projectKey` must be provided. Can be specified multiple times, one query parameter per environment key.
     * @param {String} [eventKey] An event key to filter results by. Can be specified multiple times, one query parameter per event key.
     * @param {String} [eventKind] An event kind to filter results by. Can be specified multiple times, one query parameter per event kind.
     * @param {String} [groupBy] If specified, returns data for each distinct value of the given field. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension.<br/>Valid values: `environmentId`, `eventKey`, `eventKind`.
     * @param {String} [aggregationType] Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`.
     * @param {String} [granularity] Specifies the data granularity. Defaults to `daily`. `monthly` granularity is only supported with the **month_to_date** aggregation type.<br/>Valid values: `daily`, `hourly`, `monthly`.
     * @param {module:api/AccountUsageBetaApi~getExperimentationEventsUsageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SeriesListRep}
     */
    getExperimentationEventsUsage(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = SeriesListRep;
      return this.apiClient.callApi(
        '/api/v2/usage/experimentation-events', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getExperimentationKeysUsage operation.
     * @callback module:api/AccountUsageBetaApi~getExperimentationKeysUsageCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SeriesListRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [projectKey] A project key to filter results by. Can be specified multiple times, one query parameter per project key.
     * @param {String} [environmentKey] An environment key to filter results by. If specified, exactly one `projectKey` must be provided. Can be specified multiple times, one query parameter per environment key.
     * @param {String} [experimentId] An experiment ID to filter results by. Can be specified multiple times, one query parameter per experiment ID.
     * @param {String} [groupBy] If specified, returns data for each distinct value of the given field. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension.<br/>Valid values: `projectId`, `environmentId`, `experimentId`.
     * @param {String} [aggregationType] Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`.
     * @param {String} [granularity] Specifies the data granularity. Defaults to `daily`. `monthly` granularity is only supported with the **month_to_date** aggregation type.<br/>Valid values: `daily`, `hourly`, `monthly`.
     * @param {module:api/AccountUsageBetaApi~getExperimentationKeysUsageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SeriesListRep}
     */
    getExperimentationKeysUsage(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getObservabilityErrorsUsage operation.
     * @callback module:api/AccountUsageBetaApi~getObservabilityErrorsUsageCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SeriesListRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [granularity] Specifies the data granularity. Defaults to `daily`. Valid values depend on `aggregationType`: **month_to_date** supports `daily` and `monthly`; **incremental** and **rolling_30d** support `daily` only.
     * @param {String} [aggregationType] Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`, `rolling_30d`.
     * @param {module:api/AccountUsageBetaApi~getObservabilityErrorsUsageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SeriesListRep}
     */
    getObservabilityErrorsUsage(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = SeriesListRep;
      return this.apiClient.callApi(
        '/api/v2/usage/observability/errors', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getObservabilityLogsUsage operation.
     * @callback module:api/AccountUsageBetaApi~getObservabilityLogsUsageCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SeriesListRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [granularity] Specifies the data granularity. Defaults to `daily`. Valid values depend on `aggregationType`: **month_to_date** supports `daily` and `monthly`; **incremental** and **rolling_30d** support `daily` only.
     * @param {String} [aggregationType] Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`, `rolling_30d`.
     * @param {module:api/AccountUsageBetaApi~getObservabilityLogsUsageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SeriesListRep}
     */
    getObservabilityLogsUsage(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = SeriesListRep;
      return this.apiClient.callApi(
        '/api/v2/usage/observability/logs', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getObservabilitySessionsUsage operation.
     * @callback module:api/AccountUsageBetaApi~getObservabilitySessionsUsageCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SeriesListRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [granularity] Specifies the data granularity. Defaults to `daily`. Valid values depend on `aggregationType`: **month_to_date** supports `daily` and `monthly`; **incremental** and **rolling_30d** support `daily` only.
     * @param {String} [aggregationType] Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`, `rolling_30d`.
     * @param {module:api/AccountUsageBetaApi~getObservabilitySessionsUsageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SeriesListRep}
     */
    getObservabilitySessionsUsage(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = SeriesListRep;
      return this.apiClient.callApi(
        '/api/v2/usage/observability/sessions', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getObservabilityTracesUsage operation.
     * @callback module:api/AccountUsageBetaApi~getObservabilityTracesUsageCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SeriesListRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [granularity] Specifies the data granularity. Defaults to `daily`. Valid values depend on `aggregationType`: **month_to_date** supports `daily` and `monthly`; **incremental** and **rolling_30d** support `daily` only.
     * @param {String} [aggregationType] Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`, `rolling_30d`.
     * @param {module:api/AccountUsageBetaApi~getObservabilityTracesUsageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SeriesListRep}
     */
    getObservabilityTracesUsage(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = SeriesListRep;
      return this.apiClient.callApi(
        '/api/v2/usage/observability/traces', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getServiceConnectionsUsage operation.
     * @callback module:api/AccountUsageBetaApi~getServiceConnectionsUsageCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SeriesListRepFloat} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [projectKey] A project key to filter results by. Can be specified multiple times, one query parameter per project key.
     * @param {String} [environmentKey] An environment key to filter results by. If specified, exactly one `projectKey` must be provided. Can be specified multiple times, one query parameter per environment key.
     * @param {String} [connectionType] A connection type to filter results by. Can be specified multiple times, one query parameter per connection type.
     * @param {String} [relayVersion] A relay version to filter results by. Can be specified multiple times, one query parameter per relay version.
     * @param {String} [sdkName] An SDK name to filter results by. Can be specified multiple times, one query parameter per SDK name.
     * @param {String} [sdkVersion] An SDK version to filter results by. Can be specified multiple times, one query parameter per SDK version.
     * @param {String} [sdkType] An SDK type to filter results by. Can be specified multiple times, one query parameter per SDK type.
     * @param {String} [groupBy] If specified, returns data for each distinct value of the given field. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension.<br/>Valid values: `projectId`, `environmentId`, `connectionType`, `relayVersion`, `sdkName`, `sdkVersion`, `sdkType`.
     * @param {String} [aggregationType] Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`.
     * @param {String} [granularity] Specifies the data granularity. Defaults to `daily`. `monthly` granularity is only supported with the **month_to_date** aggregation type.<br/>Valid values: `daily`, `hourly`, `monthly`.
     * @param {module:api/AccountUsageBetaApi~getServiceConnectionsUsageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SeriesListRepFloat}
     */
    getServiceConnectionsUsage(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'relayVersion': opts['relayVersion'],
        'sdkName': opts['sdkName'],
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = SeriesListRepFloat;
      return this.apiClient.callApi(
