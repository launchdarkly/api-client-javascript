...
export default class EnvironmentsApi {
    ...
    */
     ...
     */
    deleteEnvironment(projectKey, environmentKey, callback) {
      let postBody = null;
     ...
     */
    getEnvironment(projectKey, environmentKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
    ...
    /**
     * Callback function to receive the result of the getEnvironmentsByProject operation.
     * @callback module:api/EnvironmentsApi~getEnvironmentsByProjectCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} opts.limit The number of environments to return in the response. Defaults to 20.
     ...
     * @param {module:api/EnvironmentsApi~getEnvironmentsByProjectCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Environments}
     */
    getEnvironmentsByProject(projectKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getEnvironmentsByProject");
      }
     ...
     * data is of type: {@link module:model/Environment}
     */
    patchEnvironment(projectKey, environmentKey, patchOperation, callback) {
      ...
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling patchEnvironment");
      }
     ...
     * data is of type: {@link module:model/Environment}
     */
    postEnvironment(projectKey, environmentPost, callback) {
      let postBody = environmentPost;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
      ...
      if (environmentPost === undefined || environmentPost === null) {
        throw new Error("Missing the required parameter 'environmentPost' when calling postEnvironment");
      }
     ...
     * data is of type: {@link module:model/Environment}
     */
    resetEnvironmentMobileKey(projectKey, environmentKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
     ...
     * @param {String} environmentKey The environment key
     * @param {Object} opts Optional parameters
     * @param {Number} opts.expiry The time at which you want the old SDK key to expire, in UNIX milliseconds. By default, the key expires immediately. During the period between this call and the time when the old SDK key expires, both the old SDK key and the new SDK key will work.
     ...
     * data is of type: {@link module:model/Environment}
     */
    resetEnvironmentSDKKey(projectKey, environmentKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
