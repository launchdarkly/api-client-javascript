...
export default class EnvironmentsApi {
    ...
    */
     ...
     * data is of type: {@link module:model/Environment}
     */
    resetEnvironmentMobileKey(projectKey, envKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
      ...
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling resetEnvironmentMobileKey");
      }
      ...
      let returnType = Environment;
      return this.apiClient.callApi(
        '/api/v2/projects/{projectKey}/environments/{envKey}/mobileKey', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * data is of type: {@link module:model/Environment}
     */
    resetEnvironmentSDKKey(projectKey, envKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
      ...
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling resetEnvironmentSDKKey");
      }
      ...
      let returnType = Environment;
      return this.apiClient.callApi(
        '/api/v2/projects/{projectKey}/environments/{envKey}/apiKey', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
