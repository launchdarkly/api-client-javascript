...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Environment', 'model/EnvironmentBody', 'model/PatchDelta'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Environment'), require('../model/EnvironmentBody'), require('../model/PatchDelta'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyRestApi) {
      root.LaunchDarklyRestApi = {};
    }
    root.LaunchDarklyRestApi.EnvironmentsApi = factory(root.LaunchDarklyRestApi.ApiClient, root.LaunchDarklyRestApi.Environment, root.LaunchDarklyRestApi.EnvironmentBody, root.LaunchDarklyRestApi.PatchDelta);
  }
}(this, function(ApiClient, Environment, EnvironmentBody, PatchDelta) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.deleteEnvironment = function(projectKey, environmentKey, callback) {
      ...
      return this.apiClient.callApi(
        '/environments/{projectKey}/{environmentKey}', 'DELETE',
    ...
    this.getEnvironment = function(projectKey, environmentKey, callback) {
      ...
      return this.apiClient.callApi(
        '/environments/{projectKey}/{environmentKey}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.patchEnvironment = function(projectKey, environmentKey, patchDelta, callback) {
      ...
      return this.apiClient.callApi(
        '/environments/{projectKey}/{environmentKey}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
