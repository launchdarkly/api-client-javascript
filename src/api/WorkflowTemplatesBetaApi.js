...
/**
* WorkflowTemplatesBeta service.
* @module api/WorkflowTemplatesBetaApi
* @version 12.1.0
*/
export default class WorkflowTemplatesBetaApi {

    /**
    * Constructs a new WorkflowTemplatesBetaApi. 
    * @alias module:api/WorkflowTemplatesBetaApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createWorkflowTemplate operation.
     * @callback module:api/WorkflowTemplatesBetaApi~createWorkflowTemplateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/WorkflowTemplateOutput} data The data returned by the service call.
     ...
     * @param {module:model/CreateWorkflowTemplateInput} createWorkflowTemplateInput 
     * @param {module:api/WorkflowTemplatesBetaApi~createWorkflowTemplateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/WorkflowTemplateOutput}
     */
    createWorkflowTemplate(createWorkflowTemplateInput, callback) {
      let postBody = createWorkflowTemplateInput;
      // verify the required parameter 'createWorkflowTemplateInput' is set
      if (createWorkflowTemplateInput === undefined || createWorkflowTemplateInput === null) {
        throw new Error("Missing the required parameter 'createWorkflowTemplateInput' when calling createWorkflowTemplate");
      }
      ...
      let returnType = WorkflowTemplateOutput;
    ...
    /**
     * Callback function to receive the result of the deleteWorkflowTemplate operation.
     * @callback module:api/WorkflowTemplatesBetaApi~deleteWorkflowTemplateCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/WorkflowTemplatesBetaApi~deleteWorkflowTemplateCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteWorkflowTemplate(templateKey, callback) {
      let postBody = null;
      // verify the required parameter 'templateKey' is set
      if (templateKey === undefined || templateKey === null) {
        throw new Error("Missing the required parameter 'templateKey' when calling deleteWorkflowTemplate");
      }
    ...
    /**
     * Callback function to receive the result of the getWorkflowTemplates operation.
     * @callback module:api/WorkflowTemplatesBetaApi~getWorkflowTemplatesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/WorkflowTemplatesListingOutputRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Boolean} opts.summary Whether the entire template object or just a summary should be returned
     * @param {String} opts.search The substring in either the name or description of a template
     * @param {module:api/WorkflowTemplatesBetaApi~getWorkflowTemplatesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/WorkflowTemplatesListingOutputRep}
     */
    getWorkflowTemplates(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = WorkflowTemplatesListingOutputRep;
      return this.apiClient.callApi(
