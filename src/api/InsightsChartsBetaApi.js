...
export default class InsightsChartsBetaApi {
    ...
    /**
    * Constructs a new InsightsChartsBetaApi. 
    * @alias module:api/InsightsChartsBetaApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getDeploymentFrequencyChart operation.
     * @callback module:api/InsightsChartsBetaApi~getDeploymentFrequencyChartCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InsightsChart} data The data returned by the service call.
     ...
     * @param {String} opts.projectKey The project key
     * @param {String} opts.environmentKey The environment key
     ...
     * @param {Date} opts.to Unix timestamp in milliseconds. Default value is now.
     * @param {String} opts.bucketType Specify type of bucket. Options: `rolling`, `hour`, `day`. Default: `rolling`.
     * @param {Number} opts.bucketMs Duration of intervals for x-axis in milliseconds. Default value is one day (`86400000` milliseconds).
     * @param {String} opts.groupBy Options: `application`, `kind`
     * @param {String} opts.expand Options: `metrics`
     * @param {module:api/InsightsChartsBetaApi~getDeploymentFrequencyChartCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InsightsChart}
     */
    getDeploymentFrequencyChart(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getFlagStatusChart operation.
     * @callback module:api/InsightsChartsBetaApi~getFlagStatusChartCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InsightsChart} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.applicationKey Comma separated list of application keys
     * @param {module:api/InsightsChartsBetaApi~getFlagStatusChartCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InsightsChart}
     */
    getFlagStatusChart(projectKey, environmentKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getFlagStatusChart");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getFlagStatusChart");
      }
    ...
    /**
     * Callback function to receive the result of the getLeadTimeChart operation.
     * @callback module:api/InsightsChartsBetaApi~getLeadTimeChartCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InsightsChart} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.environmentKey The environment key
     * @param {String} opts.applicationKey Comma separated list of application keys
     * @param {Number} opts.from Unix timestamp in milliseconds. Default value is 7 days ago.
     * @param {Number} opts.to Unix timestamp in milliseconds. Default value is now.
     * @param {String} opts.bucketType Specify type of bucket. Options: `rolling`, `hour`, `day`. Default: `rolling`.
     * @param {Number} opts.bucketMs Duration of intervals for x-axis in milliseconds. Default value is one day (`86400000` milliseconds).
     * @param {String} opts.groupBy Options: `application`, `stage`. Default: `stage`.
     * @param {String} opts.expand Options: `metrics`, `percentiles`.
     * @param {module:api/InsightsChartsBetaApi~getLeadTimeChartCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InsightsChart}
     */
    getLeadTimeChart(projectKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getLeadTimeChart");
      }
    ...
    /**
     * Callback function to receive the result of the getReleaseFrequencyChart operation.
     * @callback module:api/InsightsChartsBetaApi~getReleaseFrequencyChartCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InsightsChart} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.bucketMs Duration of intervals for x-axis in milliseconds. Default value is one day (`86400000` milliseconds).
     * @param {String} opts.expand Options: `metrics`
     * @param {module:api/InsightsChartsBetaApi~getReleaseFrequencyChartCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InsightsChart}
     */
    getReleaseFrequencyChart(projectKey, environmentKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getReleaseFrequencyChart");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getReleaseFrequencyChart");
      }
    ...
    /**
     * Callback function to receive the result of the getStaleFlagsChart operation.
     * @callback module:api/InsightsChartsBetaApi~getStaleFlagsChartCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InsightsChart} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.applicationKey Comma separated list of application keys
     * @param {String} opts.groupBy Property to group results by. Options: `maintainer`
     * @param {String} opts.maintainerId Comma-separated list of individual maintainers to filter results.
     * @param {String} opts.maintainerTeamKey Comma-separated list of team maintainer keys to filter results.
     * @param {String} opts.expand Options: `metrics`
     * @param {module:api/InsightsChartsBetaApi~getStaleFlagsChartCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InsightsChart}
     */
    getStaleFlagsChart(projectKey, environmentKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getStaleFlagsChart");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getStaleFlagsChart");
      }
      ...
      let queryParams = {
        ...
        'maintainerTeamKey': opts['maintainerTeamKey'],
        'expand': opts['expand']
      };
      let headerParams = {
      };
