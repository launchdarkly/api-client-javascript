...
export default class LayersApi {
    ...
    */
     ...
     * @callback module:api/LayersApi~createLayerCallback
     ...
     * @param {module:api/LayersApi~createLayerCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/LayersApi~updateLayerCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LayerRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/LayersApi~updateLayerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LayerRep}
     */
