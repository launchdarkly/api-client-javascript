...
export default class CodeReferencesApi {
    ...
    */
     ...
     */
    getStatistics(projKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getStatistics");
      }
      ...
      return this.apiClient.callApi(
        '/api/v2/code-refs/statistics/{projKey}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
