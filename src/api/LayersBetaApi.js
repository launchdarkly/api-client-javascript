...
/**
* LayersBeta service.
* @module api/LayersBetaApi
* @version 17.0.0
*/
export default class LayersBetaApi {

    /**
    * Constructs a new LayersBetaApi. 
    * @alias module:api/LayersBetaApi
    * @class
    ...
    */
     ...
     * @callback module:api/LayersBetaApi~createLayerCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LayerRep} data The data returned by the service call.
     ...
     * @param {module:model/LayerPost} layerPost 
     * @param {module:api/LayersBetaApi~createLayerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LayerRep}
     */
    createLayer(projectKey, layerPost, callback) {
      let postBody = layerPost;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling createLayer");
      }
      // verify the required parameter 'layerPost' is set
      if (layerPost === undefined || layerPost === null) {
        throw new Error("Missing the required parameter 'layerPost' when calling createLayer");
      }
      ...
      let returnType = LayerRep;
      return this.apiClient.callApi(
        '/api/v2/projects/{projectKey}/layers', 'POST',
     ...
     * @callback module:api/LayersBetaApi~getLayersCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LayerCollectionRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.filter A comma-separated list of filters. This endpoint only accepts filtering by `experimentKey`. The filter returns layers which include that experiment for the selected environment(s). For example: `filter=reservations.experimentKey contains expKey`.
     * @param {module:api/LayersBetaApi~getLayersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LayerCollectionRep}
     */
    getLayers(projectKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getLayers");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = LayerCollectionRep;
      return this.apiClient.callApi(
        '/api/v2/projects/{projectKey}/layers', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateLayer operation.
     * @callback module:api/LayersBetaApi~updateLayerCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LayerRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/LayerPatchInput} layerPatchInput 
     * @param {module:api/LayersBetaApi~updateLayerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LayerRep}
     */
    updateLayer(projectKey, layerKey, layerPatchInput, callback) {
      let postBody = layerPatchInput;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling updateLayer");
      }
      // verify the required parameter 'layerKey' is set
      if (layerKey === undefined || layerKey === null) {
        throw new Error("Missing the required parameter 'layerKey' when calling updateLayer");
      }
      // verify the required parameter 'layerPatchInput' is set
      if (layerPatchInput === undefined || layerPatchInput === null) {
        throw new Error("Missing the required parameter 'layerPatchInput' when calling updateLayer");
      }
      ...
      let returnType = LayerRep;
      return this.apiClient.callApi(
        '/api/v2/projects/{projectKey}/layers/{layerKey}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
