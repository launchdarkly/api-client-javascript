...
export default class WorkflowsApi {
    ...
    */
     ...
     */
    deleteWorkflow(projectKey, featureFlagKey, environmentKey, workflowId, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling deleteWorkflow");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling deleteWorkflow");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling deleteWorkflow");
      }
    ...
    /**
     * Callback function to receive the result of the getCustomWorkflow operation.
     * @callback module:api/WorkflowsApi~getCustomWorkflowCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CustomWorkflowOutput} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} environmentKey The environment key
     * @param {String} workflowId The workflow ID
     * @param {module:api/WorkflowsApi~getCustomWorkflowCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CustomWorkflowOutput}
     */
    getCustomWorkflow(projectKey, featureFlagKey, environmentKey, workflowId, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getCustomWorkflow");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling getCustomWorkflow");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getCustomWorkflow");
      }
      // verify the required parameter 'workflowId' is set
      if (workflowId === undefined || workflowId === null) {
        throw new Error("Missing the required parameter 'workflowId' when calling getCustomWorkflow");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = CustomWorkflowOutput;
      return this.apiClient.callApi(
     ...
     * @callback module:api/WorkflowsApi~getWorkflowsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CustomWorkflowsListingOutput} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.status Filter results by workflow status. Valid status filters are `active`, `completed`, and `failed`.
     * @param {String} opts.sort A field to sort the items by. Prefix field by a dash ( - ) to sort in descending order. This endpoint supports sorting by `creationDate` or `stopDate`.
     * @param {Number} opts.limit The maximum number of workflows to return. Defaults to 20.
     ...
     * @param {module:api/WorkflowsApi~getWorkflowsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CustomWorkflowsListingOutput}
     */
    getWorkflows(projectKey, featureFlagKey, environmentKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getWorkflows");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling getWorkflows");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getWorkflows");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = CustomWorkflowsListingOutput;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the postWorkflow operation.
     * @callback module:api/WorkflowsApi~postWorkflowCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CustomWorkflowOutput} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} featureFlagKey The feature flag key
     * @param {String} environmentKey The environment key
     * @param {module:model/CustomWorkflowInput} customWorkflowInput 
     * @param {Object} opts Optional parameters
     * @param {String} opts.templateKey The template key to apply as a starting point for the new workflow
     * @param {Boolean} opts.dryRun Whether to call the endpoint in dry-run mode
     * @param {module:api/WorkflowsApi~postWorkflowCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CustomWorkflowOutput}
     */
    postWorkflow(projectKey, featureFlagKey, environmentKey, customWorkflowInput, opts, callback) {
      opts = opts || {};
      let postBody = customWorkflowInput;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling postWorkflow");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling postWorkflow");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling postWorkflow");
      }
      // verify the required parameter 'customWorkflowInput' is set
      if (customWorkflowInput === undefined || customWorkflowInput === null) {
        throw new Error("Missing the required parameter 'customWorkflowInput' when calling postWorkflow");
      }
