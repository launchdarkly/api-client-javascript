...
export default class WorkflowsBetaApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/CustomWorkflowOutputRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/CustomWorkflowOutputRep}
     */
    getCustomWorkflow(projectKey, featureFlagKey, environmentKey, workflowId, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = CustomWorkflowOutputRep;
      return this.apiClient.callApi(
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/CustomWorkflowsListingOutputRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/CustomWorkflowsListingOutputRep}
     */
    getWorkflows(projectKey, featureFlagKey, environmentKey, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = CustomWorkflowsListingOutputRep;
      return this.apiClient.callApi(
     ...
     * @param {String} featureFlagKey The feature flag key
     * @param {String} environmentKey The environment key
     * @param {module:model/CustomWorkflowInputRep} customWorkflowInputRep 
     ...
     * data is of type: {@link module:model/CustomWorkflowOutputRep}
     */
    postWorkflow(projectKey, featureFlagKey, environmentKey, customWorkflowInputRep, callback) {
      let postBody = customWorkflowInputRep;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
      ...
      // verify the required parameter 'customWorkflowInputRep' is set
      if (customWorkflowInputRep === undefined || customWorkflowInputRep === null) {
        throw new Error("Missing the required parameter 'customWorkflowInputRep' when calling postWorkflow");
      }
