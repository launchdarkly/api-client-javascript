...
export default class UserSettingsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getExpiringFlagsForUser operation.
     * @callback module:api/UserSettingsApi~getExpiringFlagsForUserCallback
     ...
     * @param {module:api/UserSettingsApi~getExpiringFlagsForUserCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ExpiringUserTargetGetResponse}
     */
    getExpiringFlagsForUser(projKey, userKey, envKey, callback) {
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getExpiringFlagsForUser");
      }
      // verify the required parameter 'userKey' is set
      if (userKey === undefined || userKey === null) {
        throw new Error("Missing the required parameter 'userKey' when calling getExpiringFlagsForUser");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling getExpiringFlagsForUser");
      }
      ...
      return this.apiClient.callApi(
        '/api/v2/users/{projKey}/{userKey}/expiring-user-targets/{envKey}', 'GET',
     ...
     */
    getUserFlagSetting(projKey, envKey, key, featureKey, callback) {
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getUserFlagSetting");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling getUserFlagSetting");
      }
      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling getUserFlagSetting");
      }
      // verify the required parameter 'featureKey' is set
      if (featureKey === undefined || featureKey === null) {
        throw new Error("Missing the required parameter 'featureKey' when calling getUserFlagSetting");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = UserFlagSetting;
      return this.apiClient.callApi(
        '/api/v2/users/{projKey}/{envKey}/{key}/flags/{featureKey}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     */
    getUserFlagSettings(projKey, envKey, key, callback) {
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getUserFlagSettings");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling getUserFlagSettings");
      }
      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling getUserFlagSettings");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = UserFlagSettings;
      return this.apiClient.callApi(
        '/api/v2/users/{projKey}/{envKey}/{key}/flags', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the patchExpiringFlagsForUser operation.
     * @callback module:api/UserSettingsApi~patchExpiringFlagsForUserCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UserSettingsApi~patchExpiringFlagsForUserCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ExpiringUserTargetPatchResponse}
     */
    patchExpiringFlagsForUser(projKey, userKey, envKey, patchWithComment, callback) {
      let postBody = patchWithComment;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling patchExpiringFlagsForUser");
      }
      // verify the required parameter 'userKey' is set
      if (userKey === undefined || userKey === null) {
        throw new Error("Missing the required parameter 'userKey' when calling patchExpiringFlagsForUser");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling patchExpiringFlagsForUser");
      }
      // verify the required parameter 'patchWithComment' is set
      if (patchWithComment === undefined || patchWithComment === null) {
        throw new Error("Missing the required parameter 'patchWithComment' when calling patchExpiringFlagsForUser");
      }
      ...
      return this.apiClient.callApi(
        '/api/v2/users/{projKey}/{userKey}/expiring-user-targets/{envKey}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     */
    putFlagSetting(projKey, envKey, key, featureKey, valuePut, callback) {
      let postBody = valuePut;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling putFlagSetting");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling putFlagSetting");
      }
      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling putFlagSetting");
      }
      // verify the required parameter 'featureKey' is set
      if (featureKey === undefined || featureKey === null) {
        throw new Error("Missing the required parameter 'featureKey' when calling putFlagSetting");
      }
      // verify the required parameter 'valuePut' is set
      if (valuePut === undefined || valuePut === null) {
        throw new Error("Missing the required parameter 'valuePut' when calling putFlagSetting");
      }
