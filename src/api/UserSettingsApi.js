...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PatchComment', 'model/UserFlagSetting', 'model/UserFlagSettings', 'model/UserSettingsBody', 'model/UserTargetingExpirationOnFlagsForUser'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PatchComment'), require('../model/UserFlagSetting'), require('../model/UserFlagSettings'), require('../model/UserSettingsBody'), require('../model/UserTargetingExpirationOnFlagsForUser'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyApi) {
      root.LaunchDarklyApi = {};
    }
    root.LaunchDarklyApi.UserSettingsApi = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.PatchComment, root.LaunchDarklyApi.UserFlagSetting, root.LaunchDarklyApi.UserFlagSettings, root.LaunchDarklyApi.UserSettingsBody, root.LaunchDarklyApi.UserTargetingExpirationOnFlagsForUser);
  }
}(this, function(ApiClient, PatchComment, UserFlagSetting, UserFlagSettings, UserSettingsBody, UserTargetingExpirationOnFlagsForUser) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * data is of type: {@link module:model/UserTargetingExpirationOnFlagsForUser}
     */
    this.patchExpiringUserTargetsForFlags = function(projectKey, environmentKey, userKey, patchComment, callback) {
      ...
      if (patchComment === undefined || patchComment === null) {
        throw new Error("Missing the required parameter 'patchComment' when calling patchExpiringUserTargetsForFlags");
      }
