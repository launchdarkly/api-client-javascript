...
export default class InsightsDeploymentsBetaApi {
    ...
    /**
    * Constructs a new InsightsDeploymentsBetaApi. 
    * @alias module:api/InsightsDeploymentsBetaApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createDeploymentEvent operation.
     * @callback module:api/InsightsDeploymentsBetaApi~createDeploymentEventCallback
     ...
     * Create deployment event
     * @param {module:model/PostDeploymentEventInput} postDeploymentEventInput 
     * @param {module:api/InsightsDeploymentsBetaApi~createDeploymentEventCallback} callback The callback function, accepting three arguments: error, data, response
     */
    createDeploymentEvent(postDeploymentEventInput, callback) {
      let postBody = postDeploymentEventInput;
      // verify the required parameter 'postDeploymentEventInput' is set
      if (postDeploymentEventInput === undefined || postDeploymentEventInput === null) {
        throw new Error("Missing the required parameter 'postDeploymentEventInput' when calling createDeploymentEvent");
      }
     ...
     * @callback module:api/InsightsDeploymentsBetaApi~getDeploymentCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeploymentRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.expand Expand properties in response. Options: `pullRequests`, `flagReferences`
     * @param {module:api/InsightsDeploymentsBetaApi~getDeploymentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeploymentRep}
     */
     ...
     * @callback module:api/InsightsDeploymentsBetaApi~getDeploymentsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeploymentCollectionRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.after Identifier used for pagination
     * @param {String} opts.before Identifier used for pagination
     * @param {String} opts.kind The deployment kind
     * @param {String} opts.status The deployment status
     * @param {module:api/InsightsDeploymentsBetaApi~getDeploymentsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeploymentCollectionRep}
     */
    getDeployments(projectKey, environmentKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getDeployments");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getDeployments");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = DeploymentCollectionRep;
      return this.apiClient.callApi(
     ...
     * @callback module:api/InsightsDeploymentsBetaApi~updateDeploymentCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeploymentRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/InsightsDeploymentsBetaApi~updateDeploymentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeploymentRep}
     */
    updateDeployment(deploymentID, patchOperation, callback) {
      ...
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling updateDeployment");
      }
