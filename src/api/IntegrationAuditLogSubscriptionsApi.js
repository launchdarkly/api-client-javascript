...
export default class IntegrationAuditLogSubscriptionsApi {
    ...
    /**
    * Constructs a new IntegrationAuditLogSubscriptionsApi. 
    * @alias module:api/IntegrationAuditLogSubscriptionsApi
    * @class
    ...
    */
     ...
     * @callback module:api/IntegrationAuditLogSubscriptionsApi~createSubscriptionCallback
     ...
     * @param {module:model/SubscriptionPost} subscriptionPost 
     * @param {module:api/IntegrationAuditLogSubscriptionsApi~createSubscriptionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Integration}
     */
    createSubscription(integrationKey, subscriptionPost, callback) {
      ...
      if (integrationKey === undefined || integrationKey === null) {
        throw new Error("Missing the required parameter 'integrationKey' when calling createSubscription");
      }
      // verify the required parameter 'subscriptionPost' is set
      if (subscriptionPost === undefined || subscriptionPost === null) {
        throw new Error("Missing the required parameter 'subscriptionPost' when calling createSubscription");
      }
     ...
     * @callback module:api/IntegrationAuditLogSubscriptionsApi~deleteSubscriptionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/IntegrationAuditLogSubscriptionsApi~deleteSubscriptionCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteSubscription(integrationKey, id, callback) {
      let postBody = null;
      // verify the required parameter 'integrationKey' is set
      if (integrationKey === undefined || integrationKey === null) {
        throw new Error("Missing the required parameter 'integrationKey' when calling deleteSubscription");
      }
     ...
     * @callback module:api/IntegrationAuditLogSubscriptionsApi~getSubscriptionByIDCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Integration} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} integrationKey The integration key
     * @param {String} id The subscription ID
     * @param {module:api/IntegrationAuditLogSubscriptionsApi~getSubscriptionByIDCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Integration}
     */
    getSubscriptionByID(integrationKey, id, callback) {
      let postBody = null;
      // verify the required parameter 'integrationKey' is set
      if (integrationKey === undefined || integrationKey === null) {
        throw new Error("Missing the required parameter 'integrationKey' when calling getSubscriptionByID");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     * @callback module:api/IntegrationAuditLogSubscriptionsApi~getSubscriptionsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} integrationKey The integration key
     * @param {module:api/IntegrationAuditLogSubscriptionsApi~getSubscriptionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Integrations}
     */
    getSubscriptions(integrationKey, callback) {
      let postBody = null;
      // verify the required parameter 'integrationKey' is set
      if (integrationKey === undefined || integrationKey === null) {
        throw new Error("Missing the required parameter 'integrationKey' when calling getSubscriptions");
      }
     ...
     * @callback module:api/IntegrationAuditLogSubscriptionsApi~updateSubscriptionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Integration} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/IntegrationAuditLogSubscriptionsApi~updateSubscriptionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Integration}
     */
    updateSubscription(integrationKey, id, patchOperation, callback) {
      let postBody = patchOperation;
      // verify the required parameter 'integrationKey' is set
      if (integrationKey === undefined || integrationKey === null) {
        throw new Error("Missing the required parameter 'integrationKey' when calling updateSubscription");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
      ...
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling updateSubscription");
      }
