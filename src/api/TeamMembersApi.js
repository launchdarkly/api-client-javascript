...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Member', 'model/Members', 'model/MembersBody', 'model/PatchDelta'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Member'), require('../model/Members'), require('../model/MembersBody'), require('../model/PatchDelta'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyRestApi) {
      root.LaunchDarklyRestApi = {};
    }
    root.LaunchDarklyRestApi.TeamMembersApi = factory(root.LaunchDarklyRestApi.ApiClient, root.LaunchDarklyRestApi.Member, root.LaunchDarklyRestApi.Members, root.LaunchDarklyRestApi.MembersBody, root.LaunchDarklyRestApi.PatchDelta);
  }
}(this, function(ApiClient, Member, Members, MembersBody, PatchDelta) {
  'use strict';
