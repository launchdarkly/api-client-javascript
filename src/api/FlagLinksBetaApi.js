...
export default class FlagLinksBetaApi {
    ...
    /**
    * Constructs a new FlagLinksBetaApi. 
    * @alias module:api/FlagLinksBetaApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createFlagLink operation.
     * @callback module:api/FlagLinksBetaApi~createFlagLinkCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FlagLinkRep} data The data returned by the service call.
     ...
     * @param {module:model/FlagLinkPost} flagLinkPost 
     * @param {module:api/FlagLinksBetaApi~createFlagLinkCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FlagLinkRep}
     */
    createFlagLink(projectKey, featureFlagKey, flagLinkPost, callback) {
      let postBody = flagLinkPost;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling createFlagLink");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling createFlagLink");
      }
      // verify the required parameter 'flagLinkPost' is set
      if (flagLinkPost === undefined || flagLinkPost === null) {
        throw new Error("Missing the required parameter 'flagLinkPost' when calling createFlagLink");
      }
    ...
    /**
     * Callback function to receive the result of the deleteFlagLink operation.
     * @callback module:api/FlagLinksBetaApi~deleteFlagLinkCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/FlagLinksBetaApi~deleteFlagLinkCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteFlagLink(projectKey, featureFlagKey, id, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling deleteFlagLink");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling deleteFlagLink");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteFlagLink");
      }
    ...
    /**
     * Callback function to receive the result of the getFlagLinks operation.
     * @callback module:api/FlagLinksBetaApi~getFlagLinksCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FlagLinkCollectionRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} projectKey The project key
     * @param {String} featureFlagKey The feature flag key
     * @param {module:api/FlagLinksBetaApi~getFlagLinksCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FlagLinkCollectionRep}
     */
    getFlagLinks(projectKey, featureFlagKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getFlagLinks");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling getFlagLinks");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = FlagLinkCollectionRep;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the updateFlagLink operation.
     * @callback module:api/FlagLinksBetaApi~updateFlagLinkCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FlagLinkRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/FlagLinksBetaApi~updateFlagLinkCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FlagLinkRep}
     */
    updateFlagLink(projectKey, featureFlagKey, id, patchOperation, callback) {
      let postBody = patchOperation;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling updateFlagLink");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling updateFlagLink");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateFlagLink");
      }
      // verify the required parameter 'patchOperation' is set
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling updateFlagLink");
      }
