...
export default class RelayProxyConfigurationsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the deleteRelayAutoConfig operation.
     * @callback module:api/RelayProxyConfigurationsApi~deleteRelayAutoConfigCallback
     ...
     * @param {module:api/RelayProxyConfigurationsApi~deleteRelayAutoConfigCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteRelayAutoConfig(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteRelayAutoConfig");
      }
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/RelayAutoConfigRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/RelayAutoConfigRep}
     */
    getRelayProxyConfig(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = RelayAutoConfigRep;
      return this.apiClient.callApi(
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/RelayAutoConfigCollectionRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/RelayAutoConfigCollectionRep}
     */
    getRelayProxyConfigs(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = RelayAutoConfigCollectionRep;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the patchRelayAutoConfig operation.
     * @callback module:api/RelayProxyConfigurationsApi~patchRelayAutoConfigCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RelayAutoConfigRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/RelayProxyConfigurationsApi~patchRelayAutoConfigCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RelayAutoConfigRep}
     */
    patchRelayAutoConfig(id, patchWithComment, callback) {
      let postBody = patchWithComment;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling patchRelayAutoConfig");
      }
      // verify the required parameter 'patchWithComment' is set
      if (patchWithComment === undefined || patchWithComment === null) {
        throw new Error("Missing the required parameter 'patchWithComment' when calling patchRelayAutoConfig");
      }
     ...
     * @param {module:model/RelayAutoConfigPost} relayAutoConfigPost 
     ...
     * data is of type: {@link module:model/RelayAutoConfigRep}
     */
    postRelayAutoConfig(relayAutoConfigPost, callback) {
      let postBody = relayAutoConfigPost;
      // verify the required parameter 'relayAutoConfigPost' is set
      if (relayAutoConfigPost === undefined || relayAutoConfigPost === null) {
        throw new Error("Missing the required parameter 'relayAutoConfigPost' when calling postRelayAutoConfig");
      }
    ...
    /**
     * Callback function to receive the result of the resetRelayAutoConfig operation.
     * @callback module:api/RelayProxyConfigurationsApi~resetRelayAutoConfigCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RelayAutoConfigRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/RelayProxyConfigurationsApi~resetRelayAutoConfigCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RelayAutoConfigRep}
     */
    resetRelayAutoConfig(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling resetRelayAutoConfig");
      }
