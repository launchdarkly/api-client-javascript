...
export default class FeatureFlagsApi {
    ...
    */
     ...
     */
    copyFeatureFlag(projKey, featureFlagKey, flagCopyConfigPost, callback) {
      let postBody = flagCopyConfigPost;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling copyFeatureFlag");
      }
      ...
      return this.apiClient.callApi(
        '/api/v2/flags/{projKey}/{featureFlagKey}/copy', 'POST',
     ...
     */
    deleteFeatureFlag(projKey, key, callback) {
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling deleteFeatureFlag");
      }
      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling deleteFeatureFlag");
      }
     ...
     */
    getExpiringUserTargets(projKey, envKey, flagKey, callback) {
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getExpiringUserTargets");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling getExpiringUserTargets");
      }
      // verify the required parameter 'flagKey' is set
      if (flagKey === undefined || flagKey === null) {
        throw new Error("Missing the required parameter 'flagKey' when calling getExpiringUserTargets");
      }
      ...
      return this.apiClient.callApi(
        '/api/v2/flags/{projKey}/{flagKey}/expiring-user-targets/{envKey}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * data is of type: {@link module:model/FeatureFlag}
     */
    getFeatureFlag(projKey, key, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getFeatureFlag");
      }
      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling getFeatureFlag");
      }
     ...
     */
    getFeatureFlagStatus(projKey, envKey, key, callback) {
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getFeatureFlagStatus");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling getFeatureFlagStatus");
      }
      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling getFeatureFlagStatus");
      }
      ...
      return this.apiClient.callApi(
        '/api/v2/flag-statuses/{projKey}/{envKey}/{key}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     */
    getFeatureFlagStatusAcrossEnvironments(projKey, key, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getFeatureFlagStatusAcrossEnvironments");
      }
      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling getFeatureFlagStatusAcrossEnvironments");
      }
      ...
      return this.apiClient.callApi(
        '/api/v2/flag-status/{projKey}/{key}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     */
    getFeatureFlagStatuses(projKey, envKey, callback) {
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getFeatureFlagStatuses");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling getFeatureFlagStatuses");
      }
      ...
      return this.apiClient.callApi(
        '/api/v2/flag-statuses/{projKey}/{envKey}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @param {String} opts.query A string that matches against the flags' keys and names. It is not case sensitive
     ...
     */
    getFeatureFlags(projKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getFeatureFlags");
      }
     ...
     */
    patchExpiringUserTargets(projKey, envKey, flagKey, patchWithComment, callback) {
      let postBody = patchWithComment;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling patchExpiringUserTargets");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling patchExpiringUserTargets");
      }
      // verify the required parameter 'flagKey' is set
      if (flagKey === undefined || flagKey === null) {
        throw new Error("Missing the required parameter 'flagKey' when calling patchExpiringUserTargets");
      }
      ...
      return this.apiClient.callApi(
        '/api/v2/flags/{projKey}/{flagKey}/expiring-user-targets/{envKey}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * data is of type: {@link module:model/FeatureFlag}
     */
    patchFeatureFlag(projKey, key, patchWithComment, callback) {
      let postBody = patchWithComment;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling patchFeatureFlag");
      }
      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling patchFeatureFlag");
      }
      // verify the required parameter 'patchWithComment' is set
      if (patchWithComment === undefined || patchWithComment === null) {
      ...
      let returnType = FeatureFlag;
      return this.apiClient.callApi(
        '/api/v2/flags/{projKey}/{key}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * data is of type: {@link module:model/FeatureFlag}
     */
    postFeatureFlag(projKey, featureFlagBody, opts, callback) {
      opts = opts || {};
      let postBody = featureFlagBody;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling postFeatureFlag");
      }
