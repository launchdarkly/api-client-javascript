...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FeatureFlag', 'model/FeatureFlagBody', 'model/FeatureFlagChangeRequest', 'model/FeatureFlagChangeRequestApplyConfigBody', 'model/FeatureFlagChangeRequestConfigBody', 'model/FeatureFlagChangeRequestReviewConfigBody', 'model/FeatureFlagChangeRequests', 'model/FeatureFlagCopyBody', 'model/FeatureFlagStatus', 'model/FeatureFlagStatusAcrossEnvironments', 'model/FeatureFlagStatuses', 'model/FeatureFlags', 'model/PatchComment', 'model/UsageError', 'model/UserTargetingExpirationForFlags'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/FeatureFlag'), require('../model/FeatureFlagBody'), require('../model/FeatureFlagChangeRequest'), require('../model/FeatureFlagChangeRequestApplyConfigBody'), require('../model/FeatureFlagChangeRequestConfigBody'), require('../model/FeatureFlagChangeRequestReviewConfigBody'), require('../model/FeatureFlagChangeRequests'), require('../model/FeatureFlagCopyBody'), require('../model/FeatureFlagStatus'), require('../model/FeatureFlagStatusAcrossEnvironments'), require('../model/FeatureFlagStatuses'), require('../model/FeatureFlags'), require('../model/PatchComment'), require('../model/UsageError'), require('../model/UserTargetingExpirationForFlags'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyApi) {
      root.LaunchDarklyApi = {};
    }
    root.LaunchDarklyApi.FeatureFlagsApi = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.FeatureFlag, root.LaunchDarklyApi.FeatureFlagBody, root.LaunchDarklyApi.FeatureFlagChangeRequest, root.LaunchDarklyApi.FeatureFlagChangeRequestApplyConfigBody, root.LaunchDarklyApi.FeatureFlagChangeRequestConfigBody, root.LaunchDarklyApi.FeatureFlagChangeRequestReviewConfigBody, root.LaunchDarklyApi.FeatureFlagChangeRequests, root.LaunchDarklyApi.FeatureFlagCopyBody, root.LaunchDarklyApi.FeatureFlagStatus, root.LaunchDarklyApi.FeatureFlagStatusAcrossEnvironments, root.LaunchDarklyApi.FeatureFlagStatuses, root.LaunchDarklyApi.FeatureFlags, root.LaunchDarklyApi.PatchComment, root.LaunchDarklyApi.UsageError, root.LaunchDarklyApi.UserTargetingExpirationForFlags);
  }
}(this, function(ApiClient, FeatureFlag, FeatureFlagBody, FeatureFlagChangeRequest, FeatureFlagChangeRequestApplyConfigBody, FeatureFlagChangeRequestConfigBody, FeatureFlagChangeRequestReviewConfigBody, FeatureFlagChangeRequests, FeatureFlagCopyBody, FeatureFlagStatus, FeatureFlagStatusAcrossEnvironments, FeatureFlagStatuses, FeatureFlags, PatchComment, UsageError, UserTargetingExpirationForFlags) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getFeatureFlagChangeRequest operation.
     * @callback module:api/FeatureFlagsApi~getFeatureFlagChangeRequestCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeatureFlagChangeRequests} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
     * @param {String} environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
     * @param {String} featureFlagChangeRequestId The feature flag change request ID
     * @param {module:api/FeatureFlagsApi~getFeatureFlagChangeRequestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagChangeRequests}
     */
    this.getFeatureFlagChangeRequest = function(projectKey, featureFlagKey, environmentKey, featureFlagChangeRequestId, callback) {
      var postBody = null;

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getFeatureFlagChangeRequest");
      }

      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling getFeatureFlagChangeRequest");
      }

      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getFeatureFlagChangeRequest");
      }

      // verify the required parameter 'featureFlagChangeRequestId' is set
      if (featureFlagChangeRequestId === undefined || featureFlagChangeRequestId === null) {
        throw new Error("Missing the required parameter 'featureFlagChangeRequestId' when calling getFeatureFlagChangeRequest");
      }
      ...
      var pathParams = {
        ...
        'featureFlagKey': featureFlagKey,
        'environmentKey': environmentKey,
        'featureFlagChangeRequestId': featureFlagChangeRequestId
      };
      var queryParams = {
      };
      var collectionQueryParams = {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = FeatureFlagChangeRequests;

      return this.apiClient.callApi(
        '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagChangeRequestId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getFeatureFlagChangeRequests operation.
     * @callback module:api/FeatureFlagsApi~getFeatureFlagChangeRequestsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeatureFlagChangeRequests} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
     * @param {String} environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
     * @param {module:api/FeatureFlagsApi~getFeatureFlagChangeRequestsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagChangeRequests}
     */
    this.getFeatureFlagChangeRequests = function(projectKey, featureFlagKey, environmentKey, callback) {
      var postBody = null;

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getFeatureFlagChangeRequests");
      }

      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling getFeatureFlagChangeRequests");
      }

      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getFeatureFlagChangeRequests");
      }
      ...
      return this.apiClient.callApi(
        '/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the postApplyFeatureFlagChangeRequest operation.
     * @callback module:api/FeatureFlagsApi~postApplyFeatureFlagChangeRequestCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeatureFlagChangeRequests} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
     * @param {String} featureFlagChangeRequestId The feature flag change request ID
     * @param {module:model/FeatureFlagChangeRequestApplyConfigBody} featureFlagChangeRequestApplyConfigBody Apply a new feature flag change request
     * @param {module:api/FeatureFlagsApi~postApplyFeatureFlagChangeRequestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagChangeRequests}
     */
    this.postApplyFeatureFlagChangeRequest = function(projectKey, featureFlagKey, environmentKey, featureFlagChangeRequestId, featureFlagChangeRequestApplyConfigBody, callback) {
      var postBody = featureFlagChangeRequestApplyConfigBody;

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling postApplyFeatureFlagChangeRequest");
      }

      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling postApplyFeatureFlagChangeRequest");
      }

      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling postApplyFeatureFlagChangeRequest");
      }

      // verify the required parameter 'featureFlagChangeRequestId' is set
      if (featureFlagChangeRequestId === undefined || featureFlagChangeRequestId === null) {
        throw new Error("Missing the required parameter 'featureFlagChangeRequestId' when calling postApplyFeatureFlagChangeRequest");
      }

      // verify the required parameter 'featureFlagChangeRequestApplyConfigBody' is set
      if (featureFlagChangeRequestApplyConfigBody === undefined || featureFlagChangeRequestApplyConfigBody === null) {
        throw new Error("Missing the required parameter 'featureFlagChangeRequestApplyConfigBody' when calling postApplyFeatureFlagChangeRequest");
      }
      ...
      return this.apiClient.callApi(
        '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagChangeRequestId}/apply', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the postFeatureFlagChangeRequest operation.
     * @callback module:api/FeatureFlagsApi~postFeatureFlagChangeRequestCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeatureFlagChangeRequest} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
     * @param {Object} opts Optional parameters
     * @param {module:model/FeatureFlagChangeRequestConfigBody} opts.featureFlagChangeRequestConfigBody Create a new feature flag change request
     * @param {module:api/FeatureFlagsApi~postFeatureFlagChangeRequestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagChangeRequest}
     */
    this.postFeatureFlagChangeRequest = function(projectKey, featureFlagKey, environmentKey, opts, callback) {
      opts = opts || {};
      var postBody = opts['featureFlagChangeRequestConfigBody'];

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling postFeatureFlagChangeRequest");
      }

      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling postFeatureFlagChangeRequest");
      }

      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling postFeatureFlagChangeRequest");
      }
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = FeatureFlagChangeRequest;

      return this.apiClient.callApi(
        '/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the postReviewFeatureFlagChangeRequest operation.
     * @callback module:api/FeatureFlagsApi~postReviewFeatureFlagChangeRequestCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeatureFlagChangeRequests} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
     * @param {String} featureFlagChangeRequestId The feature flag change request ID
     * @param {module:model/FeatureFlagChangeRequestReviewConfigBody} featureFlagChangeRequestReviewConfigBody Review a feature flag change request
     * @param {module:api/FeatureFlagsApi~postReviewFeatureFlagChangeRequestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagChangeRequests}
     */
    this.postReviewFeatureFlagChangeRequest = function(projectKey, featureFlagKey, environmentKey, featureFlagChangeRequestId, featureFlagChangeRequestReviewConfigBody, callback) {
      var postBody = featureFlagChangeRequestReviewConfigBody;

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling postReviewFeatureFlagChangeRequest");
      }

      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling postReviewFeatureFlagChangeRequest");
      }

      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling postReviewFeatureFlagChangeRequest");
      }

      // verify the required parameter 'featureFlagChangeRequestId' is set
      if (featureFlagChangeRequestId === undefined || featureFlagChangeRequestId === null) {
        throw new Error("Missing the required parameter 'featureFlagChangeRequestId' when calling postReviewFeatureFlagChangeRequest");
      }

      // verify the required parameter 'featureFlagChangeRequestReviewConfigBody' is set
      if (featureFlagChangeRequestReviewConfigBody === undefined || featureFlagChangeRequestReviewConfigBody === null) {
        throw new Error("Missing the required parameter 'featureFlagChangeRequestReviewConfigBody' when calling postReviewFeatureFlagChangeRequest");
      }
      ...
      return this.apiClient.callApi(
        '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagChangeRequestId}/review', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
