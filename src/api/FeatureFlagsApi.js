...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FeatureFlag', 'model/FeatureFlagBody', 'model/FeatureFlagCopyBody', 'model/FeatureFlagStatus', 'model/FeatureFlagStatuses', 'model/FeatureFlags', 'model/PatchComment'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/FeatureFlag'), require('../model/FeatureFlagBody'), require('../model/FeatureFlagCopyBody'), require('../model/FeatureFlagStatus'), require('../model/FeatureFlagStatuses'), require('../model/FeatureFlags'), require('../model/PatchComment'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyApi) {
      root.LaunchDarklyApi = {};
    }
    root.LaunchDarklyApi.FeatureFlagsApi = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.FeatureFlag, root.LaunchDarklyApi.FeatureFlagBody, root.LaunchDarklyApi.FeatureFlagCopyBody, root.LaunchDarklyApi.FeatureFlagStatus, root.LaunchDarklyApi.FeatureFlagStatuses, root.LaunchDarklyApi.FeatureFlags, root.LaunchDarklyApi.PatchComment);
  }
}(this, function(ApiClient, FeatureFlag, FeatureFlagBody, FeatureFlagCopyBody, FeatureFlagStatus, FeatureFlagStatuses, FeatureFlags, PatchComment) {
  'use strict';
