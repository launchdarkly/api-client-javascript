...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApprovalRequest', 'model/ApprovalRequestApplyConfigBody', 'model/ApprovalRequestConfigBody', 'model/ApprovalRequestReviewConfigBody', 'model/ApprovalRequests', 'model/DependentFlagsByEnvironment', 'model/FeatureFlag', 'model/FeatureFlagBody', 'model/FeatureFlagCopyBody', 'model/FeatureFlagScheduledChange', 'model/FeatureFlagScheduledChanges', 'model/FeatureFlagScheduledChangesConflicts', 'model/FeatureFlagStatus', 'model/FeatureFlagStatusAcrossEnvironments', 'model/FeatureFlagStatuses', 'model/FeatureFlags', 'model/FlagConfigScheduledChangesConflictsBody', 'model/FlagConfigScheduledChangesPatchBody', 'model/FlagConfigScheduledChangesPostBody', 'model/MultiEnvironmentDependentFlags', 'model/PatchComment', 'model/UsageError', 'model/UserTargetingExpirationForFlags'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApprovalRequest'), require('../model/ApprovalRequestApplyConfigBody'), require('../model/ApprovalRequestConfigBody'), require('../model/ApprovalRequestReviewConfigBody'), require('../model/ApprovalRequests'), require('../model/DependentFlagsByEnvironment'), require('../model/FeatureFlag'), require('../model/FeatureFlagBody'), require('../model/FeatureFlagCopyBody'), require('../model/FeatureFlagScheduledChange'), require('../model/FeatureFlagScheduledChanges'), require('../model/FeatureFlagScheduledChangesConflicts'), require('../model/FeatureFlagStatus'), require('../model/FeatureFlagStatusAcrossEnvironments'), require('../model/FeatureFlagStatuses'), require('../model/FeatureFlags'), require('../model/FlagConfigScheduledChangesConflictsBody'), require('../model/FlagConfigScheduledChangesPatchBody'), require('../model/FlagConfigScheduledChangesPostBody'), require('../model/MultiEnvironmentDependentFlags'), require('../model/PatchComment'), require('../model/UsageError'), require('../model/UserTargetingExpirationForFlags'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyApi) {
      root.LaunchDarklyApi = {};
    }
    root.LaunchDarklyApi.FeatureFlagsApi = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.ApprovalRequest, root.LaunchDarklyApi.ApprovalRequestApplyConfigBody, root.LaunchDarklyApi.ApprovalRequestConfigBody, root.LaunchDarklyApi.ApprovalRequestReviewConfigBody, root.LaunchDarklyApi.ApprovalRequests, root.LaunchDarklyApi.DependentFlagsByEnvironment, root.LaunchDarklyApi.FeatureFlag, root.LaunchDarklyApi.FeatureFlagBody, root.LaunchDarklyApi.FeatureFlagCopyBody, root.LaunchDarklyApi.FeatureFlagScheduledChange, root.LaunchDarklyApi.FeatureFlagScheduledChanges, root.LaunchDarklyApi.FeatureFlagScheduledChangesConflicts, root.LaunchDarklyApi.FeatureFlagStatus, root.LaunchDarklyApi.FeatureFlagStatusAcrossEnvironments, root.LaunchDarklyApi.FeatureFlagStatuses, root.LaunchDarklyApi.FeatureFlags, root.LaunchDarklyApi.FlagConfigScheduledChangesConflictsBody, root.LaunchDarklyApi.FlagConfigScheduledChangesPatchBody, root.LaunchDarklyApi.FlagConfigScheduledChangesPostBody, root.LaunchDarklyApi.MultiEnvironmentDependentFlags, root.LaunchDarklyApi.PatchComment, root.LaunchDarklyApi.UsageError, root.LaunchDarklyApi.UserTargetingExpirationForFlags);
  }
}(this, function(ApiClient, ApprovalRequest, ApprovalRequestApplyConfigBody, ApprovalRequestConfigBody, ApprovalRequestReviewConfigBody, ApprovalRequests, DependentFlagsByEnvironment, FeatureFlag, FeatureFlagBody, FeatureFlagCopyBody, FeatureFlagScheduledChange, FeatureFlagScheduledChanges, FeatureFlagScheduledChangesConflicts, FeatureFlagStatus, FeatureFlagStatusAcrossEnvironments, FeatureFlagStatuses, FeatureFlags, FlagConfigScheduledChangesConflictsBody, FlagConfigScheduledChangesPatchBody, FlagConfigScheduledChangesPostBody, MultiEnvironmentDependentFlags, PatchComment, UsageError, UserTargetingExpirationForFlags) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the flagsProjectKeyEnvironmentKeyFeatureFlagKeyDependentFlagsGet operation.
     * @callback module:api/FeatureFlagsApi~flagsProjectKeyEnvironmentKeyFeatureFlagKeyDependentFlagsGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
     * @param {String} featureFlagKey The feature flag's key. The key identifies the flag in your code.
     * @param {module:api/FeatureFlagsApi~flagsProjectKeyEnvironmentKeyFeatureFlagKeyDependentFlagsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DependentFlagsByEnvironment}
     */
    this.flagsProjectKeyEnvironmentKeyFeatureFlagKeyDependentFlagsGet = function(projectKey, environmentKey, featureFlagKey, callback) {
      var postBody = null;

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling flagsProjectKeyEnvironmentKeyFeatureFlagKeyDependentFlagsGet");
      }

      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling flagsProjectKeyEnvironmentKeyFeatureFlagKeyDependentFlagsGet");
      }

      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling flagsProjectKeyEnvironmentKeyFeatureFlagKeyDependentFlagsGet");
      }
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = DependentFlagsByEnvironment;
    ...
    /**
     * Callback function to receive the result of the flagsProjectKeyFeatureFlagKeyDependentFlagsGet operation.
     * @callback module:api/FeatureFlagsApi~flagsProjectKeyFeatureFlagKeyDependentFlagsGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} projectKey The project key, used to tie the flags together under one project so they can be managed together.
     * @param {String} featureFlagKey The feature flag's key. The key identifies the flag in your code.
     * @param {module:api/FeatureFlagsApi~flagsProjectKeyFeatureFlagKeyDependentFlagsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MultiEnvironmentDependentFlags}
     */
    this.flagsProjectKeyFeatureFlagKeyDependentFlagsGet = function(projectKey, featureFlagKey, callback) {
      var postBody = null;

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling flagsProjectKeyFeatureFlagKeyDependentFlagsGet");
      }

      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling flagsProjectKeyFeatureFlagKeyDependentFlagsGet");
      }
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = MultiEnvironmentDependentFlags;
