...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FeatureFlag', 'model/FeatureFlagApprovalRequest', 'model/FeatureFlagApprovalRequestApplyConfigBody', 'model/FeatureFlagApprovalRequestConfigBody', 'model/FeatureFlagApprovalRequestReviewConfigBody', 'model/FeatureFlagApprovalRequests', 'model/FeatureFlagBody', 'model/FeatureFlagCopyBody', 'model/FeatureFlagStatus', 'model/FeatureFlagStatusAcrossEnvironments', 'model/FeatureFlagStatuses', 'model/FeatureFlags', 'model/PatchComment', 'model/UsageError', 'model/UserTargetingExpirationForFlags'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/FeatureFlag'), require('../model/FeatureFlagApprovalRequest'), require('../model/FeatureFlagApprovalRequestApplyConfigBody'), require('../model/FeatureFlagApprovalRequestConfigBody'), require('../model/FeatureFlagApprovalRequestReviewConfigBody'), require('../model/FeatureFlagApprovalRequests'), require('../model/FeatureFlagBody'), require('../model/FeatureFlagCopyBody'), require('../model/FeatureFlagStatus'), require('../model/FeatureFlagStatusAcrossEnvironments'), require('../model/FeatureFlagStatuses'), require('../model/FeatureFlags'), require('../model/PatchComment'), require('../model/UsageError'), require('../model/UserTargetingExpirationForFlags'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyApi) {
      root.LaunchDarklyApi = {};
    }
    root.LaunchDarklyApi.FeatureFlagsApi = factory(root.LaunchDarklyApi.ApiClient, root.LaunchDarklyApi.FeatureFlag, root.LaunchDarklyApi.FeatureFlagApprovalRequest, root.LaunchDarklyApi.FeatureFlagApprovalRequestApplyConfigBody, root.LaunchDarklyApi.FeatureFlagApprovalRequestConfigBody, root.LaunchDarklyApi.FeatureFlagApprovalRequestReviewConfigBody, root.LaunchDarklyApi.FeatureFlagApprovalRequests, root.LaunchDarklyApi.FeatureFlagBody, root.LaunchDarklyApi.FeatureFlagCopyBody, root.LaunchDarklyApi.FeatureFlagStatus, root.LaunchDarklyApi.FeatureFlagStatusAcrossEnvironments, root.LaunchDarklyApi.FeatureFlagStatuses, root.LaunchDarklyApi.FeatureFlags, root.LaunchDarklyApi.PatchComment, root.LaunchDarklyApi.UsageError, root.LaunchDarklyApi.UserTargetingExpirationForFlags);
  }
}(this, function(ApiClient, FeatureFlag, FeatureFlagApprovalRequest, FeatureFlagApprovalRequestApplyConfigBody, FeatureFlagApprovalRequestConfigBody, FeatureFlagApprovalRequestReviewConfigBody, FeatureFlagApprovalRequests, FeatureFlagBody, FeatureFlagCopyBody, FeatureFlagStatus, FeatureFlagStatusAcrossEnvironments, FeatureFlagStatuses, FeatureFlags, PatchComment, UsageError, UserTargetingExpirationForFlags) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the deleteFeatureFlagApprovalRequest operation.
     * @callback module:api/FeatureFlagsApi~deleteFeatureFlagApprovalRequestCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
     * @param {String} featureFlagApprovalRequestId The feature flag approval request ID
     * @param {Object} opts Optional parameters
     * @param {module:model/FeatureFlagApprovalRequestConfigBody} opts.featureFlagApprovalRequestConfigBody Create a new feature flag approval request
     * @param {module:api/FeatureFlagsApi~deleteFeatureFlagApprovalRequestCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteFeatureFlagApprovalRequest = function(projectKey, environmentKey, featureFlagKey, featureFlagApprovalRequestId, opts, callback) {
      opts = opts || {};
      var postBody = opts['featureFlagApprovalRequestConfigBody'];

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling deleteFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling deleteFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling deleteFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'featureFlagApprovalRequestId' is set
      if (featureFlagApprovalRequestId === undefined || featureFlagApprovalRequestId === null) {
        throw new Error("Missing the required parameter 'featureFlagApprovalRequestId' when calling deleteFeatureFlagApprovalRequest");
      }
      ...
      var pathParams = {
        ...
        'featureFlagKey': featureFlagKey,
        'featureFlagApprovalRequestId': featureFlagApprovalRequestId
      };
      var queryParams = {
      };
      var collectionQueryParams = {
      ...
      return this.apiClient.callApi(
        '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getFeatureFlagApprovalRequest operation.
     * @callback module:api/FeatureFlagsApi~getFeatureFlagApprovalRequestCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeatureFlagApprovalRequests} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
     * @param {String} featureFlagApprovalRequestId The feature flag approval request ID
     * @param {module:api/FeatureFlagsApi~getFeatureFlagApprovalRequestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagApprovalRequests}
     */
    this.getFeatureFlagApprovalRequest = function(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, callback) {
      var postBody = null;

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling getFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'featureFlagApprovalRequestId' is set
      if (featureFlagApprovalRequestId === undefined || featureFlagApprovalRequestId === null) {
        throw new Error("Missing the required parameter 'featureFlagApprovalRequestId' when calling getFeatureFlagApprovalRequest");
      }
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = FeatureFlagApprovalRequests;

      return this.apiClient.callApi(
        '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getFeatureFlagApprovalRequests operation.
     * @callback module:api/FeatureFlagsApi~getFeatureFlagApprovalRequestsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeatureFlagApprovalRequests} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
     * @param {String} environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
     * @param {module:api/FeatureFlagsApi~getFeatureFlagApprovalRequestsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagApprovalRequests}
     */
    this.getFeatureFlagApprovalRequests = function(projectKey, featureFlagKey, environmentKey, callback) {
      var postBody = null;

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getFeatureFlagApprovalRequests");
      }

      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling getFeatureFlagApprovalRequests");
      }

      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getFeatureFlagApprovalRequests");
      }
    ...
    /**
     * Callback function to receive the result of the postApplyFeatureFlagApprovalRequest operation.
     * @callback module:api/FeatureFlagsApi~postApplyFeatureFlagApprovalRequestCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeatureFlagApprovalRequests} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
     * @param {String} featureFlagApprovalRequestId The feature flag approval request ID
     * @param {module:model/FeatureFlagApprovalRequestApplyConfigBody} featureFlagApprovalRequestApplyConfigBody Apply a new feature flag approval request
     * @param {module:api/FeatureFlagsApi~postApplyFeatureFlagApprovalRequestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagApprovalRequests}
     */
    this.postApplyFeatureFlagApprovalRequest = function(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestApplyConfigBody, callback) {
      var postBody = featureFlagApprovalRequestApplyConfigBody;

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling postApplyFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling postApplyFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling postApplyFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'featureFlagApprovalRequestId' is set
      if (featureFlagApprovalRequestId === undefined || featureFlagApprovalRequestId === null) {
        throw new Error("Missing the required parameter 'featureFlagApprovalRequestId' when calling postApplyFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'featureFlagApprovalRequestApplyConfigBody' is set
      if (featureFlagApprovalRequestApplyConfigBody === undefined || featureFlagApprovalRequestApplyConfigBody === null) {
        throw new Error("Missing the required parameter 'featureFlagApprovalRequestApplyConfigBody' when calling postApplyFeatureFlagApprovalRequest");
      }
      ...
      return this.apiClient.callApi(
        '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}/apply', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the postFeatureFlagApprovalRequest operation.
     * @callback module:api/FeatureFlagsApi~postFeatureFlagApprovalRequestCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeatureFlagApprovalRequest} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/FeatureFlagApprovalRequestConfigBody} opts.featureFlagApprovalRequestConfigBody Create a new feature flag approval request
     * @param {module:api/FeatureFlagsApi~postFeatureFlagApprovalRequestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagApprovalRequest}
     */
    this.postFeatureFlagApprovalRequest = function(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, opts, callback) {
      opts = opts || {};
      var postBody = opts['featureFlagApprovalRequestConfigBody'];

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling postFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling postFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling postFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'featureFlagApprovalRequestId' is set
      if (featureFlagApprovalRequestId === undefined || featureFlagApprovalRequestId === null) {
        throw new Error("Missing the required parameter 'featureFlagApprovalRequestId' when calling postFeatureFlagApprovalRequest");
      }
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = FeatureFlagApprovalRequest;

      return this.apiClient.callApi(
        '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the postReviewFeatureFlagApprovalRequest operation.
     * @callback module:api/FeatureFlagsApi~postReviewFeatureFlagApprovalRequestCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeatureFlagApprovalRequests} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
     * @param {String} featureFlagApprovalRequestId The feature flag approval request ID
     * @param {module:model/FeatureFlagApprovalRequestReviewConfigBody} featureFlagApprovalRequestReviewConfigBody Review a feature flag approval request
     * @param {module:api/FeatureFlagsApi~postReviewFeatureFlagApprovalRequestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureFlagApprovalRequests}
     */
    this.postReviewFeatureFlagApprovalRequest = function(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestReviewConfigBody, callback) {
      var postBody = featureFlagApprovalRequestReviewConfigBody;

      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling postReviewFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling postReviewFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling postReviewFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'featureFlagApprovalRequestId' is set
      if (featureFlagApprovalRequestId === undefined || featureFlagApprovalRequestId === null) {
        throw new Error("Missing the required parameter 'featureFlagApprovalRequestId' when calling postReviewFeatureFlagApprovalRequest");
      }

      // verify the required parameter 'featureFlagApprovalRequestReviewConfigBody' is set
      if (featureFlagApprovalRequestReviewConfigBody === undefined || featureFlagApprovalRequestReviewConfigBody === null) {
        throw new Error("Missing the required parameter 'featureFlagApprovalRequestReviewConfigBody' when calling postReviewFeatureFlagApprovalRequest");
      }
      ...
      return this.apiClient.callApi(
        '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}/review', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
