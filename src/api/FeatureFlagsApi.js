...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FeatureFlag', 'model/FeatureFlagBody', 'model/FeatureFlagCopyBody', 'model/FeatureFlagStatus', 'model/FeatureFlagStatusAcrossEnvironments', 'model/FeatureFlagStatuses', 'model/FeatureFlags', 'model/PatchComment', 'model/UsageError', 'model/UserTargetingExpirationForFlags'], factory);
...
}(this, function(ApiClient, FeatureFlag, FeatureFlagBody, FeatureFlagCopyBody, FeatureFlagStatus, FeatureFlagStatusAcrossEnvironments, FeatureFlagStatuses, FeatureFlags, PatchComment, UsageError, UserTargetingExpirationForFlags) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Boolean} opts.archived When set to 1, archived flags will be included in the list of flags returned.  By default, archived flags are not included in the list of flags.
     * @param {Number} opts.limit The number of objects to return. Defaults to -1, which returns everything.
     * @param {Boolean} opts._number Where to start in the list. This is for use with pagination. For example, an offset of 10 would skip the first 10 items and then return the next limit items.
     ...
     * data is of type: {@link module:model/UserTargetingExpirationForFlags}
     */
    this.patchExpiringUserTargets = function(projectKey, environmentKey, featureFlagKey, patchComment, callback) {
      ...
      if (patchComment === undefined || patchComment === null) {
        throw new Error("Missing the required parameter 'patchComment' when calling patchExpiringUserTargets");
      }
