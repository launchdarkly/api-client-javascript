...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.copyFeatureFlag = function(projectKey, environmentKey, featureFlagKey, callback) {
      var postBody = null;
      ...
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling copyFeatureFlag");
      }
      ...
      return this.apiClient.callApi(
        '/flags/{projectKey}/{environmentKey}/{featureFlagKey}/copy', 'POST',
