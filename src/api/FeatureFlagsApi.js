...
export default class FeatureFlagsApi {
    ...
    */
     ...
     * @param {Boolean} opts.compare Deprecated, unavailable in API version `20240415`. A boolean to filter results by only flags that have differences between environments.
     * @param {String} opts.expand A comma-separated list of fields to expand in the response. Supported fields are explained above.
     ...
     * @param {Object} opts Optional parameters
     * @param {Boolean} opts.ignoreConflicts If true, the patch will be applied even if it causes a pending scheduled change or approval request to fail.
     ...
     * data is of type: {@link module:model/FeatureFlag}
     */
    patchFeatureFlag(projectKey, featureFlagKey, patchWithComment, opts, callback) {
      opts = opts || {};
