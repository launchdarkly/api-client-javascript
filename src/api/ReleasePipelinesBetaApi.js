...
export default class ReleasePipelinesBetaApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the patchReleasePipeline operation.
     * @callback module:api/ReleasePipelinesBetaApi~patchReleasePipelineCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReleasePipeline} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} projectKey The project key
     * @param {String} pipelineKey The release pipeline key
     * @param {module:api/ReleasePipelinesBetaApi~patchReleasePipelineCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReleasePipeline}
     */
    patchReleasePipeline(projectKey, pipelineKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling patchReleasePipeline");
      }
      // verify the required parameter 'pipelineKey' is set
      if (pipelineKey === undefined || pipelineKey === null) {
        throw new Error("Missing the required parameter 'pipelineKey' when calling patchReleasePipeline");
      }
