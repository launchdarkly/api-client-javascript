...
export default class ReleasePipelinesBetaApi {
    ...
    /**
    * Constructs a new ReleasePipelinesBetaApi. 
    * @alias module:api/ReleasePipelinesBetaApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the deleteReleasePipeline operation.
     * @callback module:api/ReleasePipelinesBetaApi~deleteReleasePipelineCallback
     ...
     * @param {module:api/ReleasePipelinesBetaApi~deleteReleasePipelineCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteReleasePipeline(projectKey, pipelineKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling deleteReleasePipeline");
      }
      // verify the required parameter 'pipelineKey' is set
      if (pipelineKey === undefined || pipelineKey === null) {
        throw new Error("Missing the required parameter 'pipelineKey' when calling deleteReleasePipeline");
      }
    ...
    /**
     * Callback function to receive the result of the getAllReleasePipelines operation.
     * @callback module:api/ReleasePipelinesBetaApi~getAllReleasePipelinesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReleasePipelineCollection} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.limit The maximum number of items to return. Defaults to 20.
     * @param {Number} opts.offset Where to start in the list. Defaults to 0. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query `limit`.
     * @param {module:api/ReleasePipelinesBetaApi~getAllReleasePipelinesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReleasePipelineCollection}
     */
    getAllReleasePipelines(projectKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getAllReleasePipelines");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ReleasePipelineCollection;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getAllReleaseProgressionsForReleasePipeline operation.
     * @callback module:api/ReleasePipelinesBetaApi~getAllReleaseProgressionsForReleasePipelineCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReleaseProgressionCollection} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.filter Accepts filter by `status` and `activePhaseId`. `status` can take a value of `completed` or `active`. `activePhaseId` takes a UUID and will filter results down to releases active on the specified phase. Providing `status equals completed` along with an `activePhaseId` filter will return an error as they are disjoint sets of data. The combination of `status equals active` and `activePhaseId` will return the same results as `activePhaseId` alone.
     * @param {Number} opts.limit The maximum number of items to return. Defaults to 20.
     * @param {Number} opts.offset Where to start in the list. Defaults to 0. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query `limit`.
     * @param {module:api/ReleasePipelinesBetaApi~getAllReleaseProgressionsForReleasePipelineCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReleaseProgressionCollection}
     */
    getAllReleaseProgressionsForReleasePipeline(projectKey, pipelineKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getAllReleaseProgressionsForReleasePipeline");
      }
      // verify the required parameter 'pipelineKey' is set
      if (pipelineKey === undefined || pipelineKey === null) {
        throw new Error("Missing the required parameter 'pipelineKey' when calling getAllReleaseProgressionsForReleasePipeline");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ReleaseProgressionCollection;
      return this.apiClient.callApi(
        '/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}/releases', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getReleasePipelineByKey operation.
     * @callback module:api/ReleasePipelinesBetaApi~getReleasePipelineByKeyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReleasePipeline} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} projectKey The project key
     * @param {String} pipelineKey The release pipeline key
     * @param {module:api/ReleasePipelinesBetaApi~getReleasePipelineByKeyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReleasePipeline}
     */
    getReleasePipelineByKey(projectKey, pipelineKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getReleasePipelineByKey");
      }
      // verify the required parameter 'pipelineKey' is set
      if (pipelineKey === undefined || pipelineKey === null) {
        throw new Error("Missing the required parameter 'pipelineKey' when calling getReleasePipelineByKey");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ReleasePipeline;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the postReleasePipeline operation.
     * @callback module:api/ReleasePipelinesBetaApi~postReleasePipelineCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReleasePipeline} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} projectKey The project key
     * @param {module:model/CreateReleasePipelineInput} createReleasePipelineInput 
     * @param {module:api/ReleasePipelinesBetaApi~postReleasePipelineCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReleasePipeline}
     */
    postReleasePipeline(projectKey, createReleasePipelineInput, callback) {
      let postBody = createReleasePipelineInput;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling postReleasePipeline");
      }
      // verify the required parameter 'createReleasePipelineInput' is set
      if (createReleasePipelineInput === undefined || createReleasePipelineInput === null) {
        throw new Error("Missing the required parameter 'createReleasePipelineInput' when calling postReleasePipeline");
      }
    ...
    /**
     * Callback function to receive the result of the putReleasePipeline operation.
     * @callback module:api/ReleasePipelinesBetaApi~putReleasePipelineCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReleasePipeline} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} projectKey The project key
     * @param {String} pipelineKey The release pipeline key
     * @param {module:model/UpdateReleasePipelineInput} updateReleasePipelineInput 
     * @param {module:api/ReleasePipelinesBetaApi~putReleasePipelineCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReleasePipeline}
     */
    putReleasePipeline(projectKey, pipelineKey, updateReleasePipelineInput, callback) {
      let postBody = updateReleasePipelineInput;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling putReleasePipeline");
      }
      // verify the required parameter 'pipelineKey' is set
      if (pipelineKey === undefined || pipelineKey === null) {
        throw new Error("Missing the required parameter 'pipelineKey' when calling putReleasePipeline");
      }
      // verify the required parameter 'updateReleasePipelineInput' is set
      if (updateReleasePipelineInput === undefined || updateReleasePipelineInput === null) {
        throw new Error("Missing the required parameter 'updateReleasePipelineInput' when calling putReleasePipeline");
      }
      ...
      let returnType = ReleasePipeline;
      return this.apiClient.callApi(
        '/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
