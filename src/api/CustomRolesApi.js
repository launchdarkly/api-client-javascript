...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CustomRole', 'model/CustomRoleBody', 'model/CustomRoles', 'model/PatchDelta'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CustomRole'), require('../model/CustomRoleBody'), require('../model/CustomRoles'), require('../model/PatchDelta'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyRestApi) {
      root.LaunchDarklyRestApi = {};
    }
    root.LaunchDarklyRestApi.CustomRolesApi = factory(root.LaunchDarklyRestApi.ApiClient, root.LaunchDarklyRestApi.CustomRole, root.LaunchDarklyRestApi.CustomRoleBody, root.LaunchDarklyRestApi.CustomRoles, root.LaunchDarklyRestApi.PatchDelta);
  }
}(this, function(ApiClient, CustomRole, CustomRoleBody, CustomRoles, PatchDelta) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} customRoleKey The custom role key.
     * @param {Array.<module:model/PatchDelta>} patchDelta Requires a JSON Patch representation of the desired changes to the project. &#39;http://jsonpatch.com/&#39;
