...
export default class CustomRolesApi {
    ...
    */
     ...
     */
    deleteCustomRole(customRoleKey, callback) {
      let postBody = null;
     ...
     */
    getCustomRole(customRoleKey, callback) {
      let postBody = null;
      // verify the required parameter 'customRoleKey' is set
      if (customRoleKey === undefined || customRoleKey === null) {
     ...
     * @param {Number} opts.limit The maximum number of custom roles to return. Defaults to 20.
     ...
     * data is of type: {@link module:model/CustomRole}
     */
    patchCustomRole(customRoleKey, patchWithComment, callback) {
      ...
      if (patchWithComment === undefined || patchWithComment === null) {
        throw new Error("Missing the required parameter 'patchWithComment' when calling patchCustomRole");
      }
