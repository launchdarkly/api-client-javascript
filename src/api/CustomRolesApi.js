...
export default class CustomRolesApi {
    ...
    */
     ...
     */
    deleteCustomRole(key, callback) {
      let postBody = null;
      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling deleteCustomRole");
      }
    ...
    getCustomRole(key, callback) {
      ...
      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling getCustomRole");
      }
     ...
     */
    patchCustomRole(key, patchWithComment, callback) {
      let postBody = patchWithComment;
      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling patchCustomRole");
      }
