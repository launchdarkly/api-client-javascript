...
export default class ProjectsApi {
    ...
    */
     ...
     */
    deleteProject(projectKey, callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getFlagDefaultsByProject operation.
     * @callback module:api/ProjectsApi~getFlagDefaultsByProjectCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FlagDefaultsRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} projectKey The project key
     * @param {module:api/ProjectsApi~getFlagDefaultsByProjectCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FlagDefaultsRep}
     */
    getFlagDefaultsByProject(projectKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getFlagDefaultsByProject");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = FlagDefaultsRep;
      return this.apiClient.callApi(
     ...
     */
    getProject(projectKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.limit The number of projects to return in the response. Defaults to 20.
    ...
    /**
     * Callback function to receive the result of the patchFlagDefaultsByProject operation.
     * @callback module:api/ProjectsApi~patchFlagDefaultsByProjectCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UpsertPayloadRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ProjectsApi~patchFlagDefaultsByProjectCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UpsertPayloadRep}
     */
    patchFlagDefaultsByProject(projectKey, patchOperation, callback) {
      let postBody = patchOperation;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling patchFlagDefaultsByProject");
      }
      // verify the required parameter 'patchOperation' is set
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling patchFlagDefaultsByProject");
      }
      ...
      let accepts = ['application/json'];
      let returnType = UpsertPayloadRep;
      return this.apiClient.callApi(
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ProjectRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ProjectRep}
     */
    patchProject(projectKey, patchOperation, callback) {
      let postBody = patchOperation;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
      ...
      // verify the required parameter 'patchOperation' is set
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling patchProject");
      }
     ...
     * @param {module:model/ProjectPost} projectPost 
     ...
     * data is of type: {@link module:model/ProjectRep}
     */
    postProject(projectPost, callback) {
      let postBody = projectPost;
      // verify the required parameter 'projectPost' is set
      if (projectPost === undefined || projectPost === null) {
        throw new Error("Missing the required parameter 'projectPost' when calling postProject");
      }
    ...
    /**
     * Callback function to receive the result of the putFlagDefaultsByProject operation.
     * @callback module:api/ProjectsApi~putFlagDefaultsByProjectCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UpsertPayloadRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} projectKey The project key
     * @param {module:model/UpsertFlagDefaultsPayload} upsertFlagDefaultsPayload 
     * @param {module:api/ProjectsApi~putFlagDefaultsByProjectCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UpsertPayloadRep}
     */
    putFlagDefaultsByProject(projectKey, upsertFlagDefaultsPayload, callback) {
      let postBody = upsertFlagDefaultsPayload;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling putFlagDefaultsByProject");
      }
      // verify the required parameter 'upsertFlagDefaultsPayload' is set
      if (upsertFlagDefaultsPayload === undefined || upsertFlagDefaultsPayload === null) {
        throw new Error("Missing the required parameter 'upsertFlagDefaultsPayload' when calling putFlagDefaultsByProject");
      }
