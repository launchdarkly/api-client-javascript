...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PatchDelta', 'model/Project', 'model/ProjectBody', 'model/Projects'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PatchDelta'), require('../model/Project'), require('../model/ProjectBody'), require('../model/Projects'));
  } else {
    // Browser globals (root is window)
    if (!root.LaunchDarklyRestApi) {
      root.LaunchDarklyRestApi = {};
    }
    root.LaunchDarklyRestApi.ProjectsApi = factory(root.LaunchDarklyRestApi.ApiClient, root.LaunchDarklyRestApi.PatchDelta, root.LaunchDarklyRestApi.Project, root.LaunchDarklyRestApi.ProjectBody, root.LaunchDarklyRestApi.Projects);
  }
}(this, function(ApiClient, PatchDelta, Project, ProjectBody, Projects) {
  'use strict';
