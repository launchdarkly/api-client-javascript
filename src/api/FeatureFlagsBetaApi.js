...
export default class FeatureFlagsBetaApi {
    ...
    /**
    * Constructs a new FeatureFlagsBetaApi. 
    * @alias module:api/FeatureFlagsBetaApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getDependentFlags operation.
     * @callback module:api/FeatureFlagsBetaApi~getDependentFlagsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MultiEnvironmentDependentFlags} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/MultiEnvironmentDependentFlags}
     */
    getDependentFlags(projectKey, featureFlagKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getDependentFlags");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling getDependentFlags");
      }
      ...
      let returnType = MultiEnvironmentDependentFlags;
    ...
    /**
     * Callback function to receive the result of the getDependentFlagsByEnv operation.
     * @callback module:api/FeatureFlagsBetaApi~getDependentFlagsByEnvCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DependentFlagsByEnvironment} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} featureFlagKey The feature flag key
     * @param {module:api/FeatureFlagsBetaApi~getDependentFlagsByEnvCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DependentFlagsByEnvironment}
     */
    getDependentFlagsByEnv(projectKey, environmentKey, featureFlagKey, callback) {
      let postBody = null;
      // verify the required parameter 'projectKey' is set
      if (projectKey === undefined || projectKey === null) {
        throw new Error("Missing the required parameter 'projectKey' when calling getDependentFlagsByEnv");
      }
      // verify the required parameter 'environmentKey' is set
      if (environmentKey === undefined || environmentKey === null) {
        throw new Error("Missing the required parameter 'environmentKey' when calling getDependentFlagsByEnv");
      }
      // verify the required parameter 'featureFlagKey' is set
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling getDependentFlagsByEnv");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = DependentFlagsByEnvironment;
      return this.apiClient.callApi(
     ...
     * @callback module:api/FeatureFlagsBetaApi~postMigrationSafetyIssuesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/FeatureFlagsBetaApi~postMigrationSafetyIssuesCallback} callback The callback function, accepting three arguments: error, data, response
