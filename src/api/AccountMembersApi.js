...
export default class AccountMembersApi {
    ...
    /**
    * Constructs a new AccountMembersApi. 
    * @alias module:api/AccountMembersApi
    * @class
    ...
    */
     ...
     * @callback module:api/AccountMembersApi~deleteMemberCallback
     ...
     * @callback module:api/AccountMembersApi~getMemberCallback
     * @param {String} error Error message, if any.
     ...
     * @callback module:api/AccountMembersApi~getMembersCallback
     * @param {String} error Error message, if any.
     ...
     * @callback module:api/AccountMembersApi~patchMemberCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Member} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/Member}
     */
    patchMember(id, patchOperation, callback) {
      let postBody = patchOperation;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling patchMember");
      }
      // verify the required parameter 'patchOperation' is set
      if (patchOperation === undefined || patchOperation === null) {
        throw new Error("Missing the required parameter 'patchOperation' when calling patchMember");
      }
    ...
    /**
     * Callback function to receive the result of the patchMembers operation.
     * @callback module:api/AccountMembersApi~patchMembersCallback
     * @param {String} error Error message, if any.
     * @param {module:model/BulkEditMembersRep} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/MembersPatchInput} membersPatchInput 
     * @param {module:api/AccountMembersApi~patchMembersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BulkEditMembersRep}
     */
    patchMembers(membersPatchInput, callback) {
      let postBody = membersPatchInput;
      // verify the required parameter 'membersPatchInput' is set
      if (membersPatchInput === undefined || membersPatchInput === null) {
        throw new Error("Missing the required parameter 'membersPatchInput' when calling patchMembers");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = BulkEditMembersRep;
      return this.apiClient.callApi(
     ...
     * @callback module:api/AccountMembersApi~postMembersCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Members} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
