...
export default class WorkflowTemplatesApi {
    ...
    /**
    * Constructs a new WorkflowTemplatesApi. 
    * @alias module:api/WorkflowTemplatesApi
    * @class
    ...
    */
     ...
     * @callback module:api/WorkflowTemplatesApi~createWorkflowTemplateCallback
     ...
     * @param {module:api/WorkflowTemplatesApi~createWorkflowTemplateCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/WorkflowTemplatesApi~deleteWorkflowTemplateCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/WorkflowTemplatesApi~deleteWorkflowTemplateCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/WorkflowTemplatesApi~getWorkflowTemplatesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/WorkflowTemplatesApi~getWorkflowTemplatesCallback} callback The callback function, accepting three arguments: error, data, response
