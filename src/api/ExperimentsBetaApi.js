...
export default class ExperimentsBetaApi {
    ...
    */
     ...
     * @param {module:model/ExperimentResultsRep} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/ExperimentResultsRep}
     */
    getExperiment(projKey, flagKey, envKey, metricKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling getExperiment");
      }
      // verify the required parameter 'flagKey' is set
      if (flagKey === undefined || flagKey === null) {
        throw new Error("Missing the required parameter 'flagKey' when calling getExperiment");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling getExperiment");
      }
      // verify the required parameter 'metricKey' is set
      if (metricKey === undefined || metricKey === null) {
        throw new Error("Missing the required parameter 'metricKey' when calling getExperiment");
      }
      ...
      let returnType = ExperimentResultsRep;
      return this.apiClient.callApi(
        '/api/v2/flags/{projKey}/{flagKey}/experiments/{envKey}/{metricKey}', 'GET',
     ...
     */
    resetExperiment(projKey, flagKey, envKey, metricKey, callback) {
      let postBody = null;
      // verify the required parameter 'projKey' is set
      if (projKey === undefined || projKey === null) {
        throw new Error("Missing the required parameter 'projKey' when calling resetExperiment");
      }
      // verify the required parameter 'flagKey' is set
      if (flagKey === undefined || flagKey === null) {
        throw new Error("Missing the required parameter 'flagKey' when calling resetExperiment");
      }
      // verify the required parameter 'envKey' is set
      if (envKey === undefined || envKey === null) {
        throw new Error("Missing the required parameter 'envKey' when calling resetExperiment");
      }
      // verify the required parameter 'metricKey' is set
      if (metricKey === undefined || metricKey === null) {
