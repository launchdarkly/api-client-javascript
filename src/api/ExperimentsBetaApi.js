...
export default class ExperimentsBetaApi {
    ...
    */
     ...
     */
    getExperiment(projectKey, featureFlagKey, environmentKey, metricKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      if (featureFlagKey === undefined || featureFlagKey === null) {
        throw new Error("Missing the required parameter 'featureFlagKey' when calling getExperiment");
      }
